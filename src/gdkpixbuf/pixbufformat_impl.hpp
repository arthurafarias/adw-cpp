...
GI_MODULE_STATIC_OR_INLINE char* _field_name_get (const ::GdkPixbufFormat* obj) { return (char*) obj->name; }
...
GI_MODULE_STATIC_OR_INLINE ::GdkPixbufModulePattern* _field_signature_get (const ::GdkPixbufFormat* obj) { return (::GdkPixbufModulePattern*) obj->signature; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_domain_get (const ::GdkPixbufFormat* obj) { return (char*) obj->domain; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_description_get (const ::GdkPixbufFormat* obj) { return (char*) obj->description; }
...
GI_MODULE_STATIC_OR_INLINE guint32 _field_flags_get (const ::GdkPixbufFormat* obj) { return (guint32) obj->flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_flags_set (::GdkPixbufFormat* obj, guint32 _value) { obj->flags = (decltype(obj->flags)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gboolean _field_disabled_get (const ::GdkPixbufFormat* obj) { return (gboolean) obj->disabled; }
...
GI_MODULE_STATIC_OR_INLINE void _field_disabled_set (::GdkPixbufFormat* obj, gboolean _value) { obj->disabled = (decltype(obj->disabled)) _value; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_license_get (const ::GdkPixbufFormat* obj) { return (char*) obj->license; }
...
// GdkPixbufFormat* /*full,nullable*/ gdk_pixbuf_format_copy (const GdkPixbufFormat* format /*none*/);
// ::GdkPixbufFormat* /*full,nullable*/ gdk_pixbuf_format_copy (const ::GdkPixbufFormat* format /*none*/);
...
// gchar* /*full,nullable*/ gdk_pixbuf_format_get_description (GdkPixbufFormat* format /*none*/);
// char* /*full,nullable*/ gdk_pixbuf_format_get_description (::GdkPixbufFormat* format /*none*/);
...
// gchar** /*full,nullable*/ gdk_pixbuf_format_get_extensions (GdkPixbufFormat* format /*none*/);
// char** /*full,nullable*/ gdk_pixbuf_format_get_extensions (::GdkPixbufFormat* format /*none*/);
...
// gchar* /*full,nullable*/ gdk_pixbuf_format_get_license (GdkPixbufFormat* format /*none*/);
// char* /*full,nullable*/ gdk_pixbuf_format_get_license (::GdkPixbufFormat* format /*none*/);
...
// gchar** /*full,nullable*/ gdk_pixbuf_format_get_mime_types (GdkPixbufFormat* format /*none*/);
// char** /*full,nullable*/ gdk_pixbuf_format_get_mime_types (::GdkPixbufFormat* format /*none*/);
...
// gchar* /*full,nullable*/ gdk_pixbuf_format_get_name (GdkPixbufFormat* format /*none*/);
// char* /*full,nullable*/ gdk_pixbuf_format_get_name (::GdkPixbufFormat* format /*none*/);
