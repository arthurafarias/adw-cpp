...
GI_MODULE_STATIC_OR_INLINE char* _field_module_name_get (const ::GdkPixbufModule* obj) { return (char*) obj->module_name; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_module_path_get (const ::GdkPixbufModule* obj) { return (char*) obj->module_path; }
...
GI_MODULE_STATIC_OR_INLINE ::GdkPixbufFormat* _field_info_get (const ::GdkPixbufModule* obj) { return (::GdkPixbufFormat*) obj->info; }
