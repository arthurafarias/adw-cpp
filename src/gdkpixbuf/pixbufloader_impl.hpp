...
//  /*none,nullable*/ gdk_pixbuf_loader_get_animation (::GdkPixbufLoader* loader /*none*/);
...
void PixbufLoaderClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.area_prepared) methods->area_prepared = (decltype (methods->area_prepared)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::area_prepared_>;
  if (init_data.area_updated) methods->area_updated = (decltype (methods->area_updated)) gi::detail::method_wrapper<self, void (*) (gint x, gint y, gint width, gint height), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::area_updated_>;
  ...
  if (init_data.size_prepared) methods->size_prepared = (decltype (methods->size_prepared)) gi::detail::method_wrapper<self, void (*) (gint width, gint height), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::size_prepared_>;
}
