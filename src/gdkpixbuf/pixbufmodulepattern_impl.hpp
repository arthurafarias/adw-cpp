...
GI_MODULE_STATIC_OR_INLINE char* _field_prefix_get (const ::GdkPixbufModulePattern* obj) { return (char*) obj->prefix; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_mask_get (const ::GdkPixbufModulePattern* obj) { return (char*) obj->mask; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_relevance_get (const ::GdkPixbufModulePattern* obj) { return (gint) obj->relevance; }
...
GI_MODULE_STATIC_OR_INLINE void _field_relevance_set (::GdkPixbufModulePattern* obj, gint _value) { obj->relevance = (decltype(obj->relevance)) _value; }
