...
// GdkPixbuf* /*full,nullable*/ gdk_pixbuf_new_from_xpm_data (const char** data /*none*/);
// ::GdkPixbuf* /*full,nullable*/ gdk_pixbuf_new_from_xpm_data (const char** data /*none*/);
// IGNORE; deprecated
...
// GdkPixbuf* /*full,nullable*/ gdk_pixbuf_add_alpha (const GdkPixbuf* pixbuf /*none*/, gboolean substitute_color, guchar r, guchar g, guchar b);
// ::GdkPixbuf* /*full,nullable*/ gdk_pixbuf_add_alpha (const ::GdkPixbuf* pixbuf /*none*/, gboolean substitute_color, guint8 r, guint8 g, guint8 b);
...
// gboolean gdk_pixbuf_save_to_buffer (GdkPixbuf* pixbuf /*none*/, gchar** buffer /*full,out*/, gsize* buffer_size, const char* type /*none*/, GError** error /*none*/,  ..._ /*none*/);
// gboolean gdk_pixbuf_save_to_buffer (::GdkPixbuf* pixbuf /*none*/, guint8** buffer /*full,out*/, gsize* buffer_size, const char* type /*none*/, ::GError* error /*none*/,  ..._ /*none*/);
// IGNORE; not introspectable, varargs not supported
