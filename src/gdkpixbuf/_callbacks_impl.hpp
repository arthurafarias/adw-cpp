...
// typedef  /*full*/ (*GdkPixbufModuleLoadAnimationFunc) (void* f, GError ** error);
// SKIP;  type  not supported, not a callback since no user_data
...
// typedef void (*GdkPixbufModulePreparedFunc) (::GdkPixbuf* pixbuf /*none*/,  anim /*none*/, void* user_data);
// SKIP; anim type  not supported
