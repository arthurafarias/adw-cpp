...
// ::GdkColorState* /*none*/ gdk_texture_get_color_state (::GdkTexture* self /*none*/);
Gdk::ColorState_Ref base::TextureBase::get_color_state () noexcept
{
  typedef ::GdkColorState* (*call_wrap_t) (::GdkTexture* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_texture_get_color_state;
