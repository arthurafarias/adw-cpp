...
static GI_INLINE_DECL Gdk::Cursor new_from_callback (Gdk::CursorGetTextureCallback callback, Gdk::Cursor fallback) noexcept;
static GI_INLINE_DECL Gdk::Cursor new_from_callback (Gdk::CursorGetTextureCallback callback) noexcept;
