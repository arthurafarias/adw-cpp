...
// GdkCursor* /*full,nullable*/ gdk_cursor_new_from_callback (GdkCursorGetTextureCallback callback /*none*/, gpointer data, GDestroyNotify destroy /*none*/, GdkCursor* fallback /*none,nullable*/);
// ::GdkCursor* /*full,nullable*/ gdk_cursor_new_from_callback (Gdk::CursorGetTextureCallback::cfunction_type callback /*none*/, void* data, GLib::DestroyNotify::cfunction_type destroy /*none*/, ::GdkCursor* fallback /*none,nullable*/);
Gdk::Cursor base::CursorBase::new_from_callback (Gdk::CursorGetTextureCallback callback, Gdk::Cursor fallback) noexcept
{
  typedef ::GdkCursor* (*call_wrap_t) (Gdk::CursorGetTextureCallback::cfunction_type callback, void* data, GLib::DestroyNotify::cfunction_type destroy, ::GdkCursor* fallback);
  call_wrap_t call_wrap_v = (call_wrap_t) gdk_cursor_new_from_callback;
  ...
  auto _temp_ret = call_wrap_v ((Gdk::CursorGetTextureCallback::cfunction_type) (callback_wrap_ ? &callback_wrap_->wrapper : nullptr), (void*) (callback_wrap_), (GLib::DestroyNotify::cfunction_type) (callback_wrap_ ? &callback_wrap_->destroy : nullptr), (::GdkCursor*) (fallback_to_c));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
Gdk::Cursor base::CursorBase::new_from_callback (Gdk::CursorGetTextureCallback callback) noexcept
{
  typedef ::GdkCursor* (*call_wrap_t) (Gdk::CursorGetTextureCallback::cfunction_type callback, void* data, GLib::DestroyNotify::cfunction_type destroy, ::GdkCursor* fallback);
  call_wrap_t call_wrap_v = (call_wrap_t) gdk_cursor_new_from_callback;
