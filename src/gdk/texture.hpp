...
// GdkColorState* /*none*/ gdk_texture_get_color_state (GdkTexture* self /*none*/);
// ::GdkColorState* /*none*/ gdk_texture_get_color_state (::GdkTexture* self /*none*/);
...
gi::property_proxy<Gdk::ColorState, base::TextureBase> property_color_state()
{ return gi::property_proxy<Gdk::ColorState, base::TextureBase> (*this, "color-state"); }
const gi::property_proxy<Gdk::ColorState, base::TextureBase> property_color_state() const
{ return gi::property_proxy<Gdk::ColorState, base::TextureBase> (*this, "color-state"); }
