...
// GInputStream* /*full,nullable*/ gdk_drop_read_finish (GdkDrop* self /*none*/, GAsyncResult* result /*none*/, const char** out_mime_type /*none,out*/, GError ** error);
// ::GInputStream* /*full,nullable*/ gdk_drop_read_finish (::GdkDrop* self /*none*/, ::GAsyncResult* result /*none*/, const char** out_mime_type /*none,out*/, GError ** error);
Gio::InputStream base::DropBase::read_finish (Gio::AsyncResult result, gi::cstring_v & out_mime_type)
{
  ...
  out_mime_type = gi::wrap (out_mime_type_o, gi::transfer_none);
  gi::check_error (error);
  return gi::wrap (_temp_ret, gi::transfer_full);
}
Gio::InputStream base::DropBase::read_finish (Gio::AsyncResult result, gi::cstring_v & out_mime_type, GLib::Error * _error) noexcept
{
  typedef ::GInputStream* (*call_wrap_t) (::GdkDrop* self, ::GAsyncResult* result, const char** out_mime_type, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_drop_read_finish;
  const char* out_mime_type_o {};
...
std::tuple<Gio::InputStream, gi::cstring_v> base::DropBase::read_finish (Gio::AsyncResult result)
{
  typedef ::GInputStream* (*call_wrap_t) (::GdkDrop* self, ::GAsyncResult* result, const char** out_mime_type, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_drop_read_finish;
  const char* out_mime_type_o {};
...
std::tuple<Gio::InputStream, gi::cstring_v> base::DropBase::read_finish (Gio::AsyncResult result, GLib::Error * _error) noexcept
{
  typedef ::GInputStream* (*call_wrap_t) (::GdkDrop* self, ::GAsyncResult* result, const char** out_mime_type, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_drop_read_finish;
  const char* out_mime_type_o {};
