...
// ::GdkToplevelCapabilities gdk_toplevel_get_capabilities (::GdkToplevel* toplevel /*none*/);
GI_INLINE_DECL Gdk::ToplevelCapabilities get_capabilities () noexcept;
...
gi::property_proxy<Gdk::ToplevelCapabilities, base::ToplevelBase> property_capabilities()
{ return gi::property_proxy<Gdk::ToplevelCapabilities, base::ToplevelBase> (*this, "capabilities"); }
const gi::property_proxy<Gdk::ToplevelCapabilities, base::ToplevelBase> property_capabilities() const
{ return gi::property_proxy<Gdk::ToplevelCapabilities, base::ToplevelBase> (*this, "capabilities"); }
...
gi::property_proxy<Gdk::Gravity, base::ToplevelBase> property_gravity()
{ return gi::property_proxy<Gdk::Gravity, base::ToplevelBase> (*this, "gravity"); }
const gi::property_proxy<Gdk::Gravity, base::ToplevelBase> property_gravity() const
{ return gi::property_proxy<Gdk::Gravity, base::ToplevelBase> (*this, "gravity"); }
