...
//  /*full*/ gdk_surface_create_vulkan_context (::GdkSurface* surface /*none*/, GError ** error);
// IGNORE; deprecated
...
// void gdk_surface_set_input_region (GdkSurface* surface /*none*/, cairo_region_t* region /*none,nullable*/);
// void gdk_surface_set_input_region (::GdkSurface* surface /*none*/, ::cairo_region_t* region /*none,nullable*/);
...
void base::SurfaceBase::set_input_region () noexcept
{
  typedef void (*call_wrap_t) (::GdkSurface* surface, ::cairo_region_t* region);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_surface_set_input_region;
