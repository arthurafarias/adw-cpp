...
// ::GdkDmabufFormats* /*none*/ gdk_display_get_dmabuf_formats (::GdkDisplay* display /*none*/);
Gdk::DmabufFormats_Ref base::DisplayBase::get_dmabuf_formats () noexcept
{
  typedef ::GdkDmabufFormats* (*call_wrap_t) (::GdkDisplay* display);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_display_get_dmabuf_formats;
  auto _temp_ret = call_wrap_v ((::GdkDisplay*) (gobj_()));
  return gi::wrap (_temp_ret, gi::transfer_none);
}
...
// gboolean gdk_display_supports_shadow_width (::GdkDisplay* display /*none*/);
bool base::DisplayBase::supports_shadow_width () noexcept
{
  typedef gboolean (*call_wrap_t) (::GdkDisplay* display);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_display_supports_shadow_width;
  auto _temp_ret = call_wrap_v ((::GdkDisplay*) (gobj_()));
  return _temp_ret;
}
