...
// GdkToplevelCapabilities gdk_toplevel_get_capabilities (GdkToplevel* toplevel /*none*/);
// ::GdkToplevelCapabilities gdk_toplevel_get_capabilities (::GdkToplevel* toplevel /*none*/);
Gdk::ToplevelCapabilities base::ToplevelBase::get_capabilities () noexcept
{
  typedef ::GdkToplevelCapabilities (*call_wrap_t) (::GdkToplevel* toplevel);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_toplevel_get_capabilities;
  auto _temp_ret = call_wrap_v ((::GdkToplevel*) (gobj_()));
  return gi::wrap (_temp_ret);
}

// GdkGravity gdk_toplevel_get_gravity (GdkToplevel* toplevel /*none*/);
// ::GdkGravity gdk_toplevel_get_gravity (::GdkToplevel* toplevel /*none*/);
Gdk::Gravity base::ToplevelBase::get_gravity () noexcept
{
  typedef ::GdkGravity (*call_wrap_t) (::GdkToplevel* toplevel);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_toplevel_get_gravity;
  auto _temp_ret = call_wrap_v ((::GdkToplevel*) (gobj_()));
  return gi::wrap (_temp_ret);
}
...
// void gdk_toplevel_set_gravity (GdkToplevel* toplevel /*none*/, GdkGravity gravity);
// void gdk_toplevel_set_gravity (::GdkToplevel* toplevel /*none*/, ::GdkGravity gravity);
void base::ToplevelBase::set_gravity (Gdk::Gravity gravity) noexcept
{
  typedef void (*call_wrap_t) (::GdkToplevel* toplevel, ::GdkGravity gravity);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_toplevel_set_gravity;
  auto gravity_to_c = gi::unwrap (gravity);
  call_wrap_v ((::GdkToplevel*) (gobj_()), (::GdkGravity) (gravity_to_c));
}
