...
void ContentProviderClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.attach_clipboard) methods->attach_clipboard = (decltype (methods->attach_clipboard)) gi::detail::method_wrapper<self, void (*) (Gdk::Clipboard clipboard), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::attach_clipboard_>;
  if (init_data.content_changed) methods->content_changed = (decltype (methods->content_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::content_changed_>;
  if (init_data.detach_clipboard) methods->detach_clipboard = (decltype (methods->detach_clipboard)) gi::detail::method_wrapper<self, void (*) (Gdk::Clipboard clipboard), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::detach_clipboard_>;
  if (init_data.get_value) methods->get_value = (decltype (methods->get_value)) gi::detail::method_wrapper<self, bool (*) (GObject::Value_Ref value, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::get_value_>;
  if (init_data.ref_formats) methods->ref_formats = (decltype (methods->ref_formats)) gi::detail::method_wrapper<self, Gdk::ContentFormats (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::ref_formats_>;
  if (init_data.ref_storable_formats) methods->ref_storable_formats = (decltype (methods->ref_storable_formats)) gi::detail::method_wrapper<self, Gdk::ContentFormats (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::ref_storable_formats_>;
  if (init_data.write_mime_type_async) methods->write_mime_type_async = (decltype (methods->write_mime_type_async)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v mime_type, Gio::OutputStream stream, gint io_priority, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<3>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<4, 5>>>, void  (const char* mime_type, ::GOutputStream* stream, gint io_priority, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::write_mime_type_async_>;
  if (init_data.write_mime_type_finish) methods->write_mime_type_finish = (decltype (methods->write_mime_type_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::write_mime_type_finish_>;
}
