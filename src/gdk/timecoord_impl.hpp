...
GI_MODULE_STATIC_OR_INLINE guint32 _field_time_get (const ::GdkTimeCoord* obj) { return (guint32) obj->time; }
...
GI_MODULE_STATIC_OR_INLINE void _field_time_set (::GdkTimeCoord* obj, guint32 _value) { obj->time = (decltype(obj->time)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::GdkAxisFlags _field_flags_get (const ::GdkTimeCoord* obj) { return (::GdkAxisFlags) obj->flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_flags_set (::GdkTimeCoord* obj, ::GdkAxisFlags _value) { obj->flags = (decltype(obj->flags)) _value; }
