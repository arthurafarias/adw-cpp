...
GI_MODULE_STATIC_OR_INLINE guint _field_keycode_get (const ::GdkKeymapKey* obj) { return (guint) obj->keycode; }
...
GI_MODULE_STATIC_OR_INLINE void _field_keycode_set (::GdkKeymapKey* obj, guint _value) { obj->keycode = (decltype(obj->keycode)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_group_get (const ::GdkKeymapKey* obj) { return (gint) obj->group; }
...
GI_MODULE_STATIC_OR_INLINE void _field_group_set (::GdkKeymapKey* obj, gint _value) { obj->group = (decltype(obj->group)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_level_get (const ::GdkKeymapKey* obj) { return (gint) obj->level; }
...
GI_MODULE_STATIC_OR_INLINE void _field_level_set (::GdkKeymapKey* obj, gint _value) { obj->level = (decltype(obj->level)) _value; }
