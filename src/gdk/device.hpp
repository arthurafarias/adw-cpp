...
// gint gdk_device_get_active_layout_index (GdkDevice* device /*none*/);
// gint gdk_device_get_active_layout_index (::GdkDevice* device /*none*/);
GI_INLINE_DECL gint get_active_layout_index () noexcept;
...
// gchar** /*full,nullable*/ gdk_device_get_layout_names (GdkDevice* device /*none*/);
// char** /*full,nullable*/ gdk_device_get_layout_names (::GdkDevice* device /*none*/);
GI_INLINE_DECL gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> get_layout_names () noexcept;
...
gi::property_proxy<gint, base::DeviceBase> property_active_layout_index()
{ return gi::property_proxy<gint, base::DeviceBase> (*this, "active-layout-index"); }
const gi::property_proxy<gint, base::DeviceBase> property_active_layout_index() const
{ return gi::property_proxy<gint, base::DeviceBase> (*this, "active-layout-index"); }
