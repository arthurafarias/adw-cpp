...
// gint gdk_device_get_active_layout_index (::GdkDevice* device /*none*/);
gint base::DeviceBase::get_active_layout_index () noexcept
{
  typedef gint (*call_wrap_t) (::GdkDevice* device);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_device_get_active_layout_index;
...
gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> base::DeviceBase::get_layout_names () noexcept
{
  typedef char** (*call_wrap_t) (::GdkDevice* device);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_device_get_layout_names;
  auto _temp_ret = call_wrap_v ((::GdkDevice*) (gobj_()));
