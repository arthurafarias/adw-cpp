...
enum class ModifierType : std::underlying_type<GdkModifierType>::type {
  NO_MODIFIER_MASK_ = GDK_NO_MODIFIER_MASK,
...
enum class PaintableFlags : std::underlying_type<GdkPaintableFlags>::type {
  STATIC_SIZE_ = GDK_PAINTABLE_STATIC_SIZE,
  STATIC_CONTENTS_ = GDK_PAINTABLE_STATIC_CONTENTS,
};
...
enum class ToplevelCapabilities : std::underlying_type<GdkToplevelCapabilities>::type {
  EDGE_CONSTRAINTS_ = GDK_TOPLEVEL_CAPABILITIES_EDGE_CONSTRAINTS,
  INHIBIT_SHORTCUTS_ = GDK_TOPLEVEL_CAPABILITIES_INHIBIT_SHORTCUTS,
  TITLEBAR_GESTURES_ = GDK_TOPLEVEL_CAPABILITIES_TITLEBAR_GESTURES,
  WINDOW_MENU_ = GDK_TOPLEVEL_CAPABILITIES_WINDOW_MENU,
  MAXIMIZE_ = GDK_TOPLEVEL_CAPABILITIES_MAXIMIZE,
  FULLSCREEN_ = GDK_TOPLEVEL_CAPABILITIES_FULLSCREEN,
  MINIMIZE_ = GDK_TOPLEVEL_CAPABILITIES_MINIMIZE,
  LOWER_ = GDK_TOPLEVEL_CAPABILITIES_LOWER,
};

GI_FLAG_OPERATORS(ToplevelCapabilities)
...
template<> struct declare_ctype_of<Gdk::ToplevelCapabilities>
{ typedef GdkToplevelCapabilities type; }; 
template<> struct declare_cpptype_of<GdkToplevelCapabilities>
{ typedef Gdk::ToplevelCapabilities type; }; 

template<> struct declare_gtype_of<Gdk::ToplevelCapabilities>
{ static GType get_type() { return gdk_toplevel_capabilities_get_type(); } };

template<> struct is_bitfield<Gdk::ToplevelCapabilities> : public std::true_type
{};
