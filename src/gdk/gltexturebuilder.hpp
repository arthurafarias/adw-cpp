...
GI_INLINE_DECL Gdk::Texture build (GLib::DestroyNotify destroy) noexcept;
...
gi::property_proxy<Gdk::ColorState, base::GLTextureBuilderBase> property_color_state()
{ return gi::property_proxy<Gdk::ColorState, base::GLTextureBuilderBase> (*this, "color-state"); }
const gi::property_proxy<Gdk::ColorState, base::GLTextureBuilderBase> property_color_state() const
{ return gi::property_proxy<Gdk::ColorState, base::GLTextureBuilderBase> (*this, "color-state"); }
