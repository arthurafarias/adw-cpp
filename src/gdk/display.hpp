...
// GdkDmabufFormats* /*none*/ gdk_display_get_dmabuf_formats (GdkDisplay* display /*none*/);
// ::GdkDmabufFormats* /*none*/ gdk_display_get_dmabuf_formats (::GdkDisplay* display /*none*/);
GI_INLINE_DECL Gdk::DmabufFormats_Ref get_dmabuf_formats () noexcept;
...
// gboolean gdk_display_supports_shadow_width (GdkDisplay* display /*none*/);
// gboolean gdk_display_supports_shadow_width (::GdkDisplay* display /*none*/);
GI_INLINE_DECL bool supports_shadow_width () noexcept;
...
gi::property_proxy<Gdk::DmabufFormats, base::DisplayBase> property_dmabuf_formats()
{ return gi::property_proxy<Gdk::DmabufFormats, base::DisplayBase> (*this, "dmabuf-formats"); }
const gi::property_proxy<Gdk::DmabufFormats, base::DisplayBase> property_dmabuf_formats() const
{ return gi::property_proxy<Gdk::DmabufFormats, base::DisplayBase> (*this, "dmabuf-formats"); }
...
gi::property_proxy<bool, base::DisplayBase> property_shadow_width()
{ return gi::property_proxy<bool, base::DisplayBase> (*this, "shadow-width"); }
const gi::property_proxy<bool, base::DisplayBase> property_shadow_width() const
{ return gi::property_proxy<bool, base::DisplayBase> (*this, "shadow-width"); }
