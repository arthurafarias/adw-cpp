...
Gdk::Texture base::GLTextureBuilderBase::build (GLib::DestroyNotify destroy) noexcept
{
  typedef ::GdkTexture* (*call_wrap_t) (::GdkGLTextureBuilder* self, GLib::DestroyNotify::cfunction_type destroy, void* data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_gl_texture_builder_build;
  auto destroy_wrap_ = destroy ? unwrap (std::move (destroy), gi::scope_async) : nullptr;
  auto _temp_ret = call_wrap_v ((::GdkGLTextureBuilder*) (gobj_()), (GLib::DestroyNotify::cfunction_type) (destroy_wrap_ ? &destroy_wrap_->wrapper : nullptr), (void*) (destroy_wrap_));
  return gi::wrap (_temp_ret, gi::transfer_full);
}

// GdkColorState* /*none*/ gdk_gl_texture_builder_get_color_state (GdkGLTextureBuilder* self /*none*/);
// ::GdkColorState* /*none*/ gdk_gl_texture_builder_get_color_state (::GdkGLTextureBuilder* self /*none*/);
Gdk::ColorState_Ref base::GLTextureBuilderBase::get_color_state () noexcept
{
  typedef ::GdkColorState* (*call_wrap_t) (::GdkGLTextureBuilder* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_gl_texture_builder_get_color_state;
...
// void gdk_gl_texture_builder_set_color_state (GdkGLTextureBuilder* self /*none*/, GdkColorState* color_state /*none*/);
// void gdk_gl_texture_builder_set_color_state (::GdkGLTextureBuilder* self /*none*/, ::GdkColorState* color_state /*none*/);
void base::GLTextureBuilderBase::set_color_state (Gdk::ColorState_Ref color_state) noexcept
{
  typedef void (*call_wrap_t) (::GdkGLTextureBuilder* self, ::GdkColorState* color_state);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_gl_texture_builder_set_color_state;
  auto color_state_to_c = gi::unwrap (color_state, gi::transfer_none);
  call_wrap_v ((::GdkGLTextureBuilder*) (gobj_()), (::GdkColorState*) (color_state_to_c));
}
