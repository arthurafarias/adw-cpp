...
// gboolean gdk_content_formats_is_empty (GdkContentFormats* formats /*none*/);
// gboolean gdk_content_formats_is_empty (::GdkContentFormats* formats /*none*/);
bool base::ContentFormatsBase::is_empty () noexcept
{
  typedef gboolean (*call_wrap_t) (::GdkContentFormats* formats);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_content_formats_is_empty;
