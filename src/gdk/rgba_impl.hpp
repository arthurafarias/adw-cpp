...
GI_MODULE_STATIC_OR_INLINE gfloat _field_red_get (const ::GdkRGBA* obj) { return (gfloat) obj->red; }
...
GI_MODULE_STATIC_OR_INLINE void _field_red_set (::GdkRGBA* obj, gfloat _value) { obj->red = (decltype(obj->red)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gfloat _field_green_get (const ::GdkRGBA* obj) { return (gfloat) obj->green; }
...
GI_MODULE_STATIC_OR_INLINE void _field_green_set (::GdkRGBA* obj, gfloat _value) { obj->green = (decltype(obj->green)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gfloat _field_blue_get (const ::GdkRGBA* obj) { return (gfloat) obj->blue; }
...
GI_MODULE_STATIC_OR_INLINE void _field_blue_set (::GdkRGBA* obj, gfloat _value) { obj->blue = (decltype(obj->blue)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gfloat _field_alpha_get (const ::GdkRGBA* obj) { return (gfloat) obj->alpha; }
...
GI_MODULE_STATIC_OR_INLINE void _field_alpha_set (::GdkRGBA* obj, gfloat _value) { obj->alpha = (decltype(obj->alpha)) _value; }
...
// GString* /*full*/ gdk_rgba_print (const GdkRGBA* rgba /*none*/, GString* string /*none*/);
// ::GString* /*full*/ gdk_rgba_print (const ::GdkRGBA* rgba /*none*/, ::GString* string /*none*/);
GLib::String base::RGBABase::print (GLib::String_Ref string) const noexcept
{
  typedef ::GString* (*call_wrap_t) (const ::GdkRGBA* rgba, ::GString* string);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_rgba_print;
  auto string_to_c = gi::unwrap (string, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((const ::GdkRGBA*) (gobj_()), (::GString*) (string_to_c));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
