...
// double gdk_monitor_get_scale (GdkMonitor* monitor /*none*/);
// gdouble gdk_monitor_get_scale (::GdkMonitor* monitor /*none*/);
...
gi::property_proxy<gdouble, base::MonitorBase> property_scale()
{ return gi::property_proxy<gdouble, base::MonitorBase> (*this, "scale"); }
const gi::property_proxy<gdouble, base::MonitorBase> property_scale() const
{ return gi::property_proxy<gdouble, base::MonitorBase> (*this, "scale"); }
