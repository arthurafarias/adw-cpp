...
// ::GBytes* /*full*/ gdk_texture_downloader_download_bytes_with_planes (const ::GdkTextureDownloader* self /*none*/, gsize* out_offsets /*none,out,ca*/, gsize* out_strides /*none,out,ca*/);
GI_INLINE_DECL GLib::Bytes download_bytes_with_planes (gsize out_offsets[4], gsize out_strides[4]) const noexcept;
...
// ::GdkColorState* /*full*/ gdk_texture_downloader_get_color_state (const ::GdkTextureDownloader* self /*none*/);
GI_INLINE_DECL Gdk::ColorState get_color_state () const noexcept;
