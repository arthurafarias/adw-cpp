...
void PaintableInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_current_image) methods->get_current_image = (decltype (methods->get_current_image)) gi::detail::method_wrapper<self, Gdk::Paintable (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_current_image_>;
  if (init_data.get_flags) methods->get_flags = (decltype (methods->get_flags)) gi::detail::method_wrapper<self, Gdk::PaintableFlags (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_flags_>;
  if (init_data.get_intrinsic_aspect_ratio) methods->get_intrinsic_aspect_ratio = (decltype (methods->get_intrinsic_aspect_ratio)) gi::detail::method_wrapper<self, gdouble (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_intrinsic_aspect_ratio_>;
  if (init_data.get_intrinsic_height) methods->get_intrinsic_height = (decltype (methods->get_intrinsic_height)) gi::detail::method_wrapper<self, gint (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_intrinsic_height_>;
  if (init_data.get_intrinsic_width) methods->get_intrinsic_width = (decltype (methods->get_intrinsic_width)) gi::detail::method_wrapper<self, gint (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_intrinsic_width_>;
  if (init_data.snapshot) methods->snapshot = (decltype (methods->snapshot)) gi::detail::method_wrapper<self, void (*) (Gdk::Snapshot snapshot, gdouble width, gdouble height), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::snapshot_>;
}
