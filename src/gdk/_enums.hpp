...
enum class CicpRange : std::underlying_type<GdkCicpRange>::type {
  NARROW_ = GDK_CICP_RANGE_NARROW,
  FULL_ = GDK_CICP_RANGE_FULL,
};
...
template<> struct declare_ctype_of<Gdk::CicpRange>
{ typedef GdkCicpRange type; }; 
template<> struct declare_cpptype_of<GdkCicpRange>
{ typedef Gdk::CicpRange type; }; 

template<> struct declare_gtype_of<Gdk::CicpRange>
{ static GType get_type() { return gdk_cicp_range_get_type(); } };
...
enum class ColorChannel : std::underlying_type<GdkColorChannel>::type {
  RED_ = GDK_COLOR_CHANNEL_RED,
  GREEN_ = GDK_COLOR_CHANNEL_GREEN,
  BLUE_ = GDK_COLOR_CHANNEL_BLUE,
  ALPHA_ = GDK_COLOR_CHANNEL_ALPHA,
};
...
template<> struct declare_ctype_of<Gdk::ColorChannel>
{ typedef GdkColorChannel type; }; 
template<> struct declare_cpptype_of<GdkColorChannel>
{ typedef Gdk::ColorChannel type; }; 

template<> struct declare_gtype_of<Gdk::ColorChannel>
{ static GType get_type() { return gdk_color_channel_get_type(); } };
...
enum class DmabufError : std::underlying_type<GdkDmabufError>::type {
  NOT_AVAILABLE_ = GDK_DMABUF_ERROR_NOT_AVAILABLE,
  UNSUPPORTED_FORMAT_ = GDK_DMABUF_ERROR_UNSUPPORTED_FORMAT,
  CREATION_FAILED_ = GDK_DMABUF_ERROR_CREATION_FAILED,
};
...
template<> struct declare_ctype_of<Gdk::DmabufError>
{ typedef GdkDmabufError type; }; 
template<> struct declare_cpptype_of<GdkDmabufError>
{ typedef Gdk::DmabufError type; }; 

template<> struct declare_gtype_of<Gdk::DmabufError>
{ static GType get_type() { return gdk_dmabuf_error_get_type(); } };
...
enum class MemoryFormat : std::underlying_type<GdkMemoryFormat>::type {
  ...
  A8B8G8R8_PREMULTIPLIED_ = GDK_MEMORY_A8B8G8R8_PREMULTIPLIED,
  B8G8R8X8_ = GDK_MEMORY_B8G8R8X8,
  X8R8G8B8_ = GDK_MEMORY_X8R8G8B8,
  R8G8B8X8_ = GDK_MEMORY_R8G8B8X8,
  X8B8G8R8_ = GDK_MEMORY_X8B8G8R8,
  G8_B8R8_420_ = GDK_MEMORY_G8_B8R8_420,
  G8_R8B8_420_ = GDK_MEMORY_G8_R8B8_420,
  G8_B8R8_422_ = GDK_MEMORY_G8_B8R8_422,
  G8_R8B8_422_ = GDK_MEMORY_G8_R8B8_422,
  G8_B8R8_444_ = GDK_MEMORY_G8_B8R8_444,
  G8_R8B8_444_ = GDK_MEMORY_G8_R8B8_444,
  G10X6_B10X6R10X6_420_ = GDK_MEMORY_G10X6_B10X6R10X6_420,
  G12X4_B12X4R12X4_420_ = GDK_MEMORY_G12X4_B12X4R12X4_420,
  G16_B16R16_420_ = GDK_MEMORY_G16_B16R16_420,
  G8_B8_R8_410_ = GDK_MEMORY_G8_B8_R8_410,
  G8_R8_B8_410_ = GDK_MEMORY_G8_R8_B8_410,
  G8_B8_R8_411_ = GDK_MEMORY_G8_B8_R8_411,
  G8_R8_B8_411_ = GDK_MEMORY_G8_R8_B8_411,
  G8_B8_R8_420_ = GDK_MEMORY_G8_B8_R8_420,
  G8_R8_B8_420_ = GDK_MEMORY_G8_R8_B8_420,
  G8_B8_R8_422_ = GDK_MEMORY_G8_B8_R8_422,
  G8_R8_B8_422_ = GDK_MEMORY_G8_R8_B8_422,
  G8_B8_R8_444_ = GDK_MEMORY_G8_B8_R8_444,
  G8_R8_B8_444_ = GDK_MEMORY_G8_R8_B8_444,
  G8B8G8R8_422_ = GDK_MEMORY_G8B8G8R8_422,
  G8R8G8B8_422_ = GDK_MEMORY_G8R8G8B8_422,
  R8G8B8G8_422_ = GDK_MEMORY_R8G8B8G8_422,
  B8G8R8G8_422_ = GDK_MEMORY_B8G8R8G8_422,
  X6G10_X6B10_X6R10_420_ = GDK_MEMORY_X6G10_X6B10_X6R10_420,
  X6G10_X6B10_X6R10_422_ = GDK_MEMORY_X6G10_X6B10_X6R10_422,
  X6G10_X6B10_X6R10_444_ = GDK_MEMORY_X6G10_X6B10_X6R10_444,
  X4G12_X4B12_X4R12_420_ = GDK_MEMORY_X4G12_X4B12_X4R12_420,
  X4G12_X4B12_X4R12_422_ = GDK_MEMORY_X4G12_X4B12_X4R12_422,
  X4G12_X4B12_X4R12_444_ = GDK_MEMORY_X4G12_X4B12_X4R12_444,
  G16_B16_R16_420_ = GDK_MEMORY_G16_B16_R16_420,
  G16_B16_R16_422_ = GDK_MEMORY_G16_B16_R16_422,
  G16_B16_R16_444_ = GDK_MEMORY_G16_B16_R16_444,
...
enum class ScrollRelativeDirection : std::underlying_type<GdkScrollRelativeDirection>::type {
  IDENTICAL_ = GDK_SCROLL_RELATIVE_DIRECTION_IDENTICAL,
  INVERTED_ = GDK_SCROLL_RELATIVE_DIRECTION_INVERTED,
  UNKNOWN_ = GDK_SCROLL_RELATIVE_DIRECTION_UNKNOWN,
};
...
template<> struct declare_ctype_of<Gdk::ScrollRelativeDirection>
{ typedef GdkScrollRelativeDirection type; }; 
template<> struct declare_cpptype_of<GdkScrollRelativeDirection>
{ typedef Gdk::ScrollRelativeDirection type; }; 

template<> struct declare_gtype_of<Gdk::ScrollRelativeDirection>
{ static GType get_type() { return gdk_scroll_relative_direction_get_type(); } };
