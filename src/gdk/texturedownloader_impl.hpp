...
// GBytes* /*full*/ gdk_texture_downloader_download_bytes_with_planes (const GdkTextureDownloader* self /*none*/, gsize* out_offsets /*none,out,ca*/, gsize* out_strides /*none,out,ca*/);
// ::GBytes* /*full*/ gdk_texture_downloader_download_bytes_with_planes (const ::GdkTextureDownloader* self /*none*/, gsize* out_offsets /*none,out,ca*/, gsize* out_strides /*none,out,ca*/);
GLib::Bytes base::TextureDownloaderBase::download_bytes_with_planes (gsize out_offsets[4], gsize out_strides[4]) const noexcept
{
  typedef ::GBytes* (*call_wrap_t) (const ::GdkTextureDownloader* self, gsize* out_offsets, gsize* out_strides);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_texture_downloader_download_bytes_with_planes;
  auto _temp_ret = call_wrap_v ((const ::GdkTextureDownloader*) (gobj_()), (gsize*) (out_offsets), (gsize*) (out_strides));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
...
// GdkColorState* /*full*/ gdk_texture_downloader_get_color_state (const GdkTextureDownloader* self /*none*/);
// ::GdkColorState* /*full*/ gdk_texture_downloader_get_color_state (const ::GdkTextureDownloader* self /*none*/);
Gdk::ColorState base::TextureDownloaderBase::get_color_state () const noexcept
{
  typedef ::GdkColorState* (*call_wrap_t) (const ::GdkTextureDownloader* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_texture_downloader_get_color_state;
  auto _temp_ret = call_wrap_v ((const ::GdkTextureDownloader*) (gobj_()));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
...
// void gdk_texture_downloader_set_color_state (GdkTextureDownloader* self /*none*/, GdkColorState* color_state /*none*/);
// void gdk_texture_downloader_set_color_state (::GdkTextureDownloader* self /*none*/, ::GdkColorState* color_state /*none*/);
void base::TextureDownloaderBase::set_color_state (Gdk::ColorState_Ref color_state) noexcept
{
  typedef void (*call_wrap_t) (::GdkTextureDownloader* self, ::GdkColorState* color_state);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gdk_texture_downloader_set_color_state;
  auto color_state_to_c = gi::unwrap (color_state, gi::transfer_none);
  call_wrap_v ((::GdkTextureDownloader*) (gobj_()), (::GdkColorState*) (color_state_to_c));
}
