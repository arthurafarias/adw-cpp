...
GI_MODULE_STATIC_OR_INLINE gint _field_value_get (const ::GEnumValue* obj) { return (gint) obj->value; }
...
GI_MODULE_STATIC_OR_INLINE void _field_value_set (::GEnumValue* obj, gint _value) { obj->value = (decltype(obj->value)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_value_name_get (const ::GEnumValue* obj) { return (const char*) obj->value_name; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_value_nick_get (const ::GEnumValue* obj) { return (const char*) obj->value_nick; }
