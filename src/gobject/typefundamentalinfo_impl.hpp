...
GI_MODULE_STATIC_OR_INLINE ::GTypeFundamentalFlags _field_type_flags_get (const ::GTypeFundamentalInfo* obj) { return (::GTypeFundamentalFlags) obj->type_flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_type_flags_set (::GTypeFundamentalInfo* obj, ::GTypeFundamentalFlags _value) { obj->type_flags = (decltype(obj->type_flags)) _value; }
