...
GI_MODULE_STATIC_OR_INLINE guint _field_in_marshal_get (const ::GClosure* obj) { return (guint) obj->in_marshal; }
...
GI_MODULE_STATIC_OR_INLINE void _field_in_marshal_set (::GClosure* obj, guint _value) { obj->in_marshal = (decltype(obj->in_marshal)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_is_invalid_get (const ::GClosure* obj) { return (guint) obj->is_invalid; }
...
GI_MODULE_STATIC_OR_INLINE void _field_is_invalid_set (::GClosure* obj, guint _value) { obj->is_invalid = (decltype(obj->is_invalid)) _value; }
...
// GClosure* /*none*/ g_closure_new_object (guint sizeof_closure, GObject* object /*none*/);
// ::GClosure* /*none*/ g_closure_new_object (guint sizeof_closure, ::GObject* object /*none*/);
GObject::Closure_Ref base::ClosureBase::new_object (guint sizeof_closure, GObject::Object object) noexcept
{
...
// GClosure* /*none*/ g_closure_new_simple (guint sizeof_closure, gpointer data);
// ::GClosure* /*none*/ g_closure_new_simple (guint sizeof_closure, void* data);
GObject::Closure_Ref base::ClosureBase::new_simple (guint sizeof_closure, void* data) noexcept
{
...
// void g_closure_add_finalize_notifier (GClosure* closure /*none*/, gpointer notify_data, GClosureNotify notify_func /*none*/);
// void g_closure_add_finalize_notifier (::GClosure* closure /*none*/, void* notify_data,  notify_func /*none*/);
// IGNORE; not introspectable, notify_func type  not supported

// void g_closure_add_invalidate_notifier (GClosure* closure /*none*/, gpointer notify_data, GClosureNotify notify_func /*none*/);
// void g_closure_add_invalidate_notifier (::GClosure* closure /*none*/, void* notify_data,  notify_func /*none*/);
// IGNORE; not introspectable, notify_func type  not supported

// void g_closure_add_marshal_guards (GClosure* closure /*none*/, gpointer pre_marshal_data, GClosureNotify pre_marshal_notify /*none*/, gpointer post_marshal_data, GClosureNotify post_marshal_notify /*none*/);
// void g_closure_add_marshal_guards (::GClosure* closure /*none*/, void* pre_marshal_data,  pre_marshal_notify /*none*/, void* post_marshal_data,  post_marshal_notify /*none*/);
...
// GClosure* /*full*/ g_closure_ref (GClosure* closure /*none*/);
// ::GClosure* /*full*/ g_closure_ref (::GClosure* closure /*none*/);
...
// void g_closure_set_meta_marshal (GClosure* closure /*none*/, gpointer marshal_data, GClosureMarshal meta_marshal /*none*/);
// void g_closure_set_meta_marshal (::GClosure* closure /*none*/, void* marshal_data,  meta_marshal /*none*/);
...
// void g_closure_unref (GClosure* closure /*full*/);
// void g_closure_unref (::GClosure* closure /*full*/);
// IGNORE; marked ignore
