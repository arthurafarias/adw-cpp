...
GI_MODULE_STATIC_OR_INLINE guint16 _field_instance_size_get (const ::GParamSpecTypeInfo* obj) { return (guint16) obj->instance_size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_instance_size_set (::GParamSpecTypeInfo* obj, guint16 _value) { obj->instance_size = (decltype(obj->instance_size)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint16 _field_n_preallocs_get (const ::GParamSpecTypeInfo* obj) { return (guint16) obj->n_preallocs; }
...
GI_MODULE_STATIC_OR_INLINE void _field_n_preallocs_set (::GParamSpecTypeInfo* obj, guint16 _value) { obj->n_preallocs = (decltype(obj->n_preallocs)) _value; }
...
GI_MODULE_STATIC_OR_INLINE GType _field_value_type_get (const ::GParamSpecTypeInfo* obj) { return (GType) obj->value_type; }
...
GI_MODULE_STATIC_OR_INLINE void _field_value_type_set (::GParamSpecTypeInfo* obj, GType _value) { obj->value_type = (decltype(obj->value_type)) _value; }
