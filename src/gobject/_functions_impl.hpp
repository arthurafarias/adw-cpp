...
// void g_enum_complete_type_info (GType g_enum_type, ::GTypeInfo** info /*full,out*/, const ::GEnumValue** const_values /*none*/);
// SKIP; const_values in boxed array not supported (depth 1), inconsistent info out pointer depth (1 vs 2)
...
// SKIP; const_static_values in boxed array not supported (depth 1)
...
// IGNORE; not introspectable, c_marshaller type  not supported, invalid callback scope forever
...
// IGNORE; not introspectable, va_marshaller type  not supported
...
// GClosure* /*none*/ g_signal_type_cclosure_new (GType itype, guint struct_offset);
// ::GClosure* /*none*/ g_signal_type_cclosure_new (GType itype, guint struct_offset);
GObject::Closure_Ref signal_type_cclosure_new (GType itype, guint struct_offset) noexcept
{
...
// gpointer /*none*/ g_type_default_interface_get (GType g_type);
// ::GTypeInterface* /*none*/ g_type_default_interface_get (GType g_type);
GObject::TypeInterface_Ref type_default_interface_get (GType g_type) noexcept
{
  typedef ::GTypeInterface* (*call_wrap_t) (GType g_type);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_type_default_interface_get;
