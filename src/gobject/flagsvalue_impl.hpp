...
GI_MODULE_STATIC_OR_INLINE guint _field_value_get (const ::GFlagsValue* obj) { return (guint) obj->value; }
...
GI_MODULE_STATIC_OR_INLINE void _field_value_set (::GFlagsValue* obj, guint _value) { obj->value = (decltype(obj->value)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_value_name_get (const ::GFlagsValue* obj) { return (const char*) obj->value_name; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_value_nick_get (const ::GFlagsValue* obj) { return (const char*) obj->value_nick; }
