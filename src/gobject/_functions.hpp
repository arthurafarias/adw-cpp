...
// ::GClosure* /*none*/ g_signal_type_cclosure_new (GType itype, guint struct_offset);
GI_INLINE_DECL GObject::Closure_Ref signal_type_cclosure_new (GType itype, guint struct_offset) noexcept;
...
GI_INLINE_DECL GObject::TypeInterface_Ref type_default_interface_get (GType g_type) noexcept;
