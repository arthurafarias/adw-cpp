...
GI_MODULE_STATIC_OR_INLINE ::GParamSpec* _field_pspec_get (const ::GObjectConstructParam* obj) { return (::GParamSpec*) obj->pspec; }
...
GI_MODULE_STATIC_OR_INLINE ::GValue* _field_value_get (const ::GObjectConstructParam* obj) { return (::GValue*) obj->value; }
