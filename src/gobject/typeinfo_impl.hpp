...
GI_MODULE_STATIC_OR_INLINE guint16 _field_class_size_get (const ::GTypeInfo* obj) { return (guint16) obj->class_size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_class_size_set (::GTypeInfo* obj, guint16 _value) { obj->class_size = (decltype(obj->class_size)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint16 _field_instance_size_get (const ::GTypeInfo* obj) { return (guint16) obj->instance_size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_instance_size_set (::GTypeInfo* obj, guint16 _value) { obj->instance_size = (decltype(obj->instance_size)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint16 _field_n_preallocs_get (const ::GTypeInfo* obj) { return (guint16) obj->n_preallocs; }
...
GI_MODULE_STATIC_OR_INLINE void _field_n_preallocs_set (::GTypeInfo* obj, guint16 _value) { obj->n_preallocs = (decltype(obj->n_preallocs)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const ::GTypeValueTable* _field_value_table_get (const ::GTypeInfo* obj) { return (const ::GTypeValueTable*) obj->value_table; }
