...
GI_MODULE_STATIC_OR_INLINE guint _field_signal_id_get (const ::GSignalInvocationHint* obj) { return (guint) obj->signal_id; }
...
GI_MODULE_STATIC_OR_INLINE void _field_signal_id_set (::GSignalInvocationHint* obj, guint _value) { obj->signal_id = (decltype(obj->signal_id)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::GQuark _field_detail_get (const ::GSignalInvocationHint* obj) { return (::GQuark) obj->detail; }
...
GI_MODULE_STATIC_OR_INLINE void _field_detail_set (::GSignalInvocationHint* obj, ::GQuark _value) { obj->detail = (decltype(obj->detail)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::GSignalFlags _field_run_type_get (const ::GSignalInvocationHint* obj) { return (::GSignalFlags) obj->run_type; }
...
GI_MODULE_STATIC_OR_INLINE void _field_run_type_set (::GSignalInvocationHint* obj, ::GSignalFlags _value) { obj->run_type = (decltype(obj->run_type)) _value; }
