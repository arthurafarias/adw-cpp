...
GI_MODULE_STATIC_OR_INLINE guint _field_signal_id_get (const ::GSignalQuery* obj) { return (guint) obj->signal_id; }
...
GI_MODULE_STATIC_OR_INLINE void _field_signal_id_set (::GSignalQuery* obj, guint _value) { obj->signal_id = (decltype(obj->signal_id)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_signal_name_get (const ::GSignalQuery* obj) { return (const char*) obj->signal_name; }
...
GI_MODULE_STATIC_OR_INLINE GType _field_itype_get (const ::GSignalQuery* obj) { return (GType) obj->itype; }
...
GI_MODULE_STATIC_OR_INLINE void _field_itype_set (::GSignalQuery* obj, GType _value) { obj->itype = (decltype(obj->itype)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::GSignalFlags _field_signal_flags_get (const ::GSignalQuery* obj) { return (::GSignalFlags) obj->signal_flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_signal_flags_set (::GSignalQuery* obj, ::GSignalFlags _value) { obj->signal_flags = (decltype(obj->signal_flags)) _value; }
...
GI_MODULE_STATIC_OR_INLINE GType _field_return_type_get (const ::GSignalQuery* obj) { return (GType) obj->return_type; }
...
GI_MODULE_STATIC_OR_INLINE void _field_return_type_set (::GSignalQuery* obj, GType _value) { obj->return_type = (decltype(obj->return_type)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_n_params_get (const ::GSignalQuery* obj) { return (guint) obj->n_params; }
...
GI_MODULE_STATIC_OR_INLINE void _field_n_params_set (::GSignalQuery* obj, guint _value) { obj->n_params = (decltype(obj->n_params)) _value; }
