...
GI_MODULE_STATIC_OR_INLINE guint _field_use_count_get (const ::GTypeModule* obj) { return (guint) obj->use_count; }
...
GI_MODULE_STATIC_OR_INLINE void _field_use_count_set (::GTypeModule* obj, guint _value) { obj->use_count = (decltype(obj->use_count)) _value; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_name_get (const ::GTypeModule* obj) { return (char*) obj->name; }
...
void TypeModuleClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.load) methods->load = (decltype (methods->load)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::load_>;
  if (init_data.unload) methods->unload = (decltype (methods->unload)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::unload_>;
}
