...
GI_MODULE_STATIC_OR_INLINE gint _field_minimum_get (const ::GEnumClass* obj) { return (gint) obj->minimum; }
...
GI_MODULE_STATIC_OR_INLINE void _field_minimum_set (::GEnumClass* obj, gint _value) { obj->minimum = (decltype(obj->minimum)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_maximum_get (const ::GEnumClass* obj) { return (gint) obj->maximum; }
...
GI_MODULE_STATIC_OR_INLINE void _field_maximum_set (::GEnumClass* obj, gint _value) { obj->maximum = (decltype(obj->maximum)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_n_values_get (const ::GEnumClass* obj) { return (guint) obj->n_values; }
...
GI_MODULE_STATIC_OR_INLINE void _field_n_values_set (::GEnumClass* obj, guint _value) { obj->n_values = (decltype(obj->n_values)) _value; }
