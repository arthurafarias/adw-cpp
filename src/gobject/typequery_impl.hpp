...
GI_MODULE_STATIC_OR_INLINE GType _field_type_get (const ::GTypeQuery* obj) { return (GType) obj->type; }
...
GI_MODULE_STATIC_OR_INLINE void _field_type_set (::GTypeQuery* obj, GType _value) { obj->type = (decltype(obj->type)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_type_name_get (const ::GTypeQuery* obj) { return (const char*) obj->type_name; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_class_size_get (const ::GTypeQuery* obj) { return (guint) obj->class_size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_class_size_set (::GTypeQuery* obj, guint _value) { obj->class_size = (decltype(obj->class_size)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_instance_size_get (const ::GTypeQuery* obj) { return (guint) obj->instance_size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_instance_size_set (::GTypeQuery* obj, guint _value) { obj->instance_size = (decltype(obj->instance_size)) _value; }
