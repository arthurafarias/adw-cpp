...
GI_MODULE_STATIC_OR_INLINE const char* _field_collect_format_get (const ::GTypeValueTable* obj) { return (const char*) obj->collect_format; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_lcopy_format_get (const ::GTypeValueTable* obj) { return (const char*) obj->lcopy_format; }
...
// GTypeValueTable* /*none,nullable*/ g_type_value_table_peek (GType type);
// ::GTypeValueTable* /*none,nullable*/ g_type_value_table_peek (GType type);
GObject::TypeValueTable_Ref base::TypeValueTableBase::peek (GType type) noexcept
{
  typedef ::GTypeValueTable* (*call_wrap_t) (GType type);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_type_value_table_peek;
  auto type_to_c = type;
