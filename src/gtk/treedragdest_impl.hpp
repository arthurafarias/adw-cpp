...
void TreeDragDestIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.drag_data_received) methods->drag_data_received = (decltype (methods->drag_data_received)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreePath_Ref dest, const GObject::Value_Ref value), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::drag_data_received_>;
  if (init_data.row_drop_possible) methods->row_drop_possible = (decltype (methods->row_drop_possible)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreePath_Ref dest_path, const GObject::Value_Ref value), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::row_drop_possible_>;
}
