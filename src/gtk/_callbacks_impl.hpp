...
void TextBufferCommitNotify_CF (Gtk::TextBuffer buffer, Gtk::TextBufferNotifyFlags flags, guint position, guint length, TextBufferCommitNotify_CF_CType _call, gpointer user_data) noexcept
{
  auto user_data_to_c = user_data;
  ...
  _call ((::GtkTextBuffer*) (buffer_to_c), (::GtkTextBufferNotifyFlags) (flags_to_c), (guint) (position_to_c), (guint) (length_to_c), (void*) (user_data_to_c));
}
} // namespace internal
