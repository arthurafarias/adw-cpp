...
GI_MODULE_STATIC_OR_INLINE gint _field_stamp_get (const ::GtkTreeIter* obj) { return (gint) obj->stamp; }
...
GI_MODULE_STATIC_OR_INLINE void _field_stamp_set (::GtkTreeIter* obj, gint _value) { obj->stamp = (decltype(obj->stamp)) _value; }
