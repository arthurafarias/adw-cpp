...
// (signal) gboolean change-current-page (gint page);
// (signal) gboolean change-current-page (gint page);
gi::signal_proxy<bool(Gtk::Notebook, gint page)> signal_change_current_page()
{ return gi::signal_proxy<bool(Gtk::Notebook, gint page)> (*this, "change-current-page"); }
...
// (signal) gboolean focus-tab ( tab);
// (signal) gboolean focus-tab (::GtkNotebookTab tab);
gi::signal_proxy<bool(Gtk::Notebook, Gtk::NotebookTab tab)> signal_focus_tab()
{ return gi::signal_proxy<bool(Gtk::Notebook, Gtk::NotebookTab tab)> (*this, "focus-tab"); }

// (signal) void move-focus-out ( direction);
// (signal) void move-focus-out (::GtkDirectionType direction);
gi::signal_proxy<void(Gtk::Notebook, Gtk::DirectionType direction)> signal_move_focus_out()
{ return gi::signal_proxy<void(Gtk::Notebook, Gtk::DirectionType direction)> (*this, "move-focus-out"); }
...
// (signal) gboolean reorder-tab ( direction, gboolean move_to_last);
// (signal) gboolean reorder-tab (::GtkDirectionType direction, gboolean move_to_last);
gi::signal_proxy<bool(Gtk::Notebook, Gtk::DirectionType direction, gboolean move_to_last)> signal_reorder_tab()
{ return gi::signal_proxy<bool(Gtk::Notebook, Gtk::DirectionType direction, gboolean move_to_last)> (*this, "reorder-tab"); }

// (signal) gboolean select-page (gboolean move_focus);
// (signal) gboolean select-page (gboolean move_focus);
gi::signal_proxy<bool(Gtk::Notebook, gboolean move_focus)> signal_select_page()
{ return gi::signal_proxy<bool(Gtk::Notebook, gboolean move_focus)> (*this, "select-page"); }
