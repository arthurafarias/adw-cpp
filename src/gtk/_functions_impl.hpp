...
namespace SvgErrorNS_ {

// const char* /*none,nullable*/ gtk_svg_error_get_attribute (const GError* error /*none*/);
// const char* /*none,nullable*/ gtk_svg_error_get_attribute (const ::GError* error /*none*/);
gi::cstring_v get_attribute (const GLib::Error_Ref error) noexcept
{
  typedef const char* (*call_wrap_t) (const ::GError* error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_svg_error_get_attribute;
  auto error_to_c = gi::unwrap (error, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((const ::GError*) (error_to_c));
  return gi::wrap (_temp_ret, gi::transfer_none);
}

// const char* /*none,nullable*/ gtk_svg_error_get_element (const GError* error /*none*/);
// const char* /*none,nullable*/ gtk_svg_error_get_element (const ::GError* error /*none*/);
gi::cstring_v get_element (const GLib::Error_Ref error) noexcept
{
  typedef const char* (*call_wrap_t) (const ::GError* error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_svg_error_get_element;
  auto error_to_c = gi::unwrap (error, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((const ::GError*) (error_to_c));
  return gi::wrap (_temp_ret, gi::transfer_none);
}

// const GtkSvgLocation* /*none,nullable*/ gtk_svg_error_get_end (const GError* error /*none*/);
// const ::GtkSvgLocation* /*none,nullable*/ gtk_svg_error_get_end (const ::GError* error /*none*/);
Gtk::SvgLocation_Ref get_end (const GLib::Error_Ref error) noexcept
{
  typedef const ::GtkSvgLocation* (*call_wrap_t) (const ::GError* error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_svg_error_get_end;
  auto error_to_c = gi::unwrap (error, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((const ::GError*) (error_to_c));
  return gi::wrap (_temp_ret, gi::transfer_none);
}

// const GtkSvgLocation* /*none,nullable*/ gtk_svg_error_get_start (const GError* error /*none*/);
// const ::GtkSvgLocation* /*none,nullable*/ gtk_svg_error_get_start (const ::GError* error /*none*/);
Gtk::SvgLocation_Ref get_start (const GLib::Error_Ref error) noexcept
{
  typedef const ::GtkSvgLocation* (*call_wrap_t) (const ::GError* error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_svg_error_get_start;
  auto error_to_c = gi::unwrap (error, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((const ::GError*) (error_to_c));
  return gi::wrap (_temp_ret, gi::transfer_none);
}

// GQuark gtk_svg_error_quark ();
// ::GQuark gtk_svg_error_quark ();
GLib::Quark quark () noexcept
{
  typedef ::GQuark (*call_wrap_t) ();
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_svg_error_quark;
  auto _temp_ret = call_wrap_v ();
  return _temp_ret;
}
...
// char* /*full*/ gtk_accelerator_get_accessible_label (guint accelerator_key, GdkModifierType accelerator_mods);
// char* /*full*/ gtk_accelerator_get_accessible_label (guint accelerator_key, ::GdkModifierType accelerator_mods);
gi::cstring accelerator_get_accessible_label (guint accelerator_key, Gdk::ModifierType accelerator_mods) noexcept
{
  typedef char* (*call_wrap_t) (guint accelerator_key, ::GdkModifierType accelerator_mods);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_accelerator_get_accessible_label;
...
// void gtk_disable_portal_interfaces (const char** portal_interfaces /*none*/);
// void gtk_disable_portal_interfaces (const char** portal_interfaces /*none*/);
void disable_portal_interfaces (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> portal_interfaces) noexcept
{
  typedef void (*call_wrap_t) (const char** portal_interfaces);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_disable_portal_interfaces;
  auto portal_interfaces_w = unwrap (std::move(portal_interfaces), gi::transfer_none);
  auto portal_interfaces_to_c = portal_interfaces_w;
  call_wrap_v ((const char**) (portal_interfaces_to_c));
}

// void gtk_disable_portals ();
// void gtk_disable_portals ();
void disable_portals () noexcept
{
  typedef void (*call_wrap_t) ();
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_disable_portals;
  call_wrap_v ();
}
