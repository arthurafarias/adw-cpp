...
// guint gtk_text_buffer_add_commit_notify (GtkTextBuffer* buffer /*none*/, GtkTextBufferNotifyFlags flags, GtkTextBufferCommitNotify commit_notify /*none*/, gpointer user_data, GDestroyNotify destroy /*none*/);
// guint gtk_text_buffer_add_commit_notify (::GtkTextBuffer* buffer /*none*/, ::GtkTextBufferNotifyFlags flags, Gtk::TextBufferCommitNotify::cfunction_type commit_notify /*none*/, void* user_data, GLib::DestroyNotify::cfunction_type destroy /*none*/);
guint base::TextBufferBase::add_commit_notify (Gtk::TextBufferNotifyFlags flags, Gtk::TextBufferCommitNotify commit_notify) noexcept
{
  typedef guint (*call_wrap_t) (::GtkTextBuffer* buffer, ::GtkTextBufferNotifyFlags flags, Gtk::TextBufferCommitNotify::cfunction_type commit_notify, void* user_data, GLib::DestroyNotify::cfunction_type destroy);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_text_buffer_add_commit_notify;
  auto commit_notify_wrap_ = commit_notify ? unwrap (std::move (commit_notify), gi::scope_notified) : nullptr;
  auto flags_to_c = gi::unwrap (flags);
  auto _temp_ret = call_wrap_v ((::GtkTextBuffer*) (gobj_()), (::GtkTextBufferNotifyFlags) (flags_to_c), (Gtk::TextBufferCommitNotify::cfunction_type) (commit_notify_wrap_ ? &commit_notify_wrap_->wrapper : nullptr), (void*) (commit_notify_wrap_), (GLib::DestroyNotify::cfunction_type) (commit_notify_wrap_ ? &commit_notify_wrap_->destroy : nullptr));
  return _temp_ret;
}
...
// void gtk_text_buffer_remove_commit_notify (GtkTextBuffer* buffer /*none*/, guint commit_notify_handler);
// void gtk_text_buffer_remove_commit_notify (::GtkTextBuffer* buffer /*none*/, guint commit_notify_handler);
void base::TextBufferBase::remove_commit_notify (guint commit_notify_handler) noexcept
{
  typedef void (*call_wrap_t) (::GtkTextBuffer* buffer, guint commit_notify_handler);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_text_buffer_remove_commit_notify;
  auto commit_notify_handler_to_c = commit_notify_handler;
  call_wrap_v ((::GtkTextBuffer*) (gobj_()), (guint) (commit_notify_handler_to_c));
}
...
void TextBufferClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.apply_tag) methods->apply_tag = (decltype (methods->apply_tag)) gi::detail::method_wrapper<self, void (*) (Gtk::TextTag tag, const Gtk::TextIter_Ref start, const Gtk::TextIter_Ref end), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::apply_tag_>;
  if (init_data.begin_user_action) methods->begin_user_action = (decltype (methods->begin_user_action)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::begin_user_action_>;
  ...
  if (init_data.delete_range) methods->delete_range = (decltype (methods->delete_range)) gi::detail::method_wrapper<self, void (*) (Gtk::TextIter_Ref start, Gtk::TextIter_Ref end), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::delete_range_>;
  if (init_data.end_user_action) methods->end_user_action = (decltype (methods->end_user_action)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::end_user_action_>;
  if (init_data.insert_child_anchor) methods->insert_child_anchor = (decltype (methods->insert_child_anchor)) gi::detail::method_wrapper<self, void (*) (Gtk::TextIter_Ref iter, Gtk::TextChildAnchor anchor), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::insert_child_anchor_>;
  if (init_data.insert_paintable) methods->insert_paintable = (decltype (methods->insert_paintable)) gi::detail::method_wrapper<self, void (*) (Gtk::TextIter_Ref iter, Gdk::Paintable paintable), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::insert_paintable_>;
  if (init_data.insert_text) methods->insert_text = (decltype (methods->insert_text)) gi::detail::method_wrapper<self, void (*) (Gtk::TextIter_Ref pos, const gi::cstring_v new_text, gint new_text_length), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::insert_text_>;
  if (init_data.mark_deleted) methods->mark_deleted = (decltype (methods->mark_deleted)) gi::detail::method_wrapper<self, void (*) (Gtk::TextMark mark), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::mark_deleted_>;
  if (init_data.mark_set) methods->mark_set = (decltype (methods->mark_set)) gi::detail::method_wrapper<self, void (*) (const Gtk::TextIter_Ref location, Gtk::TextMark mark), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::mark_set_>;
  if (init_data.modified_changed) methods->modified_changed = (decltype (methods->modified_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::modified_changed_>;
  if (init_data.paste_done) methods->paste_done = (decltype (methods->paste_done)) gi::detail::method_wrapper<self, void (*) (Gdk::Clipboard clipboard), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::paste_done_>;
  if (init_data.redo) methods->redo = (decltype (methods->redo)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::redo_>;
  if (init_data.remove_tag) methods->remove_tag = (decltype (methods->remove_tag)) gi::detail::method_wrapper<self, void (*) (Gtk::TextTag tag, const Gtk::TextIter_Ref start, const Gtk::TextIter_Ref end), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::remove_tag_>;
  if (init_data.undo) methods->undo = (decltype (methods->undo)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::undo_>;
}
