...
// gboolean gtk_header_bar_get_use_native_controls (GtkHeaderBar* bar /*none*/);
// gboolean gtk_header_bar_get_use_native_controls (::GtkHeaderBar* bar /*none*/);
...
// void gtk_header_bar_set_use_native_controls (GtkHeaderBar* bar /*none*/, gboolean setting);
// void gtk_header_bar_set_use_native_controls (::GtkHeaderBar* bar /*none*/, gboolean setting);
...
gi::property_proxy<bool, base::HeaderBarBase> property_use_native_controls()
{ return gi::property_proxy<bool, base::HeaderBarBase> (*this, "use-native-controls"); }
const gi::property_proxy<bool, base::HeaderBarBase> property_use_native_controls() const
{ return gi::property_proxy<bool, base::HeaderBarBase> (*this, "use-native-controls"); }
