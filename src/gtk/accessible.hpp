...
// void gtk_accessible_announce (::GtkAccessible* self /*none*/, const char* message /*none*/, ::GtkAccessibleAnnouncementPriority priority);
GI_INLINE_DECL void announce (const gi::cstring_v message, Gtk::AccessibleAnnouncementPriority priority) noexcept;

// char* /*full,nullable*/ gtk_accessible_get_accessible_id (GtkAccessible* self /*none*/);
// char* /*full,nullable*/ gtk_accessible_get_accessible_id (::GtkAccessible* self /*none*/);
GI_INLINE_DECL gi::cstring get_accessible_id () noexcept;
...
// void gtk_accessible_update_platform_state (::GtkAccessible* self /*none*/, ::GtkAccessiblePlatformState state);
GI_INLINE_DECL void update_platform_state (Gtk::AccessiblePlatformState state) noexcept;
...
using GI_MEMBER_CHECK_CONFLICT(get_accessible_id) = self;
...
// char* /*full,nullable*/ Accessible::get_accessible_id (::GtkAccessible* self /*none*/);
virtual gi::cstring get_accessible_id_ () noexcept = 0;
...
// char* /*full,nullable*/ Accessible::get_accessible_id (GtkAccessible* self /*none*/);
// char* /*full,nullable*/ Accessible::get_accessible_id (::GtkAccessible* self /*none*/);
GI_INLINE_DECL gi::cstring get_accessible_id_ () noexcept override;
...
{
  GI_MEMBER_DEFINE(AccessibleInterfaceClassImpl, get_accessible_id)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, get_accessible_id),
