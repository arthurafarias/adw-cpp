...
enum class DebugFlags : std::underlying_type<GtkDebugFlags>::type {
  ...
  BUILDER_TRACE_ = GTK_DEBUG_BUILDER_TRACE,
...
enum class EventControllerScrollFlags : std::underlying_type<GtkEventControllerScrollFlags>::type {
  ...
  PHYSICAL_DIRECTION_ = GTK_EVENT_CONTROLLER_SCROLL_PHYSICAL_DIRECTION,
...
enum class PopoverMenuFlags : std::underlying_type<GtkPopoverMenuFlags>::type {
  SLIDING_ = GTK_POPOVER_MENU_SLIDING,
...
enum class SvgFeatures : std::underlying_type<GtkSvgFeatures>::type {
  ANIMATIONS_ = GTK_SVG_ANIMATIONS,
  SYSTEM_RESOURCES_ = GTK_SVG_SYSTEM_RESOURCES,
  EXTERNAL_RESOURCES_ = GTK_SVG_EXTERNAL_RESOURCES,
  EXTENSIONS_ = GTK_SVG_EXTENSIONS,
  TRADITIONAL_SYMBOLIC_ = GTK_SVG_TRADITIONAL_SYMBOLIC,
};

GI_FLAG_OPERATORS(SvgFeatures)
...
template<> struct declare_ctype_of<Gtk::SvgFeatures>
{ typedef GtkSvgFeatures type; }; 
template<> struct declare_cpptype_of<GtkSvgFeatures>
{ typedef Gtk::SvgFeatures type; }; 

template<> struct declare_gtype_of<Gtk::SvgFeatures>
{ static GType get_type() { return gtk_svg_features_get_type(); } };

template<> struct is_bitfield<Gtk::SvgFeatures> : public std::true_type
{};
...
enum class TextBufferNotifyFlags : std::underlying_type<GtkTextBufferNotifyFlags>::type {
  BEFORE_INSERT_ = GTK_TEXT_BUFFER_NOTIFY_BEFORE_INSERT,
  AFTER_INSERT_ = GTK_TEXT_BUFFER_NOTIFY_AFTER_INSERT,
  BEFORE_DELETE_ = GTK_TEXT_BUFFER_NOTIFY_BEFORE_DELETE,
  AFTER_DELETE_ = GTK_TEXT_BUFFER_NOTIFY_AFTER_DELETE,
};

GI_FLAG_OPERATORS(TextBufferNotifyFlags)
...
template<> struct declare_ctype_of<Gtk::TextBufferNotifyFlags>
{ typedef GtkTextBufferNotifyFlags type; }; 
template<> struct declare_cpptype_of<GtkTextBufferNotifyFlags>
{ typedef Gtk::TextBufferNotifyFlags type; }; 

template<> struct declare_gtype_of<Gtk::TextBufferNotifyFlags>
{ static GType get_type() { return gtk_text_buffer_notify_flags_get_type(); } };

template<> struct is_bitfield<Gtk::TextBufferNotifyFlags> : public std::true_type
{};
