...
// gboolean gtk_header_bar_get_use_native_controls (::GtkHeaderBar* bar /*none*/);
bool base::HeaderBarBase::get_use_native_controls () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkHeaderBar* bar);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_header_bar_get_use_native_controls;
  auto _temp_ret = call_wrap_v ((::GtkHeaderBar*) (gobj_()));
  return _temp_ret;
}
...
// void gtk_header_bar_set_use_native_controls (::GtkHeaderBar* bar /*none*/, gboolean setting);
void base::HeaderBarBase::set_use_native_controls (gboolean setting) noexcept
{
  typedef void (*call_wrap_t) (::GtkHeaderBar* bar, gboolean setting);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_header_bar_set_use_native_controls;
  auto setting_to_c = setting;
  call_wrap_v ((::GtkHeaderBar*) (gobj_()), (gboolean) (setting_to_c));
}
