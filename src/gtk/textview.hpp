...
GI_INLINE_DECL Gtk::AccessibleText interface_ (gi::interface_tag<Gtk::AccessibleText>);

GI_INLINE_DECL operator Gtk::AccessibleText ();
...
GI_INLINE_DECL void get_visible_offset (gdouble & x_offset, gdouble & y_offset) noexcept;
GI_INLINE_DECL std::tuple<gdouble, gdouble> get_visible_offset () noexcept;
...
using GI_MEMBER_CHECK_CONFLICT(snapshot_layer) = self;
...
virtual void snapshot_layer_ (Gtk::TextViewLayer layer, Gtk::Snapshot snapshot) noexcept = 0;
...
class TextViewClass: public detail::ClassTemplate<Gtk::impl::internal::TextViewClassDef, Gtk::impl::internal::WidgetClass, Gtk::impl::internal::AccessibleTextInterfaceClassImpl, Gtk::impl::internal::ScrollableInterfaceClassImpl>
{
friend class internal::TextViewClassDef;
typedef TextViewClass self;
typedef detail::ClassTemplate<Gtk::impl::internal::TextViewClassDef, Gtk::impl::internal::WidgetClass, Gtk::impl::internal::AccessibleTextInterfaceClassImpl, Gtk::impl::internal::ScrollableInterfaceClassImpl> super;
...
typedef Gtk::impl::internal::AccessibleTextInterfaceClassImpl GtkAccessibleTextInterface_type;
...
// void TextView::snapshot_layer (GtkTextView* text_view /*none*/, GtkTextViewLayer layer, GtkSnapshot* snapshot /*none*/);
// void TextView::snapshot_layer (::GtkTextView* text_view /*none*/, ::GtkTextViewLayer layer, ::GI_PATCH_GtkSnapshot* snapshot /*none*/);
GI_INLINE_DECL void snapshot_layer_ (Gtk::TextViewLayer layer, Gtk::Snapshot snapshot) noexcept override;
...
struct TextViewClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(TextViewClass, snapshot_layer)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, snapshot_layer),
