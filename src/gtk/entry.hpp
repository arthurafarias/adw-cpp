...
// const gchar* /*none,nullable*/ gtk_entry_get_menu_entry_icon_text (GtkEntry* entry /*none*/, GtkEntryIconPosition icon_pos);
// const char* /*none,nullable*/ gtk_entry_get_menu_entry_icon_text (::GtkEntry* entry /*none*/, ::GtkEntryIconPosition icon_pos);
GI_INLINE_DECL gi::cstring_v get_menu_entry_icon_text (Gtk::EntryIconPosition icon_pos) noexcept;
...
// void gtk_entry_set_menu_entry_icon_text (GtkEntry* entry /*none*/, GtkEntryIconPosition icon_pos, const gchar* text /*none*/);
// void gtk_entry_set_menu_entry_icon_text (::GtkEntry* entry /*none*/, ::GtkEntryIconPosition icon_pos, const char* text /*none*/);
GI_INLINE_DECL void set_menu_entry_icon_text (Gtk::EntryIconPosition icon_pos, const gi::cstring_v text) noexcept;
...
gi::property_proxy<gi::cstring, base::EntryBase> property_menu_entry_icon_primary_text()
{ return gi::property_proxy<gi::cstring, base::EntryBase> (*this, "menu-entry-icon-primary-text"); }
const gi::property_proxy<gi::cstring, base::EntryBase> property_menu_entry_icon_primary_text() const
{ return gi::property_proxy<gi::cstring, base::EntryBase> (*this, "menu-entry-icon-primary-text"); }

gi::property_proxy<gi::cstring, base::EntryBase> property_menu_entry_icon_secondary_text()
{ return gi::property_proxy<gi::cstring, base::EntryBase> (*this, "menu-entry-icon-secondary-text"); }
const gi::property_proxy<gi::cstring, base::EntryBase> property_menu_entry_icon_secondary_text() const
{ return gi::property_proxy<gi::cstring, base::EntryBase> (*this, "menu-entry-icon-secondary-text"); }
