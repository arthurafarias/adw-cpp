...
// gboolean gtk_spin_button_get_activates_default (GtkSpinButton* spin_button /*none*/);
// gboolean gtk_spin_button_get_activates_default (::GtkSpinButton* spin_button /*none*/);
bool base::SpinButtonBase::get_activates_default () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkSpinButton* spin_button);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_spin_button_get_activates_default;
...
// void gtk_spin_button_set_activates_default (GtkSpinButton* spin_button /*none*/, gboolean activates_default);
// void gtk_spin_button_set_activates_default (::GtkSpinButton* spin_button /*none*/, gboolean activates_default);
void base::SpinButtonBase::set_activates_default (gboolean activates_default) noexcept
{
  typedef void (*call_wrap_t) (::GtkSpinButton* spin_button, gboolean activates_default);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_spin_button_set_activates_default;
  auto activates_default_to_c = activates_default;
  call_wrap_v ((::GtkSpinButton*) (gobj_()), (gboolean) (activates_default_to_c));
}
