...
GI_MODULE_STATIC_OR_INLINE gint _field_width_get (const ::GtkRequisition* obj) { return (gint) obj->width; }
...
GI_MODULE_STATIC_OR_INLINE void _field_width_set (::GtkRequisition* obj, gint _value) { obj->width = (decltype(obj->width)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_height_get (const ::GtkRequisition* obj) { return (gint) obj->height; }
...
GI_MODULE_STATIC_OR_INLINE void _field_height_set (::GtkRequisition* obj, gint _value) { obj->height = (decltype(obj->height)) _value; }
