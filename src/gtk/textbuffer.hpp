...
GI_INLINE_DECL guint add_commit_notify (Gtk::TextBufferNotifyFlags flags, Gtk::TextBufferCommitNotify commit_notify) noexcept;
...
// void gtk_text_buffer_remove_commit_notify (::GtkTextBuffer* buffer /*none*/, guint commit_notify_handler);
GI_INLINE_DECL void remove_commit_notify (guint commit_notify_handler) noexcept;
