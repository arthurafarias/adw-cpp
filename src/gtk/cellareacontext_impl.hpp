...
void CellAreaContextClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.allocate) methods->allocate = (decltype (methods->allocate)) gi::detail::method_wrapper<self, void (*) (gint width, gint height), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::allocate_>;
  if (init_data.get_preferred_height_for_width) methods->get_preferred_height_for_width = (decltype (methods->get_preferred_height_for_width)) gi::detail::method_wrapper<self, void (*) (gint width, gint & minimum_height, gint & natural_height), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_preferred_height_for_width_>;
  if (init_data.get_preferred_width_for_height) methods->get_preferred_width_for_height = (decltype (methods->get_preferred_width_for_height)) gi::detail::method_wrapper<self, void (*) (gint height, gint & minimum_width, gint & natural_width), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_preferred_width_for_height_>;
