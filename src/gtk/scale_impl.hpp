...
void ScaleClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.get_layout_offsets) methods->get_layout_offsets = (decltype (methods->get_layout_offsets)) gi::detail::method_wrapper<self, void (*) (gint & x, gint & y), gi::transfer_full_t, std::tuple<gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_layout_offsets_>;
}
