...
void TreeSortableIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_sort_column_id) methods->get_sort_column_id = (decltype (methods->get_sort_column_id)) gi::detail::method_wrapper<self, bool (*) (gint & sort_column_id, Gtk::SortType & order), gi::transfer_none_t, std::tuple<gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_sort_column_id_>;
  if (init_data.has_default_sort_func) methods->has_default_sort_func = (decltype (methods->has_default_sort_func)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::has_default_sort_func_>;
  if (init_data.set_default_sort_func) methods->set_default_sort_func = (decltype (methods->set_default_sort_func)) gi::detail::method_wrapper<self, void (*) (Gtk::TreeIterCompareFunc sort_func), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, Gtk::internal::TreeIterCompareFunc_CB_Trait, detail::args_index<0, 1, 2>>>, void  (Gtk::TreeIterCompareFunc::cfunction_type sort_func, void* user_data, GLib::DestroyNotify::cfunction_type destroy)>::wrapper<&self::set_default_sort_func_>;
  if (init_data.set_sort_column_id) methods->set_sort_column_id = (decltype (methods->set_sort_column_id)) gi::detail::method_wrapper<self, void (*) (gint sort_column_id, Gtk::SortType order), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::set_sort_column_id_>;
  if (init_data.set_sort_func) methods->set_sort_func = (decltype (methods->set_sort_func)) gi::detail::method_wrapper<self, void (*) (gint sort_column_id, Gtk::TreeIterCompareFunc sort_func), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, Gtk::internal::TreeIterCompareFunc_CB_Trait, detail::args_index<1, 2, 3>>>, void  (gint sort_column_id, Gtk::TreeIterCompareFunc::cfunction_type sort_func, void* user_data, GLib::DestroyNotify::cfunction_type destroy)>::wrapper<&self::set_sort_func_>;
  if (init_data.sort_column_changed) methods->sort_column_changed = (decltype (methods->sort_column_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::sort_column_changed_>;
}
