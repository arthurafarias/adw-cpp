...
void TreeDragSourceIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.drag_data_delete) methods->drag_data_delete = (decltype (methods->drag_data_delete)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreePath_Ref path), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::drag_data_delete_>;
  if (init_data.drag_data_get) methods->drag_data_get = (decltype (methods->drag_data_get)) gi::detail::method_wrapper<self, Gdk::ContentProvider (*) (Gtk::TreePath_Ref path), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::drag_data_get_>;
  if (init_data.row_draggable) methods->row_draggable = (decltype (methods->row_draggable)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreePath_Ref path), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::row_draggable_>;
}
