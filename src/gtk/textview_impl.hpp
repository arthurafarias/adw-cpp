...
Gtk::AccessibleText TextViewBase::interface_ (gi::interface_tag<Gtk::AccessibleText>)
{ return gi::wrap ((Gtk::AccessibleText::BaseObjectType*) gobj_copy_(), gi::transfer_full); }

TextViewBase::operator Gtk::AccessibleText ()
{ return interface_ (gi::interface_tag<Gtk::AccessibleText>()); }
...
// GMenuModel* /*none,nullable*/ gtk_text_view_get_extra_menu (GtkTextView* text_view /*none*/);
// ::GMenuModel* /*none,nullable*/ gtk_text_view_get_extra_menu (::GtkTextView* text_view /*none*/);
...
// void gtk_text_view_get_visible_offset (GtkTextView* text_view /*none*/, double* x_offset, double* y_offset);
// void gtk_text_view_get_visible_offset (::GtkTextView* text_view /*none*/, gdouble* x_offset, gdouble* y_offset);
void base::TextViewBase::get_visible_offset (gdouble & x_offset, gdouble & y_offset) noexcept
{
  typedef void (*call_wrap_t) (::GtkTextView* text_view, gdouble* x_offset, gdouble* y_offset);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_text_view_get_visible_offset;
  gdouble y_offset_o {};
  gdouble x_offset_o {};
  call_wrap_v ((::GtkTextView*) (gobj_()), (gdouble*) (&x_offset_o), (gdouble*) (&y_offset_o));
  y_offset = y_offset_o;
  x_offset = x_offset_o;
}
std::tuple<gdouble, gdouble> base::TextViewBase::get_visible_offset () noexcept
{
  typedef void (*call_wrap_t) (::GtkTextView* text_view, gdouble* x_offset, gdouble* y_offset);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_text_view_get_visible_offset;
  gdouble y_offset_o {};
...
void TextViewClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.backspace) methods->backspace = (decltype (methods->backspace)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::backspace_>;
  if (init_data.copy_clipboard) methods->copy_clipboard = (decltype (methods->copy_clipboard)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::copy_clipboard_>;
  if (init_data.cut_clipboard) methods->cut_clipboard = (decltype (methods->cut_clipboard)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::cut_clipboard_>;
  if (init_data.delete_from_cursor) methods->delete_from_cursor = (decltype (methods->delete_from_cursor)) gi::detail::method_wrapper<self, void (*) (Gtk::DeleteType type, gint count), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::delete_from_cursor_>;
  if (init_data.extend_selection) methods->extend_selection = (decltype (methods->extend_selection)) gi::detail::method_wrapper<self, bool (*) (Gtk::TextExtendSelection granularity, const Gtk::TextIter_Ref location, Gtk::TextIter_Ref start, Gtk::TextIter_Ref end), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::extend_selection_>;
  if (init_data.insert_at_cursor) methods->insert_at_cursor = (decltype (methods->insert_at_cursor)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v str), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::insert_at_cursor_>;
  if (init_data.insert_emoji) methods->insert_emoji = (decltype (methods->insert_emoji)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::insert_emoji_>;
  if (init_data.move_cursor) methods->move_cursor = (decltype (methods->move_cursor)) gi::detail::method_wrapper<self, void (*) (Gtk::MovementStep step, gint count, gboolean extend_selection), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::move_cursor_>;
  if (init_data.paste_clipboard) methods->paste_clipboard = (decltype (methods->paste_clipboard)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::paste_clipboard_>;
  if (init_data.set_anchor) methods->set_anchor = (decltype (methods->set_anchor)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::set_anchor_>;
  if (init_data.snapshot_layer) methods->snapshot_layer = (decltype (methods->snapshot_layer)) gi::detail::method_wrapper<self, void (*) (Gtk::TextViewLayer layer, Gtk::Snapshot snapshot), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::snapshot_layer_>;
  if (init_data.toggle_overwrite) methods->toggle_overwrite = (decltype (methods->toggle_overwrite)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::toggle_overwrite_>;
}
...
// void TextView::snapshot_layer (::GtkTextView* text_view /*none*/, ::GtkTextViewLayer layer, ::GI_PATCH_GtkSnapshot* snapshot /*none*/);
void TextViewClass::snapshot_layer_ (Gtk::TextViewLayer layer, Gtk::Snapshot snapshot) noexcept
{
  if (!get_struct_()->snapshot_layer) { g_critical ("no method in class struct"); return ; }
  typedef void (*call_wrap_t) (::GtkTextView* text_view, ::GtkTextViewLayer layer, ::GI_PATCH_GtkSnapshot* snapshot);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->snapshot_layer;
  auto snapshot_to_c = gi::unwrap (snapshot, gi::transfer_none);
  auto layer_to_c = gi::unwrap (layer);
  call_wrap_v ((::GtkTextView*) (gobj_()), (::GtkTextViewLayer) (layer_to_c), (::GI_PATCH_GtkSnapshot*) (snapshot_to_c));
}
