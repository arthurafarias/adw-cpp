...
// guint gtk_string_list_find (GtkStringList* self /*none*/, const char* string /*none*/);
// guint gtk_string_list_find (::GtkStringList* self /*none*/, const char* string /*none*/);
GI_INLINE_DECL guint find (const gi::cstring_v string) noexcept;
...
gi::property_proxy<GType, base::StringListBase> property_item_type()
{ return gi::property_proxy<GType, base::StringListBase> (*this, "item-type"); }
const gi::property_proxy<GType, base::StringListBase> property_item_type() const
{ return gi::property_proxy<GType, base::StringListBase> (*this, "item-type"); }

gi::property_proxy<guint, base::StringListBase> property_n_items()
{ return gi::property_proxy<guint, base::StringListBase> (*this, "n-items"); }
const gi::property_proxy<guint, base::StringListBase> property_n_items() const
{ return gi::property_proxy<guint, base::StringListBase> (*this, "n-items"); }
