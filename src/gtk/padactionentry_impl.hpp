...
GI_MODULE_STATIC_OR_INLINE ::GtkPadActionType _field_type_get (const ::GtkPadActionEntry* obj) { return (::GtkPadActionType) obj->type; }
...
GI_MODULE_STATIC_OR_INLINE void _field_type_set (::GtkPadActionEntry* obj, ::GtkPadActionType _value) { obj->type = (decltype(obj->type)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_index_get (const ::GtkPadActionEntry* obj) { return (gint) obj->index; }
...
GI_MODULE_STATIC_OR_INLINE void _field_index_set (::GtkPadActionEntry* obj, gint _value) { obj->index = (decltype(obj->index)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_mode_get (const ::GtkPadActionEntry* obj) { return (gint) obj->mode; }
...
GI_MODULE_STATIC_OR_INLINE void _field_mode_set (::GtkPadActionEntry* obj, gint _value) { obj->mode = (decltype(obj->mode)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_label_get (const ::GtkPadActionEntry* obj) { return (const char*) obj->label; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_action_name_get (const ::GtkPadActionEntry* obj) { return (const char*) obj->action_name; }
