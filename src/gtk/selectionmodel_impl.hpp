...
void SelectionModelInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_selection_in_range) methods->get_selection_in_range = (decltype (methods->get_selection_in_range)) gi::detail::method_wrapper<self, Gtk::Bitset (*) (guint position, guint n_items), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_selection_in_range_>;
  if (init_data.is_selected) methods->is_selected = (decltype (methods->is_selected)) gi::detail::method_wrapper<self, bool (*) (guint position), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::is_selected_>;
  ...
  if (init_data.select_item) methods->select_item = (decltype (methods->select_item)) gi::detail::method_wrapper<self, bool (*) (guint position, gboolean unselect_rest), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::select_item_>;
  if (init_data.select_range) methods->select_range = (decltype (methods->select_range)) gi::detail::method_wrapper<self, bool (*) (guint position, guint n_items, gboolean unselect_rest), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::select_range_>;
  if (init_data.set_selection) methods->set_selection = (decltype (methods->set_selection)) gi::detail::method_wrapper<self, bool (*) (Gtk::Bitset_Ref selected, Gtk::Bitset_Ref mask), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::set_selection_>;
  ...
  if (init_data.unselect_item) methods->unselect_item = (decltype (methods->unselect_item)) gi::detail::method_wrapper<self, bool (*) (guint position), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::unselect_item_>;
  if (init_data.unselect_range) methods->unselect_range = (decltype (methods->unselect_range)) gi::detail::method_wrapper<self, bool (*) (guint position, guint n_items), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::unselect_range_>;
}
