...
// ::GtkGraphicsOffloadEnabled gtk_video_get_graphics_offload (::GtkVideo* self /*none*/);
GI_INLINE_DECL Gtk::GraphicsOffloadEnabled get_graphics_offload () noexcept;
...
// void gtk_video_set_graphics_offload (::GtkVideo* self /*none*/, ::GtkGraphicsOffloadEnabled enabled);
GI_INLINE_DECL void set_graphics_offload (Gtk::GraphicsOffloadEnabled enabled) noexcept;
...
gi::property_proxy<Gtk::GraphicsOffloadEnabled, base::VideoBase> property_graphics_offload()
{ return gi::property_proxy<Gtk::GraphicsOffloadEnabled, base::VideoBase> (*this, "graphics-offload"); }
const gi::property_proxy<Gtk::GraphicsOffloadEnabled, base::VideoBase> property_graphics_offload() const
{ return gi::property_proxy<Gtk::GraphicsOffloadEnabled, base::VideoBase> (*this, "graphics-offload"); }
