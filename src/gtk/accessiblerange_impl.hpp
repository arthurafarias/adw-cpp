...
void AccessibleRangeInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.set_current_value) methods->set_current_value = (decltype (methods->set_current_value)) gi::detail::method_wrapper<self, bool (*) (gdouble value), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_current_value_>;
}
