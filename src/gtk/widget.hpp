...
// gboolean gtk_widget_get_limit_events (::GtkWidget* widget /*none*/);
GI_INLINE_DECL bool get_limit_events () noexcept;
...
// void gtk_widget_set_limit_events (::GtkWidget* widget /*none*/, gboolean limit_events);
GI_INLINE_DECL void set_limit_events (gboolean limit_events) noexcept;
...
GI_INLINE_DECL void snapshot_child (Gtk::Widget child, Gtk::Snapshot snapshot) noexcept;
...
gi::property_proxy<bool, base::WidgetBase> property_limit_events()
{ return gi::property_proxy<bool, base::WidgetBase> (*this, "limit-events"); }
const gi::property_proxy<bool, base::WidgetBase> property_limit_events() const
{ return gi::property_proxy<bool, base::WidgetBase> (*this, "limit-events"); }
...
virtual void snapshot_ (Gtk::Snapshot snapshot) noexcept = 0;
...
// void Widget::snapshot (GtkWidget* widget /*none*/, GtkSnapshot* snapshot /*none*/);
// void Widget::snapshot (::GtkWidget* widget /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/);
GI_INLINE_DECL void snapshot_ (Gtk::Snapshot snapshot) noexcept override;
...
struct WidgetClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(WidgetClass, snapshot)
