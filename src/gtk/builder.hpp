...
// ::GClosure* /*none,nullable*/ gtk_builder_create_closure (::GtkBuilder* builder /*none*/, const char* function_name /*none*/, ::GtkBuilderClosureFlags flags, ::GObject* object /*none,nullable*/, GError ** error);
GI_INLINE_DECL GObject::Closure_Ref create_closure (const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags, GObject::Object object);
GI_INLINE_DECL GObject::Closure_Ref create_closure (const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags);
GI_INLINE_DECL GObject::Closure_Ref create_closure (const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags, GObject::Object object, GLib::Error * _error) noexcept;
GI_INLINE_DECL GObject::Closure_Ref create_closure (const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags, GLib::Error * _error) noexcept;
