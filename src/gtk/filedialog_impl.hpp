...
// GFile* /*full*/ gtk_file_dialog_open_finish (GtkFileDialog* self /*none*/, GAsyncResult* result /*none*/, GError ** error);
// ::GFile* /*full*/ gtk_file_dialog_open_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
...
// GListModel* /*full*/ gtk_file_dialog_open_multiple_finish (GtkFileDialog* self /*none*/, GAsyncResult* result /*none*/, GError ** error);
// ::GListModel* /*full*/ gtk_file_dialog_open_multiple_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
...
// void gtk_file_dialog_open_multiple_text_files (GtkFileDialog* self /*none*/, GtkWindow* parent /*none,nullable*/, GCancellable* cancellable /*none,nullable*/, GAsyncReadyCallback callback /*none,nullable*/, gpointer user_data);
// void gtk_file_dialog_open_multiple_text_files (::GtkFileDialog* self /*none*/, ::GtkWindow* parent /*none,nullable*/, ::GCancellable* cancellable /*none,nullable*/, Gio::AsyncReadyCallback::cfunction_type callback /*none,nullable*/, void* user_data);
void base::FileDialogBase::open_multiple_text_files (Gtk::Window parent, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback) noexcept
{
  typedef void (*call_wrap_t) (::GtkFileDialog* self, ::GtkWindow* parent, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_multiple_text_files;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
  auto parent_to_c = gi::unwrap (parent, gi::transfer_none);
  call_wrap_v ((::GtkFileDialog*) (gobj_()), (::GtkWindow*) (parent_to_c), (::GCancellable*) (cancellable_to_c), (Gio::AsyncReadyCallback::cfunction_type) (callback_wrap_ ? &callback_wrap_->wrapper : nullptr), (void*) (callback_wrap_));
}
void base::FileDialogBase::open_multiple_text_files (Gio::AsyncReadyCallback callback) noexcept
{
  typedef void (*call_wrap_t) (::GtkFileDialog* self, ::GtkWindow* parent, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_multiple_text_files;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
...
// GListModel* /*full*/ gtk_file_dialog_open_multiple_text_files_finish (GtkFileDialog* self /*none*/, GAsyncResult* result /*none*/, const char** encoding /*none,out*/, GError ** error);
// ::GListModel* /*full*/ gtk_file_dialog_open_multiple_text_files_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, const char** encoding /*none,out*/, GError ** error);
Gio::ListModel base::FileDialogBase::open_multiple_text_files_finish (Gio::AsyncResult result, gi::cstring_v & encoding)
{
  typedef ::GListModel* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_multiple_text_files_finish;
  const char* encoding_o {};
  auto result_to_c = gi::unwrap (result, gi::transfer_none);
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::GtkFileDialog*) (gobj_()), (::GAsyncResult*) (result_to_c), (const char**) (&encoding_o), &error);
  encoding = gi::wrap (encoding_o, gi::transfer_none);
  gi::check_error (error);
  return gi::wrap (_temp_ret, gi::transfer_full);
}
Gio::ListModel base::FileDialogBase::open_multiple_text_files_finish (Gio::AsyncResult result, gi::cstring_v & encoding, GLib::Error * _error) noexcept
{
  typedef ::GListModel* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_multiple_text_files_finish;
  const char* encoding_o {};
  auto result_to_c = gi::unwrap (result, gi::transfer_none);
  GError* _error_o {};
  auto _temp_ret = call_wrap_v ((::GtkFileDialog*) (gobj_()), (::GAsyncResult*) (result_to_c), (const char**) (&encoding_o), _error ? &_error_o : nullptr);
  encoding = gi::wrap (encoding_o, gi::transfer_none);
  if (_error) *_error = gi::wrap (_error_o, gi::transfer_full);
  return gi::wrap (_temp_ret, gi::transfer_full);
}
std::tuple<Gio::ListModel, gi::cstring_v> base::FileDialogBase::open_multiple_text_files_finish (Gio::AsyncResult result)
{
  typedef ::GListModel* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_multiple_text_files_finish;
  const char* encoding_o {};
  ...
  auto &&tmp_return_2 = gi::wrap (encoding_o, gi::transfer_none);
  return std::make_tuple (std::move(tmp_return_1),std::move(tmp_return_2));
}
std::tuple<Gio::ListModel, gi::cstring_v> base::FileDialogBase::open_multiple_text_files_finish (Gio::AsyncResult result, GLib::Error * _error) noexcept
{
  typedef ::GListModel* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_multiple_text_files_finish;
  const char* encoding_o {};
...
// void gtk_file_dialog_open_text_file (GtkFileDialog* self /*none*/, GtkWindow* parent /*none,nullable*/, GCancellable* cancellable /*none,nullable*/, GAsyncReadyCallback callback /*none,nullable*/, gpointer user_data);
// void gtk_file_dialog_open_text_file (::GtkFileDialog* self /*none*/, ::GtkWindow* parent /*none,nullable*/, ::GCancellable* cancellable /*none,nullable*/, Gio::AsyncReadyCallback::cfunction_type callback /*none,nullable*/, void* user_data);
void base::FileDialogBase::open_text_file (Gtk::Window parent, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback) noexcept
{
  typedef void (*call_wrap_t) (::GtkFileDialog* self, ::GtkWindow* parent, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_text_file;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
  auto parent_to_c = gi::unwrap (parent, gi::transfer_none);
  call_wrap_v ((::GtkFileDialog*) (gobj_()), (::GtkWindow*) (parent_to_c), (::GCancellable*) (cancellable_to_c), (Gio::AsyncReadyCallback::cfunction_type) (callback_wrap_ ? &callback_wrap_->wrapper : nullptr), (void*) (callback_wrap_));
}
void base::FileDialogBase::open_text_file (Gio::AsyncReadyCallback callback) noexcept
{
  typedef void (*call_wrap_t) (::GtkFileDialog* self, ::GtkWindow* parent, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_text_file;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
...
// GFile* /*full*/ gtk_file_dialog_open_text_file_finish (GtkFileDialog* self /*none*/, GAsyncResult* result /*none*/, const char** encoding /*none,out*/, GError ** error);
// ::GFile* /*full*/ gtk_file_dialog_open_text_file_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, const char** encoding /*none,out*/, GError ** error);
Gio::File base::FileDialogBase::open_text_file_finish (Gio::AsyncResult result, gi::cstring_v & encoding)
{
  typedef ::GFile* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_text_file_finish;
  const char* encoding_o {};
  auto result_to_c = gi::unwrap (result, gi::transfer_none);
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::GtkFileDialog*) (gobj_()), (::GAsyncResult*) (result_to_c), (const char**) (&encoding_o), &error);
...
Gio::File base::FileDialogBase::open_text_file_finish (Gio::AsyncResult result, gi::cstring_v & encoding, GLib::Error * _error) noexcept
{
  typedef ::GFile* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_text_file_finish;
  const char* encoding_o {};
...
std::tuple<Gio::File, gi::cstring_v> base::FileDialogBase::open_text_file_finish (Gio::AsyncResult result)
{
  typedef ::GFile* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_text_file_finish;
  const char* encoding_o {};
...
std::tuple<Gio::File, gi::cstring_v> base::FileDialogBase::open_text_file_finish (Gio::AsyncResult result, GLib::Error * _error) noexcept
{
  typedef ::GFile* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_open_text_file_finish;
  const char* encoding_o {};
...
// GFile* /*full*/ gtk_file_dialog_save_finish (GtkFileDialog* self /*none*/, GAsyncResult* result /*none*/, GError ** error);
// ::GFile* /*full*/ gtk_file_dialog_save_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
...
// void gtk_file_dialog_save_text_file (GtkFileDialog* self /*none*/, GtkWindow* parent /*none,nullable*/, GCancellable* cancellable /*none,nullable*/, GAsyncReadyCallback callback /*none,nullable*/, gpointer user_data);
// void gtk_file_dialog_save_text_file (::GtkFileDialog* self /*none*/, ::GtkWindow* parent /*none,nullable*/, ::GCancellable* cancellable /*none,nullable*/, Gio::AsyncReadyCallback::cfunction_type callback /*none,nullable*/, void* user_data);
void base::FileDialogBase::save_text_file (Gtk::Window parent, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback) noexcept
{
  typedef void (*call_wrap_t) (::GtkFileDialog* self, ::GtkWindow* parent, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_save_text_file;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
  auto parent_to_c = gi::unwrap (parent, gi::transfer_none);
  call_wrap_v ((::GtkFileDialog*) (gobj_()), (::GtkWindow*) (parent_to_c), (::GCancellable*) (cancellable_to_c), (Gio::AsyncReadyCallback::cfunction_type) (callback_wrap_ ? &callback_wrap_->wrapper : nullptr), (void*) (callback_wrap_));
}
void base::FileDialogBase::save_text_file (Gio::AsyncReadyCallback callback) noexcept
{
  typedef void (*call_wrap_t) (::GtkFileDialog* self, ::GtkWindow* parent, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_save_text_file;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
...
// GFile* /*full*/ gtk_file_dialog_save_text_file_finish (GtkFileDialog* self /*none*/, GAsyncResult* result /*none*/, const char** encoding /*none,out*/, const char** line_ending /*none,out*/, GError ** error);
// ::GFile* /*full*/ gtk_file_dialog_save_text_file_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, const char** encoding /*none,out*/, const char** line_ending /*none,out*/, GError ** error);
Gio::File base::FileDialogBase::save_text_file_finish (Gio::AsyncResult result, gi::cstring_v & encoding, gi::cstring_v & line_ending)
{
  typedef ::GFile* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, const char** line_ending, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_save_text_file_finish;
  const char* line_ending_o {};
  const char* encoding_o {};
  auto result_to_c = gi::unwrap (result, gi::transfer_none);
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::GtkFileDialog*) (gobj_()), (::GAsyncResult*) (result_to_c), (const char**) (&encoding_o), (const char**) (&line_ending_o), &error);
  line_ending = gi::wrap (line_ending_o, gi::transfer_none);
  encoding = gi::wrap (encoding_o, gi::transfer_none);
  gi::check_error (error);
  return gi::wrap (_temp_ret, gi::transfer_full);
}
Gio::File base::FileDialogBase::save_text_file_finish (Gio::AsyncResult result, gi::cstring_v & encoding, gi::cstring_v & line_ending, GLib::Error * _error) noexcept
{
  typedef ::GFile* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, const char** line_ending, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_save_text_file_finish;
  const char* line_ending_o {};
  ...
  auto result_to_c = gi::unwrap (result, gi::transfer_none);
  GError* _error_o {};
  auto _temp_ret = call_wrap_v ((::GtkFileDialog*) (gobj_()), (::GAsyncResult*) (result_to_c), (const char**) (&encoding_o), (const char**) (&line_ending_o), _error ? &_error_o : nullptr);
  line_ending = gi::wrap (line_ending_o, gi::transfer_none);
  encoding = gi::wrap (encoding_o, gi::transfer_none);
  if (_error) *_error = gi::wrap (_error_o, gi::transfer_full);
  return gi::wrap (_temp_ret, gi::transfer_full);
}
std::tuple<Gio::File, gi::cstring_v, gi::cstring_v> base::FileDialogBase::save_text_file_finish (Gio::AsyncResult result)
{
  typedef ::GFile* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, const char** line_ending, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_save_text_file_finish;
  const char* line_ending_o {};
  ...
  auto &&tmp_return_1 = gi::wrap (_temp_ret, gi::transfer_full);
  auto &&tmp_return_2 = gi::wrap (encoding_o, gi::transfer_none);
  auto &&tmp_return_3 = gi::wrap (line_ending_o, gi::transfer_none);
  return std::make_tuple (std::move(tmp_return_1),std::move(tmp_return_2),std::move(tmp_return_3));
}
std::tuple<Gio::File, gi::cstring_v, gi::cstring_v> base::FileDialogBase::save_text_file_finish (Gio::AsyncResult result, GLib::Error * _error) noexcept
{
  typedef ::GFile* (*call_wrap_t) (::GtkFileDialog* self, ::GAsyncResult* result, const char** encoding, const char** line_ending, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_dialog_save_text_file_finish;
  const char* line_ending_o {};
...
// GFile* /*full*/ gtk_file_dialog_select_folder_finish (GtkFileDialog* self /*none*/, GAsyncResult* result /*none*/, GError ** error);
// ::GFile* /*full*/ gtk_file_dialog_select_folder_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
...
// GListModel* /*full*/ gtk_file_dialog_select_multiple_folders_finish (GtkFileDialog* self /*none*/, GAsyncResult* result /*none*/, GError ** error);
// ::GListModel* /*full*/ gtk_file_dialog_select_multiple_folders_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
