...
// gboolean gtk_picture_get_isolate_contents (::GtkPicture* self /*none*/);
GI_INLINE_DECL bool get_isolate_contents () noexcept;
...
// void gtk_picture_set_isolate_contents (::GtkPicture* self /*none*/, gboolean isolate_contents);
GI_INLINE_DECL void set_isolate_contents (gboolean isolate_contents) noexcept;
...
gi::property_proxy<bool, base::PictureBase> property_isolate_contents()
{ return gi::property_proxy<bool, base::PictureBase> (*this, "isolate-contents"); }
const gi::property_proxy<bool, base::PictureBase> property_isolate_contents() const
{ return gi::property_proxy<bool, base::PictureBase> (*this, "isolate-contents"); }
