...
void EntryBufferClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.delete_text) methods->delete_text = (decltype (methods->delete_text)) gi::detail::method_wrapper<self, guint (*) (guint position, guint n_chars), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::delete_text_>;
  if (init_data.deleted_text) methods->deleted_text = (decltype (methods->deleted_text)) gi::detail::method_wrapper<self, void (*) (guint position, guint n_chars), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::deleted_text_>;
  if (init_data.get_length) methods->get_length = (decltype (methods->get_length)) gi::detail::method_wrapper<self, guint (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_length_>;
  if (init_data.insert_text) methods->insert_text = (decltype (methods->insert_text)) gi::detail::method_wrapper<self, guint (*) (guint position, const gi::cstring_v chars, guint n_chars), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::insert_text_>;
  if (init_data.inserted_text) methods->inserted_text = (decltype (methods->inserted_text)) gi::detail::method_wrapper<self, void (*) (guint position, const gi::cstring_v chars, guint n_chars), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::inserted_text_>;
}
