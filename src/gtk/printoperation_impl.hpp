...
void PrintOperationClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.begin_print) methods->begin_print = (decltype (methods->begin_print)) gi::detail::method_wrapper<self, void (*) (Gtk::PrintContext context), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::begin_print_>;
  if (init_data.custom_widget_apply) methods->custom_widget_apply = (decltype (methods->custom_widget_apply)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::custom_widget_apply_>;
  if (init_data.done) methods->done = (decltype (methods->done)) gi::detail::method_wrapper<self, void (*) (Gtk::PrintOperationResult result), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::done_>;
  if (init_data.draw_page) methods->draw_page = (decltype (methods->draw_page)) gi::detail::method_wrapper<self, void (*) (Gtk::PrintContext context, gint page_nr), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::draw_page_>;
  if (init_data.end_print) methods->end_print = (decltype (methods->end_print)) gi::detail::method_wrapper<self, void (*) (Gtk::PrintContext context), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::end_print_>;
  if (init_data.paginate) methods->paginate = (decltype (methods->paginate)) gi::detail::method_wrapper<self, bool (*) (Gtk::PrintContext context), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::paginate_>;
  if (init_data.preview) methods->preview = (decltype (methods->preview)) gi::detail::method_wrapper<self, bool (*) (Gtk::PrintOperationPreview preview, Gtk::PrintContext context, Gtk::Window parent), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::preview_>;
  if (init_data.request_page_setup) methods->request_page_setup = (decltype (methods->request_page_setup)) gi::detail::method_wrapper<self, void (*) (Gtk::PrintContext context, gint page_nr, Gtk::PageSetup setup), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::request_page_setup_>;
  if (init_data.status_changed) methods->status_changed = (decltype (methods->status_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::status_changed_>;
  if (init_data.update_custom_widget) methods->update_custom_widget = (decltype (methods->update_custom_widget)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget, Gtk::PageSetup setup, Gtk::PrintSettings settings), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::update_custom_widget_>;
}
