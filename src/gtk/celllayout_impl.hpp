...
void CellLayoutIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.add_attribute) methods->add_attribute = (decltype (methods->add_attribute)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer cell, const gi::cstring_v attribute, gint column), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::add_attribute_>;
  if (init_data.clear) methods->clear = (decltype (methods->clear)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::clear_>;
  if (init_data.clear_attributes) methods->clear_attributes = (decltype (methods->clear_attributes)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer cell), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::clear_attributes_>;
  if (init_data.get_area) methods->get_area = (decltype (methods->get_area)) gi::detail::method_wrapper<self, Gtk::CellArea (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_area_>;
  if (init_data.get_cells) methods->get_cells = (decltype (methods->get_cells)) gi::detail::method_wrapper<self, gi::Collection<GList, ::GtkCellRenderer*, gi::transfer_container_t> (*) (), gi::transfer_container_t, std::tuple<>>::wrapper<&self::get_cells_>;
  if (init_data.pack_end) methods->pack_end = (decltype (methods->pack_end)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer cell, gboolean expand), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::pack_end_>;
  if (init_data.pack_start) methods->pack_start = (decltype (methods->pack_start)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer cell, gboolean expand), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::pack_start_>;
  if (init_data.reorder) methods->reorder = (decltype (methods->reorder)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer cell, gint position), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::reorder_>;
  if (init_data.set_cell_data_func) methods->set_cell_data_func = (decltype (methods->set_cell_data_func)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer cell, Gtk::CellLayoutDataFunc func), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, Gtk::internal::CellLayoutDataFunc_CB_Trait, detail::args_index<1, 2, 3>>>, void  (::GtkCellRenderer* cell, Gtk::CellLayoutDataFunc::cfunction_type func, void* func_data, GLib::DestroyNotify::cfunction_type destroy)>::wrapper<&self::set_cell_data_func_>;
}
