...
void TreeModelIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_column_type) methods->get_column_type = (decltype (methods->get_column_type)) gi::detail::method_wrapper<self, GType (*) (gint index_), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_column_type_>;
  if (init_data.get_flags) methods->get_flags = (decltype (methods->get_flags)) gi::detail::method_wrapper<self, Gtk::TreeModelFlags (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_flags_>;
  if (init_data.get_iter) methods->get_iter = (decltype (methods->get_iter)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter, Gtk::TreePath_Ref path), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_iter_>;
  if (init_data.get_n_columns) methods->get_n_columns = (decltype (methods->get_n_columns)) gi::detail::method_wrapper<self, gint (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_n_columns_>;
  if (init_data.get_path) methods->get_path = (decltype (methods->get_path)) gi::detail::method_wrapper<self, Gtk::TreePath (*) (Gtk::TreeIter_Ref iter), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_path_>;
  if (init_data.get_value) methods->get_value = (decltype (methods->get_value)) gi::detail::method_wrapper<self, void (*) (Gtk::TreeIter_Ref iter, gint column, GObject::Value_Ref value), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_value_>;
  if (init_data.iter_children) methods->iter_children = (decltype (methods->iter_children)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter, Gtk::TreeIter_Ref parent), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::iter_children_>;
  if (init_data.iter_has_child) methods->iter_has_child = (decltype (methods->iter_has_child)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::iter_has_child_>;
  if (init_data.iter_n_children) methods->iter_n_children = (decltype (methods->iter_n_children)) gi::detail::method_wrapper<self, gint (*) (Gtk::TreeIter_Ref iter), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::iter_n_children_>;
  if (init_data.iter_next) methods->iter_next = (decltype (methods->iter_next)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::iter_next_>;
  if (init_data.iter_nth_child) methods->iter_nth_child = (decltype (methods->iter_nth_child)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter, Gtk::TreeIter_Ref parent, gint n), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::iter_nth_child_>;
  if (init_data.iter_parent) methods->iter_parent = (decltype (methods->iter_parent)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter, Gtk::TreeIter_Ref child), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::iter_parent_>;
  if (init_data.iter_previous) methods->iter_previous = (decltype (methods->iter_previous)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::iter_previous_>;
  if (init_data.ref_node) methods->ref_node = (decltype (methods->ref_node)) gi::detail::method_wrapper<self, void (*) (Gtk::TreeIter_Ref iter), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::ref_node_>;
  if (init_data.row_changed) methods->row_changed = (decltype (methods->row_changed)) gi::detail::method_wrapper<self, void (*) (Gtk::TreePath_Ref path, Gtk::TreeIter_Ref iter), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::row_changed_>;
  if (init_data.row_deleted) methods->row_deleted = (decltype (methods->row_deleted)) gi::detail::method_wrapper<self, void (*) (Gtk::TreePath_Ref path), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::row_deleted_>;
  if (init_data.row_has_child_toggled) methods->row_has_child_toggled = (decltype (methods->row_has_child_toggled)) gi::detail::method_wrapper<self, void (*) (Gtk::TreePath_Ref path, Gtk::TreeIter_Ref iter), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::row_has_child_toggled_>;
  if (init_data.row_inserted) methods->row_inserted = (decltype (methods->row_inserted)) gi::detail::method_wrapper<self, void (*) (Gtk::TreePath_Ref path, Gtk::TreeIter_Ref iter), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::row_inserted_>;
  if (init_data.unref_node) methods->unref_node = (decltype (methods->unref_node)) gi::detail::method_wrapper<self, void (*) (Gtk::TreeIter_Ref iter), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::unref_node_>;
}
