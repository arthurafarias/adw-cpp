...
// GtkListTabBehavior gtk_list_box_get_tab_behavior (GtkListBox* box /*none*/);
// ::GtkListTabBehavior gtk_list_box_get_tab_behavior (::GtkListBox* box /*none*/);
...
// void gtk_list_box_set_tab_behavior (GtkListBox* box /*none*/, GtkListTabBehavior behavior);
// void gtk_list_box_set_tab_behavior (::GtkListBox* box /*none*/, ::GtkListTabBehavior behavior);
GI_INLINE_DECL void set_tab_behavior (Gtk::ListTabBehavior behavior) noexcept;
...
gi::property_proxy<Gtk::ListTabBehavior, base::ListBoxBase> property_tab_behavior()
{ return gi::property_proxy<Gtk::ListTabBehavior, base::ListBoxBase> (*this, "tab-behavior"); }
const gi::property_proxy<Gtk::ListTabBehavior, base::ListBoxBase> property_tab_behavior() const
{ return gi::property_proxy<Gtk::ListTabBehavior, base::ListBoxBase> (*this, "tab-behavior"); }
...
// (signal) void move-cursor ( step, gint count, gboolean extend, gboolean modify);
// (signal) void move-cursor (::GtkMovementStep step, gint count, gboolean extend, gboolean modify);
gi::signal_proxy<void(Gtk::ListBox, Gtk::MovementStep step, gint count, gboolean extend, gboolean modify)> signal_move_cursor()
{ return gi::signal_proxy<void(Gtk::ListBox, Gtk::MovementStep step, gint count, gboolean extend, gboolean modify)> (*this, "move-cursor"); }
