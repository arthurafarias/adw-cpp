...
// gboolean gtk_window_controls_get_use_native_controls (::GtkWindowControls* self /*none*/);
GI_INLINE_DECL bool get_use_native_controls () noexcept;
...
// void gtk_window_controls_set_use_native_controls (::GtkWindowControls* self /*none*/, gboolean setting);
GI_INLINE_DECL void set_use_native_controls (gboolean setting) noexcept;
...
gi::property_proxy<bool, base::WindowControlsBase> property_use_native_controls()
{ return gi::property_proxy<bool, base::WindowControlsBase> (*this, "use-native-controls"); }
const gi::property_proxy<bool, base::WindowControlsBase> property_use_native_controls() const
{ return gi::property_proxy<bool, base::WindowControlsBase> (*this, "use-native-controls"); }
