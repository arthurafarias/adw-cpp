...
// ::GtkPopoverMenuFlags gtk_popover_menu_get_flags (::GtkPopoverMenu* popover /*none*/);
GI_INLINE_DECL Gtk::PopoverMenuFlags get_flags () noexcept;
...
// void gtk_popover_menu_set_flags (::GtkPopoverMenu* popover /*none*/, ::GtkPopoverMenuFlags flags);
GI_INLINE_DECL void set_flags (Gtk::PopoverMenuFlags flags) noexcept;
...
gi::property_proxy<Gtk::PopoverMenuFlags, base::PopoverMenuBase> property_flags()
{ return gi::property_proxy<Gtk::PopoverMenuFlags, base::PopoverMenuBase> (*this, "flags"); }
const gi::property_proxy<Gtk::PopoverMenuFlags, base::PopoverMenuBase> property_flags() const
{ return gi::property_proxy<Gtk::PopoverMenuFlags, base::PopoverMenuBase> (*this, "flags"); }
