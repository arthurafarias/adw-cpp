...
// GClosure* /*none,nullable*/ gtk_builder_create_closure (GtkBuilder* builder /*none*/, const char* function_name /*none*/, GtkBuilderClosureFlags flags, GObject* object /*none,nullable*/, GError ** error);
// ::GClosure* /*none,nullable*/ gtk_builder_create_closure (::GtkBuilder* builder /*none*/, const char* function_name /*none*/, ::GtkBuilderClosureFlags flags, ::GObject* object /*none,nullable*/, GError ** error);
GObject::Closure_Ref base::BuilderBase::create_closure (const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags, GObject::Object object)
{
...
GObject::Closure_Ref base::BuilderBase::create_closure (const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags)
{
  typedef ::GClosure* (*call_wrap_t) (::GtkBuilder* builder, const char* function_name, ::GtkBuilderClosureFlags flags, ::GObject* object, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_builder_create_closure;
...
GObject::Closure_Ref base::BuilderBase::create_closure (const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags, GObject::Object object, GLib::Error * _error) noexcept
{
  typedef ::GClosure* (*call_wrap_t) (::GtkBuilder* builder, const char* function_name, ::GtkBuilderClosureFlags flags, ::GObject* object, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_builder_create_closure;
  auto object_to_c = gi::unwrap (object, gi::transfer_none);
...
GObject::Closure_Ref base::BuilderBase::create_closure (const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags, GLib::Error * _error) noexcept
{
  typedef ::GClosure* (*call_wrap_t) (::GtkBuilder* builder, const char* function_name, ::GtkBuilderClosureFlags flags, ::GObject* object, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_builder_create_closure;
  auto object_to_c = nullptr;
