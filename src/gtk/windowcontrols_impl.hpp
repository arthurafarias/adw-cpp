...
// gboolean gtk_window_controls_get_use_native_controls (GtkWindowControls* self /*none*/);
// gboolean gtk_window_controls_get_use_native_controls (::GtkWindowControls* self /*none*/);
bool base::WindowControlsBase::get_use_native_controls () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkWindowControls* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_window_controls_get_use_native_controls;
  auto _temp_ret = call_wrap_v ((::GtkWindowControls*) (gobj_()));
  return _temp_ret;
}
...
// void gtk_window_controls_set_use_native_controls (GtkWindowControls* self /*none*/, gboolean setting);
// void gtk_window_controls_set_use_native_controls (::GtkWindowControls* self /*none*/, gboolean setting);
void base::WindowControlsBase::set_use_native_controls (gboolean setting) noexcept
{
  typedef void (*call_wrap_t) (::GtkWindowControls* self, gboolean setting);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_window_controls_set_use_native_controls;
  auto setting_to_c = setting;
  call_wrap_v ((::GtkWindowControls*) (gobj_()), (gboolean) (setting_to_c));
}
