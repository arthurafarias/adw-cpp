...
void FrameClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.compute_child_allocation) methods->compute_child_allocation = (decltype (methods->compute_child_allocation)) gi::detail::method_wrapper<self, void (*) (Gtk::Allocation_Ref allocation), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::compute_child_allocation_>;
}
