...
gi::property_proxy<Gtk::InputHints, base::SearchEntryBase> property_input_hints()
{ return gi::property_proxy<Gtk::InputHints, base::SearchEntryBase> (*this, "input-hints"); }
const gi::property_proxy<Gtk::InputHints, base::SearchEntryBase> property_input_hints() const
{ return gi::property_proxy<Gtk::InputHints, base::SearchEntryBase> (*this, "input-hints"); }

gi::property_proxy<Gtk::InputPurpose, base::SearchEntryBase> property_input_purpose()
{ return gi::property_proxy<Gtk::InputPurpose, base::SearchEntryBase> (*this, "input-purpose"); }
const gi::property_proxy<Gtk::InputPurpose, base::SearchEntryBase> property_input_purpose() const
{ return gi::property_proxy<Gtk::InputPurpose, base::SearchEntryBase> (*this, "input-purpose"); }

gi::property_proxy<Gtk::Widget, base::SearchEntryBase> property_key_capture_widget()
{ return gi::property_proxy<Gtk::Widget, base::SearchEntryBase> (*this, "key-capture-widget"); }
const gi::property_proxy<Gtk::Widget, base::SearchEntryBase> property_key_capture_widget() const
{ return gi::property_proxy<Gtk::Widget, base::SearchEntryBase> (*this, "key-capture-widget"); }
