...
GI_MODULE_STATIC_OR_INLINE gint16 _field_left_get (const ::GtkBorder* obj) { return (gint16) obj->left; }
...
GI_MODULE_STATIC_OR_INLINE void _field_left_set (::GtkBorder* obj, gint16 _value) { obj->left = (decltype(obj->left)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint16 _field_right_get (const ::GtkBorder* obj) { return (gint16) obj->right; }
...
GI_MODULE_STATIC_OR_INLINE void _field_right_set (::GtkBorder* obj, gint16 _value) { obj->right = (decltype(obj->right)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint16 _field_top_get (const ::GtkBorder* obj) { return (gint16) obj->top; }
...
GI_MODULE_STATIC_OR_INLINE void _field_top_set (::GtkBorder* obj, gint16 _value) { obj->top = (decltype(obj->top)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint16 _field_bottom_get (const ::GtkBorder* obj) { return (gint16) obj->bottom; }
...
GI_MODULE_STATIC_OR_INLINE void _field_bottom_set (::GtkBorder* obj, gint16 _value) { obj->bottom = (decltype(obj->bottom)) _value; }
