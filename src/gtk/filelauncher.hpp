...
// gboolean gtk_file_launcher_get_writable (::GtkFileLauncher* self /*none*/);
GI_INLINE_DECL bool get_writable () noexcept;
...
// void gtk_file_launcher_set_writable (::GtkFileLauncher* self /*none*/, gboolean writable);
GI_INLINE_DECL void set_writable (gboolean writable) noexcept;
...
gi::property_proxy<bool, base::FileLauncherBase> property_writable()
{ return gi::property_proxy<bool, base::FileLauncherBase> (*this, "writable"); }
const gi::property_proxy<bool, base::FileLauncherBase> property_writable() const
{ return gi::property_proxy<bool, base::FileLauncherBase> (*this, "writable"); }
