...
// ::GtkDragIcon* /*none*/ gtk_drag_icon_get_for_drag (::GdkDrag* drag /*none*/);
Gtk::DragIcon base::DragIconBase::get_for_drag (Gdk::Drag drag) noexcept
{
  typedef ::GtkDragIcon* (*call_wrap_t) (::GdkDrag* drag);
