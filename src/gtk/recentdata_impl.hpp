...
GI_MODULE_STATIC_OR_INLINE char* _field_display_name_get (const ::GtkRecentData* obj) { return (char*) obj->display_name; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_description_get (const ::GtkRecentData* obj) { return (char*) obj->description; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_mime_type_get (const ::GtkRecentData* obj) { return (char*) obj->mime_type; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_app_name_get (const ::GtkRecentData* obj) { return (char*) obj->app_name; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_app_exec_get (const ::GtkRecentData* obj) { return (char*) obj->app_exec; }
...
GI_MODULE_STATIC_OR_INLINE gboolean _field_is_private_get (const ::GtkRecentData* obj) { return (gboolean) obj->is_private; }
...
GI_MODULE_STATIC_OR_INLINE void _field_is_private_set (::GtkRecentData* obj, gboolean _value) { obj->is_private = (decltype(obj->is_private)) _value; }
