...
// GtkCssSection* /*full*/ gtk_css_section_new_with_bytes (GFile* file /*none,nullable*/, GBytes* bytes /*none,nullable*/, const GtkCssLocation* start /*none*/, const GtkCssLocation* end /*none*/);
// ::GtkCssSection* /*full*/ gtk_css_section_new_with_bytes (::GFile* file /*none,nullable*/, ::GBytes* bytes /*none,nullable*/, const ::GtkCssLocation* start /*none*/, const ::GtkCssLocation* end /*none*/);
Gtk::CssSection base::CssSectionBase::new_with_bytes (Gio::File file, GLib::Bytes_Ref bytes, const Gtk::CssLocation_Ref start, const Gtk::CssLocation_Ref end) noexcept
{
  typedef ::GtkCssSection* (*call_wrap_t) (::GFile* file, ::GBytes* bytes, const ::GtkCssLocation* start, const ::GtkCssLocation* end);
  call_wrap_t call_wrap_v = (call_wrap_t) gtk_css_section_new_with_bytes;
  auto end_to_c = gi::unwrap (end, gi::transfer_none);
  auto start_to_c = gi::unwrap (start, gi::transfer_none);
  auto bytes_to_c = gi::unwrap (bytes, gi::transfer_none);
  auto file_to_c = gi::unwrap (file, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((::GFile*) (file_to_c), (::GBytes*) (bytes_to_c), (const ::GtkCssLocation*) (start_to_c), (const ::GtkCssLocation*) (end_to_c));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
Gtk::CssSection base::CssSectionBase::new_with_bytes (const Gtk::CssLocation_Ref start, const Gtk::CssLocation_Ref end) noexcept
{
  typedef ::GtkCssSection* (*call_wrap_t) (::GFile* file, ::GBytes* bytes, const ::GtkCssLocation* start, const ::GtkCssLocation* end);
  call_wrap_t call_wrap_v = (call_wrap_t) gtk_css_section_new_with_bytes;
  auto end_to_c = gi::unwrap (end, gi::transfer_none);
...
// GBytes* /*none,nullable*/ gtk_css_section_get_bytes (const GtkCssSection* section /*none*/);
// ::GBytes* /*none,nullable*/ gtk_css_section_get_bytes (const ::GtkCssSection* section /*none*/);
GLib::Bytes_Ref base::CssSectionBase::get_bytes () const noexcept
{
  typedef ::GBytes* (*call_wrap_t) (const ::GtkCssSection* section);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_css_section_get_bytes;
