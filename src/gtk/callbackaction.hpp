...
// GtkShortcutAction* /*full*/ gtk_callback_action_new (GtkShortcutFunc callback /*none*/, gpointer data, GDestroyNotify destroy /*none*/);
// ::GtkCallbackAction* /*full*/ gtk_callback_action_new (Gtk::ShortcutFunc::cfunction_type callback /*none*/, void* data, GLib::DestroyNotify::cfunction_type destroy /*none*/);
