...
// ::GtkWindowGravity gtk_window_get_gravity (::GtkWindow* window /*none*/);
GI_INLINE_DECL Gtk::WindowGravity get_gravity () noexcept;
...
// void gtk_window_set_gravity (::GtkWindow* window /*none*/, ::GtkWindowGravity gravity);
GI_INLINE_DECL void set_gravity (Gtk::WindowGravity gravity) noexcept;
...
gi::property_proxy<Gtk::WindowGravity, base::WindowBase> property_gravity()
{ return gi::property_proxy<Gtk::WindowGravity, base::WindowBase> (*this, "gravity"); }
const gi::property_proxy<Gtk::WindowGravity, base::WindowBase> property_gravity() const
{ return gi::property_proxy<Gtk::WindowGravity, base::WindowBase> (*this, "gravity"); }
