...
void TreeViewClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.columns_changed) methods->columns_changed = (decltype (methods->columns_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::columns_changed_>;
  if (init_data.cursor_changed) methods->cursor_changed = (decltype (methods->cursor_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::cursor_changed_>;
  if (init_data.expand_collapse_cursor_row) methods->expand_collapse_cursor_row = (decltype (methods->expand_collapse_cursor_row)) gi::detail::method_wrapper<self, bool (*) (gboolean logical, gboolean expand, gboolean open_all), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::expand_collapse_cursor_row_>;
  if (init_data.move_cursor) methods->move_cursor = (decltype (methods->move_cursor)) gi::detail::method_wrapper<self, bool (*) (Gtk::MovementStep step, gint count, gboolean extend, gboolean modify), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::move_cursor_>;
  if (init_data.row_activated) methods->row_activated = (decltype (methods->row_activated)) gi::detail::method_wrapper<self, void (*) (Gtk::TreePath_Ref path, Gtk::TreeViewColumn column), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::row_activated_>;
  if (init_data.row_collapsed) methods->row_collapsed = (decltype (methods->row_collapsed)) gi::detail::method_wrapper<self, void (*) (Gtk::TreeIter_Ref iter, Gtk::TreePath_Ref path), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::row_collapsed_>;
  if (init_data.row_expanded) methods->row_expanded = (decltype (methods->row_expanded)) gi::detail::method_wrapper<self, void (*) (Gtk::TreeIter_Ref iter, Gtk::TreePath_Ref path), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::row_expanded_>;
  if (init_data.select_all) methods->select_all = (decltype (methods->select_all)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::select_all_>;
  if (init_data.select_cursor_parent) methods->select_cursor_parent = (decltype (methods->select_cursor_parent)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::select_cursor_parent_>;
  if (init_data.select_cursor_row) methods->select_cursor_row = (decltype (methods->select_cursor_row)) gi::detail::method_wrapper<self, bool (*) (gboolean start_editing), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::select_cursor_row_>;
  if (init_data.start_interactive_search) methods->start_interactive_search = (decltype (methods->start_interactive_search)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::start_interactive_search_>;
  if (init_data.test_collapse_row) methods->test_collapse_row = (decltype (methods->test_collapse_row)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter, Gtk::TreePath_Ref path), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::test_collapse_row_>;
  if (init_data.test_expand_row) methods->test_expand_row = (decltype (methods->test_expand_row)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeIter_Ref iter, Gtk::TreePath_Ref path), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::test_expand_row_>;
  if (init_data.toggle_cursor_row) methods->toggle_cursor_row = (decltype (methods->toggle_cursor_row)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::toggle_cursor_row_>;
  if (init_data.unselect_all) methods->unselect_all = (decltype (methods->unselect_all)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::unselect_all_>;
}
