...
void ColorChooserInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.color_activated) methods->color_activated = (decltype (methods->color_activated)) gi::detail::method_wrapper<self, void (*) (const Gdk::RGBA_Ref color), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::color_activated_>;
  if (init_data.get_rgba) methods->get_rgba = (decltype (methods->get_rgba)) gi::detail::method_wrapper<self, void (*) (Gdk::RGBA_Ref color), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_rgba_>;
  if (init_data.set_rgba) methods->set_rgba = (decltype (methods->set_rgba)) gi::detail::method_wrapper<self, void (*) (const Gdk::RGBA_Ref color), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_rgba_>;
}
