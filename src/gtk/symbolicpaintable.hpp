...
// void gtk_symbolic_paintable_snapshot_with_weight (GtkSymbolicPaintable* paintable /*none*/, GdkSnapshot* snapshot /*none*/, double width, double height, const GdkRGBA* colors /*none*/, gsize n_colors, double weight);
// void gtk_symbolic_paintable_snapshot_with_weight (::GtkSymbolicPaintable* paintable /*none*/, ::GdkSnapshot* snapshot /*none*/, gdouble width, gdouble height, const ::GdkRGBA** colors /*none*/, gsize n_colors, gdouble weight);
// SKIP; colors in boxed array not supported (depth 1)
...
// void SymbolicPaintable::snapshot_with_weight (GtkSymbolicPaintable* paintable /*none*/, GdkSnapshot* snapshot /*none*/, double width, double height, const GdkRGBA* colors /*none*/, gsize n_colors, double weight);
// void SymbolicPaintable::snapshot_with_weight (::GtkSymbolicPaintable* paintable /*none*/, ::GdkSnapshot* snapshot /*none*/, gdouble width, gdouble height, const ::GdkRGBA** colors /*none*/, gsize n_colors, gdouble weight);
// SKIP; colors in boxed array not supported (depth 1)
