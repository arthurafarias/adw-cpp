...
// (signal) gboolean invalid-composition (gchar* str /*none*/);
// (signal) gboolean invalid-composition (char* str /*none*/);
gi::signal_proxy<bool(Gtk::IMContext, gi::cstring_v str)> signal_invalid_composition()
{ return gi::signal_proxy<bool(Gtk::IMContext, gi::cstring_v str)> (*this, "invalid-composition"); }
...
using GI_MEMBER_CHECK_CONFLICT(invalid_composition) = self;
...
// gboolean IMContext::invalid_composition (::GtkIMContext* context /*none*/, const char* str /*none*/);
virtual bool invalid_composition_ (const gi::cstring_v str) noexcept = 0;
...
// gboolean IMContext::invalid_composition (GtkIMContext* context /*none*/, const char* str /*none*/);
// gboolean IMContext::invalid_composition (::GtkIMContext* context /*none*/, const char* str /*none*/);
GI_INLINE_DECL bool invalid_composition_ (const gi::cstring_v str) noexcept override;
...
struct IMContextClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(IMContextClass, invalid_composition)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, invalid_composition),
