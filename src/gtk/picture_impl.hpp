...
// gboolean gtk_picture_get_isolate_contents (GtkPicture* self /*none*/);
// gboolean gtk_picture_get_isolate_contents (::GtkPicture* self /*none*/);
bool base::PictureBase::get_isolate_contents () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkPicture* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_picture_get_isolate_contents;
  auto _temp_ret = call_wrap_v ((::GtkPicture*) (gobj_()));
  return _temp_ret;
}
...
// void gtk_picture_set_isolate_contents (GtkPicture* self /*none*/, gboolean isolate_contents);
// void gtk_picture_set_isolate_contents (::GtkPicture* self /*none*/, gboolean isolate_contents);
void base::PictureBase::set_isolate_contents (gboolean isolate_contents) noexcept
{
  typedef void (*call_wrap_t) (::GtkPicture* self, gboolean isolate_contents);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_picture_set_isolate_contents;
  auto isolate_contents_to_c = isolate_contents;
  call_wrap_v ((::GtkPicture*) (gobj_()), (gboolean) (isolate_contents_to_c));
}
