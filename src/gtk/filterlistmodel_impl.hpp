...
// gboolean gtk_filter_list_model_get_watch_items (GtkFilterListModel* self /*none*/);
// gboolean gtk_filter_list_model_get_watch_items (::GtkFilterListModel* self /*none*/);
bool base::FilterListModelBase::get_watch_items () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkFilterListModel* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_filter_list_model_get_watch_items;
  auto _temp_ret = call_wrap_v ((::GtkFilterListModel*) (gobj_()));
  return _temp_ret;
}
...
// void gtk_filter_list_model_set_watch_items (GtkFilterListModel* self /*none*/, gboolean watch_items);
// void gtk_filter_list_model_set_watch_items (::GtkFilterListModel* self /*none*/, gboolean watch_items);
void base::FilterListModelBase::set_watch_items (gboolean watch_items) noexcept
{
  typedef void (*call_wrap_t) (::GtkFilterListModel* self, gboolean watch_items);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_filter_list_model_set_watch_items;
  auto watch_items_to_c = watch_items;
  call_wrap_v ((::GtkFilterListModel*) (gobj_()), (gboolean) (watch_items_to_c));
}
