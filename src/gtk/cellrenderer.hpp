...
GI_INLINE_DECL void snapshot (Gtk::Snapshot snapshot, Gtk::Widget widget, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags) noexcept;
...
virtual void snapshot_ (Gtk::Snapshot snapshot, Gtk::Widget widget, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags) noexcept = 0;
...
// void CellRenderer::snapshot (GtkCellRenderer* cell /*none*/, GtkSnapshot* snapshot /*none*/, GtkWidget* widget /*none*/, const GdkRectangle* background_area /*none*/, const GdkRectangle* cell_area /*none*/, GtkCellRendererState flags);
// void CellRenderer::snapshot (::GtkCellRenderer* cell /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/, ::GtkWidget* widget /*none*/, const ::GdkRectangle* background_area /*none*/, const ::GdkRectangle* cell_area /*none*/, ::GtkCellRendererState flags);
GI_INLINE_DECL void snapshot_ (Gtk::Snapshot snapshot, Gtk::Widget widget, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags) noexcept override;
...
struct CellRendererClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(CellRendererClass, snapshot)
