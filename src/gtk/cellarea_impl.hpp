...
// void gtk_cell_area_snapshot (::GtkCellArea* area /*none*/, ::GtkCellAreaContext* context /*none*/, ::GtkWidget* widget /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/, const ::GdkRectangle* background_area /*none*/, const ::GdkRectangle* cell_area /*none*/, ::GtkCellRendererState flags, gboolean paint_focus);
void base::CellAreaBase::snapshot (Gtk::CellAreaContext context, Gtk::Widget widget, Gtk::Snapshot snapshot, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags, gboolean paint_focus) noexcept
{
  typedef void (*call_wrap_t) (::GtkCellArea* area, ::GtkCellAreaContext* context, ::GtkWidget* widget, ::GI_PATCH_GtkSnapshot* snapshot, const ::GdkRectangle* background_area, const ::GdkRectangle* cell_area, ::GtkCellRendererState flags, gboolean paint_focus);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_cell_area_snapshot;
  ...
  auto widget_to_c = gi::unwrap (widget, gi::transfer_none);
  auto context_to_c = gi::unwrap (context, gi::transfer_none);
  call_wrap_v ((::GtkCellArea*) (gobj_()), (::GtkCellAreaContext*) (context_to_c), (::GtkWidget*) (widget_to_c), (::GI_PATCH_GtkSnapshot*) (snapshot_to_c), (const ::GdkRectangle*) (background_area_to_c), (const ::GdkRectangle*) (cell_area_to_c), (::GtkCellRendererState) (flags_to_c), (gboolean) (paint_focus_to_c));
}
...
void CellAreaClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.activate) methods->activate = (decltype (methods->activate)) gi::detail::method_wrapper<self, bool (*) (Gtk::CellAreaContext context, Gtk::Widget widget, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags, gboolean edit_only), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::activate_>;
  if (init_data.add) methods->add = (decltype (methods->add)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer renderer), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::add_>;
  if (init_data.apply_attributes) methods->apply_attributes = (decltype (methods->apply_attributes)) gi::detail::method_wrapper<self, void (*) (Gtk::TreeModel tree_model, Gtk::TreeIter_Ref iter, gboolean is_expander, gboolean is_expanded), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::apply_attributes_>;
  if (init_data.copy_context) methods->copy_context = (decltype (methods->copy_context)) gi::detail::method_wrapper<self, Gtk::CellAreaContext (*) (Gtk::CellAreaContext context), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::copy_context_>;
  if (init_data.create_context) methods->create_context = (decltype (methods->create_context)) gi::detail::method_wrapper<self, Gtk::CellAreaContext (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::create_context_>;
  ...
  if (init_data.is_activatable) methods->is_activatable = (decltype (methods->is_activatable)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::is_activatable_>;
  if (init_data.remove) methods->remove = (decltype (methods->remove)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer renderer), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::remove_>;
  if (init_data.set_cell_property) methods->set_cell_property = (decltype (methods->set_cell_property)) gi::detail::method_wrapper<self, void (*) (Gtk::CellRenderer renderer, guint property_id, const GObject::Value_Ref value, GObject::ParamSpec pspec), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::set_cell_property_>;
  if (init_data.snapshot) methods->snapshot = (decltype (methods->snapshot)) gi::detail::method_wrapper<self, void (*) (Gtk::CellAreaContext context, Gtk::Widget widget, Gtk::Snapshot snapshot, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags, gboolean paint_focus), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::snapshot_>;
}
...
// void CellArea::snapshot (::GtkCellArea* area /*none*/, ::GtkCellAreaContext* context /*none*/, ::GtkWidget* widget /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/, const ::GdkRectangle* background_area /*none*/, const ::GdkRectangle* cell_area /*none*/, ::GtkCellRendererState flags, gboolean paint_focus);
void CellAreaClass::snapshot_ (Gtk::CellAreaContext context, Gtk::Widget widget, Gtk::Snapshot snapshot, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags, gboolean paint_focus) noexcept
{
