...
// const char* /*none,nullable*/ gtk_svg_error_get_attribute (const ::GError* error /*none*/);
GI_INLINE_DECL gi::cstring_v get_attribute (const GLib::Error_Ref error) noexcept;

// const char* /*none,nullable*/ gtk_svg_error_get_element (const GError* error /*none*/);
// const char* /*none,nullable*/ gtk_svg_error_get_element (const ::GError* error /*none*/);
GI_INLINE_DECL gi::cstring_v get_element (const GLib::Error_Ref error) noexcept;

// const GtkSvgLocation* /*none,nullable*/ gtk_svg_error_get_end (const GError* error /*none*/);
// const ::GtkSvgLocation* /*none,nullable*/ gtk_svg_error_get_end (const ::GError* error /*none*/);
GI_INLINE_DECL Gtk::SvgLocation_Ref get_end (const GLib::Error_Ref error) noexcept;

// const GtkSvgLocation* /*none,nullable*/ gtk_svg_error_get_start (const GError* error /*none*/);
// const ::GtkSvgLocation* /*none,nullable*/ gtk_svg_error_get_start (const ::GError* error /*none*/);
GI_INLINE_DECL Gtk::SvgLocation_Ref get_start (const GLib::Error_Ref error) noexcept;
...
// char* /*full*/ gtk_accelerator_get_accessible_label (guint accelerator_key, ::GdkModifierType accelerator_mods);
GI_INLINE_DECL gi::cstring accelerator_get_accessible_label (guint accelerator_key, Gdk::ModifierType accelerator_mods) noexcept;
...
// void gtk_disable_portal_interfaces (const char** portal_interfaces /*none*/);
GI_INLINE_DECL void disable_portal_interfaces (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> portal_interfaces) noexcept;

// void gtk_disable_portals ();
// void gtk_disable_portals ();
GI_INLINE_DECL void disable_portals () noexcept;
