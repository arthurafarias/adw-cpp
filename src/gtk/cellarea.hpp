...
GI_INLINE_DECL void snapshot (Gtk::CellAreaContext context, Gtk::Widget widget, Gtk::Snapshot snapshot, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags, gboolean paint_focus) noexcept;
...
virtual void snapshot_ (Gtk::CellAreaContext context, Gtk::Widget widget, Gtk::Snapshot snapshot, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags, gboolean paint_focus) noexcept = 0;
...
// void CellArea::snapshot (GtkCellArea* area /*none*/, GtkCellAreaContext* context /*none*/, GtkWidget* widget /*none*/, GtkSnapshot* snapshot /*none*/, const GdkRectangle* background_area /*none*/, const GdkRectangle* cell_area /*none*/, GtkCellRendererState flags, gboolean paint_focus);
// void CellArea::snapshot (::GtkCellArea* area /*none*/, ::GtkCellAreaContext* context /*none*/, ::GtkWidget* widget /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/, const ::GdkRectangle* background_area /*none*/, const ::GdkRectangle* cell_area /*none*/, ::GtkCellRendererState flags, gboolean paint_focus);
GI_INLINE_DECL void snapshot_ (Gtk::CellAreaContext context, Gtk::Widget widget, Gtk::Snapshot snapshot, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags, gboolean paint_focus) noexcept override;
...
struct CellAreaClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(CellAreaClass, snapshot)
