...
void BuildableIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.add_child) methods->add_child = (decltype (methods->add_child)) gi::detail::method_wrapper<self, void (*) (Gtk::Builder builder, GObject::Object child, const gi::cstring_v type), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::add_child_>;
  if (init_data.custom_finished) methods->custom_finished = (decltype (methods->custom_finished)) gi::detail::method_wrapper<self, void (*) (Gtk::Builder builder, GObject::Object child, const gi::cstring_v tagname, void* data), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::custom_finished_>;
  if (init_data.custom_tag_end) methods->custom_tag_end = (decltype (methods->custom_tag_end)) gi::detail::method_wrapper<self, void (*) (Gtk::Builder builder, GObject::Object child, const gi::cstring_v tagname, void* data), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::custom_tag_end_>;
  if (init_data.custom_tag_start) methods->custom_tag_start = (decltype (methods->custom_tag_start)) gi::detail::method_wrapper<self, bool (*) (Gtk::Builder builder, GObject::Object child, const gi::cstring_v tagname, Gtk::BuildableParser_Ref parser, gpointer & data), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::custom_tag_start_>;
  ...
  if (init_data.get_internal_child) methods->get_internal_child = (decltype (methods->get_internal_child)) gi::detail::method_wrapper<self, GObject::Object (*) (Gtk::Builder builder, const gi::cstring_v childname), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_internal_child_>;
  if (init_data.parser_finished) methods->parser_finished = (decltype (methods->parser_finished)) gi::detail::method_wrapper<self, void (*) (Gtk::Builder builder), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::parser_finished_>;
  if (init_data.set_buildable_property) methods->set_buildable_property = (decltype (methods->set_buildable_property)) gi::detail::method_wrapper<self, void (*) (Gtk::Builder builder, const gi::cstring_v name, const GObject::Value_Ref value), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::set_buildable_property_>;
  if (init_data.set_id) methods->set_id = (decltype (methods->set_id)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v id), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_id_>;
}
