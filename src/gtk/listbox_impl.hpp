...
// ::GtkListTabBehavior gtk_list_box_get_tab_behavior (::GtkListBox* box /*none*/);
Gtk::ListTabBehavior base::ListBoxBase::get_tab_behavior () noexcept
{
  typedef ::GtkListTabBehavior (*call_wrap_t) (::GtkListBox* box);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_list_box_get_tab_behavior;
  auto _temp_ret = call_wrap_v ((::GtkListBox*) (gobj_()));
  return gi::wrap (_temp_ret);
}
...
// void gtk_list_box_set_tab_behavior (::GtkListBox* box /*none*/, ::GtkListTabBehavior behavior);
void base::ListBoxBase::set_tab_behavior (Gtk::ListTabBehavior behavior) noexcept
{
  typedef void (*call_wrap_t) (::GtkListBox* box, ::GtkListTabBehavior behavior);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_list_box_set_tab_behavior;
  auto behavior_to_c = gi::unwrap (behavior);
  call_wrap_v ((::GtkListBox*) (gobj_()), (::GtkListTabBehavior) (behavior_to_c));
}
