...
gi::property_proxy<Gtk::InterfaceColorScheme, base::CssProviderBase> property_prefers_color_scheme()
{ return gi::property_proxy<Gtk::InterfaceColorScheme, base::CssProviderBase> (*this, "prefers-color-scheme"); }
const gi::property_proxy<Gtk::InterfaceColorScheme, base::CssProviderBase> property_prefers_color_scheme() const
{ return gi::property_proxy<Gtk::InterfaceColorScheme, base::CssProviderBase> (*this, "prefers-color-scheme"); }

gi::property_proxy<Gtk::InterfaceContrast, base::CssProviderBase> property_prefers_contrast()
{ return gi::property_proxy<Gtk::InterfaceContrast, base::CssProviderBase> (*this, "prefers-contrast"); }
const gi::property_proxy<Gtk::InterfaceContrast, base::CssProviderBase> property_prefers_contrast() const
{ return gi::property_proxy<Gtk::InterfaceContrast, base::CssProviderBase> (*this, "prefers-contrast"); }

gi::property_proxy<Gtk::ReducedMotion, base::CssProviderBase> property_prefers_reduced_motion()
{ return gi::property_proxy<Gtk::ReducedMotion, base::CssProviderBase> (*this, "prefers-reduced-motion"); }
const gi::property_proxy<Gtk::ReducedMotion, base::CssProviderBase> property_prefers_reduced_motion() const
{ return gi::property_proxy<Gtk::ReducedMotion, base::CssProviderBase> (*this, "prefers-reduced-motion"); }
