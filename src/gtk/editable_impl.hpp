...
void EditableInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.delete_text) methods->delete_text = (decltype (methods->delete_text)) gi::detail::method_wrapper<self, void (*) (gint start_pos, gint end_pos), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::delete_text_>;
  if (init_data.do_delete_text) methods->do_delete_text = (decltype (methods->do_delete_text)) gi::detail::method_wrapper<self, void (*) (gint start_pos, gint end_pos), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::do_delete_text_>;
  if (init_data.do_insert_text) methods->do_insert_text = (decltype (methods->do_insert_text)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v text, gint length, gint & position), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, detail::arg_info<gi::transfer_full_t, true>>>::wrapper<&self::do_insert_text_>;
  if (init_data.get_delegate) methods->get_delegate = (decltype (methods->get_delegate)) gi::detail::method_wrapper<self, Gtk::Editable (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_delegate_>;
  if (init_data.get_selection_bounds) methods->get_selection_bounds = (decltype (methods->get_selection_bounds)) gi::detail::method_wrapper<self, bool (*) (gint & start_pos, gint & end_pos), gi::transfer_none_t, std::tuple<gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_selection_bounds_>;
  if (init_data.get_text) methods->get_text = (decltype (methods->get_text)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_text_>;
  if (init_data.insert_text) methods->insert_text = (decltype (methods->insert_text)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v text, gint length, gint & position), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, detail::arg_info<gi::transfer_full_t, true>>>::wrapper<&self::insert_text_>;
  if (init_data.set_selection_bounds) methods->set_selection_bounds = (decltype (methods->set_selection_bounds)) gi::detail::method_wrapper<self, void (*) (gint start_pos, gint end_pos), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::set_selection_bounds_>;
}
