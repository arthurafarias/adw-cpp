...
GI_INLINE_DECL void open_multiple_text_files (Gtk::Window parent, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback) noexcept;
GI_INLINE_DECL void open_multiple_text_files (Gio::AsyncReadyCallback callback) noexcept;
...
// ::GListModel* /*full*/ gtk_file_dialog_open_multiple_text_files_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, const char** encoding /*none,out*/, GError ** error);
GI_INLINE_DECL Gio::ListModel open_multiple_text_files_finish (Gio::AsyncResult result, gi::cstring_v & encoding);
GI_INLINE_DECL Gio::ListModel open_multiple_text_files_finish (Gio::AsyncResult result, gi::cstring_v & encoding, GLib::Error * _error) noexcept;
GI_INLINE_DECL std::tuple<Gio::ListModel, gi::cstring_v> open_multiple_text_files_finish (Gio::AsyncResult result);
GI_INLINE_DECL std::tuple<Gio::ListModel, gi::cstring_v> open_multiple_text_files_finish (Gio::AsyncResult result, GLib::Error * _error) noexcept;
...
GI_INLINE_DECL void open_text_file (Gtk::Window parent, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback) noexcept;
GI_INLINE_DECL void open_text_file (Gio::AsyncReadyCallback callback) noexcept;
...
// ::GFile* /*full*/ gtk_file_dialog_open_text_file_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, const char** encoding /*none,out*/, GError ** error);
GI_INLINE_DECL Gio::File open_text_file_finish (Gio::AsyncResult result, gi::cstring_v & encoding);
GI_INLINE_DECL Gio::File open_text_file_finish (Gio::AsyncResult result, gi::cstring_v & encoding, GLib::Error * _error) noexcept;
GI_INLINE_DECL std::tuple<Gio::File, gi::cstring_v> open_text_file_finish (Gio::AsyncResult result);
GI_INLINE_DECL std::tuple<Gio::File, gi::cstring_v> open_text_file_finish (Gio::AsyncResult result, GLib::Error * _error) noexcept;
...
GI_INLINE_DECL void save_text_file (Gtk::Window parent, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback) noexcept;
GI_INLINE_DECL void save_text_file (Gio::AsyncReadyCallback callback) noexcept;
...
// ::GFile* /*full*/ gtk_file_dialog_save_text_file_finish (::GtkFileDialog* self /*none*/, ::GAsyncResult* result /*none*/, const char** encoding /*none,out*/, const char** line_ending /*none,out*/, GError ** error);
GI_INLINE_DECL Gio::File save_text_file_finish (Gio::AsyncResult result, gi::cstring_v & encoding, gi::cstring_v & line_ending);
GI_INLINE_DECL Gio::File save_text_file_finish (Gio::AsyncResult result, gi::cstring_v & encoding, gi::cstring_v & line_ending, GLib::Error * _error) noexcept;
GI_INLINE_DECL std::tuple<Gio::File, gi::cstring_v, gi::cstring_v> save_text_file_finish (Gio::AsyncResult result);
GI_INLINE_DECL std::tuple<Gio::File, gi::cstring_v, gi::cstring_v> save_text_file_finish (Gio::AsyncResult result, GLib::Error * _error) noexcept;
