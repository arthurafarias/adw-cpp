...
// void gtk_menu_button_set_popover (::GtkMenuButton* menu_button /*none*/, ::GtkPopover* popover /*none,nullable*/);
void base::MenuButtonBase::set_popover (Gtk::Popover popover) noexcept
{
  typedef void (*call_wrap_t) (::GtkMenuButton* menu_button, ::GtkPopover* popover);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_menu_button_set_popover;
  auto popover_to_c = gi::unwrap (popover, gi::transfer_none);
  call_wrap_v ((::GtkMenuButton*) (gobj_()), (::GtkPopover*) (popover_to_c));
}
