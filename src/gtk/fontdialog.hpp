...
// PangoFontFace* /*full*/ gtk_font_dialog_choose_face_finish (GtkFontDialog* self /*none*/, GAsyncResult* result /*none*/, GError ** error);
// ::PangoFontFace* /*full*/ gtk_font_dialog_choose_face_finish (::GtkFontDialog* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
...
// PangoFontFamily* /*full*/ gtk_font_dialog_choose_family_finish (GtkFontDialog* self /*none*/, GAsyncResult* result /*none*/, GError ** error);
// ::PangoFontFamily* /*full*/ gtk_font_dialog_choose_family_finish (::GtkFontDialog* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
...
// PangoFontDescription* /*full*/ gtk_font_dialog_choose_font_finish (GtkFontDialog* self /*none*/, GAsyncResult* result /*none*/, GError ** error);
// ::PangoFontDescription* /*full*/ gtk_font_dialog_choose_font_finish (::GtkFontDialog* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
