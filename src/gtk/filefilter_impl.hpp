...
// void gtk_file_filter_add_mime_types (GtkFileFilter* filter /*none*/, const char** mime_types /*none*/);
// void gtk_file_filter_add_mime_types (::GtkFileFilter* filter /*none*/, const char** mime_types /*none*/);
void base::FileFilterBase::add_mime_types (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> mime_types) noexcept
{
  typedef void (*call_wrap_t) (::GtkFileFilter* filter, const char** mime_types);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_filter_add_mime_types;
  auto mime_types_w = unwrap (std::move(mime_types), gi::transfer_none);
  auto mime_types_to_c = mime_types_w;
  call_wrap_v ((::GtkFileFilter*) (gobj_()), (const char**) (mime_types_to_c));
}
