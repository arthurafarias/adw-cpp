...
// typedef void (*GtkTextBufferCommitNotify) (GtkTextBuffer* buffer /*none*/, GtkTextBufferNotifyFlags flags, guint position, guint length, gpointer user_data);
// typedef void (*GtkTextBufferCommitNotify) (::GtkTextBuffer* buffer /*none*/, ::GtkTextBufferNotifyFlags flags, guint position, guint length, void* user_data);
namespace internal {

typedef void (*TextBufferCommitNotify_CF_CType) (::GtkTextBuffer* buffer, ::GtkTextBufferNotifyFlags flags, guint position, guint length, void* user_data);
GI_INLINE_DECL void TextBufferCommitNotify_CF (Gtk::TextBuffer buffer, Gtk::TextBufferNotifyFlags flags, guint position, guint length, TextBufferCommitNotify_CF_CType _call, gpointer user_data) noexcept;
GI_CB_ARG_CALLBACK_CUSTOM(TextBufferCommitNotify_CB_Trait, TextBufferCommitNotify_CF_CType, TextBufferCommitNotify_CF);
} // namespace internal

typedef gi::detail::callback<void(Gtk::TextBuffer buffer, Gtk::TextBufferNotifyFlags flags, guint position, guint length), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>> TextBufferCommitNotify;
