...
void ApplicationClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.window_added) methods->window_added = (decltype (methods->window_added)) gi::detail::method_wrapper<self, void (*) (Gtk::Window window), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::window_added_>;
  if (init_data.window_removed) methods->window_removed = (decltype (methods->window_removed)) gi::detail::method_wrapper<self, void (*) (Gtk::Window window), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::window_removed_>;
}
