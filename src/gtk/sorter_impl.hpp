...
void SorterClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.compare) methods->compare = (decltype (methods->compare)) gi::detail::method_wrapper<self, Gtk::Ordering (*) (GObject::Object item1, GObject::Object item2), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::compare_>;
  if (init_data.get_order) methods->get_order = (decltype (methods->get_order)) gi::detail::method_wrapper<self, Gtk::SorterOrder (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_order_>;
}
