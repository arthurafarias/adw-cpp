...
// gboolean gtk_widget_get_limit_events (GtkWidget* widget /*none*/);
// gboolean gtk_widget_get_limit_events (::GtkWidget* widget /*none*/);
bool base::WidgetBase::get_limit_events () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkWidget* widget);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_widget_get_limit_events;
  auto _temp_ret = call_wrap_v ((::GtkWidget*) (gobj_()));
  return _temp_ret;
}
...
// void gtk_widget_set_limit_events (GtkWidget* widget /*none*/, gboolean limit_events);
// void gtk_widget_set_limit_events (::GtkWidget* widget /*none*/, gboolean limit_events);
void base::WidgetBase::set_limit_events (gboolean limit_events) noexcept
{
  typedef void (*call_wrap_t) (::GtkWidget* widget, gboolean limit_events);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_widget_set_limit_events;
  auto limit_events_to_c = limit_events;
  call_wrap_v ((::GtkWidget*) (gobj_()), (gboolean) (limit_events_to_c));
}
...
// void gtk_widget_snapshot_child (::GtkWidget* widget /*none*/, ::GtkWidget* child /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/);
void base::WidgetBase::snapshot_child (Gtk::Widget child, Gtk::Snapshot snapshot) noexcept
{
  typedef void (*call_wrap_t) (::GtkWidget* widget, ::GtkWidget* child, ::GI_PATCH_GtkSnapshot* snapshot);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_widget_snapshot_child;
  auto snapshot_to_c = gi::unwrap (snapshot, gi::transfer_none);
  auto child_to_c = gi::unwrap (child, gi::transfer_none);
  call_wrap_v ((::GtkWidget*) (gobj_()), (::GtkWidget*) (child_to_c), (::GI_PATCH_GtkSnapshot*) (snapshot_to_c));
}
...
void WidgetClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.contains) methods->contains = (decltype (methods->contains)) gi::detail::method_wrapper<self, bool (*) (gdouble x, gdouble y), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::contains_>;
  if (init_data.direction_changed) methods->direction_changed = (decltype (methods->direction_changed)) gi::detail::method_wrapper<self, void (*) (Gtk::TextDirection previous_direction), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::direction_changed_>;
  if (init_data.focus) methods->focus = (decltype (methods->focus)) gi::detail::method_wrapper<self, bool (*) (Gtk::DirectionType direction), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::focus_>;
  if (init_data.get_request_mode) methods->get_request_mode = (decltype (methods->get_request_mode)) gi::detail::method_wrapper<self, Gtk::SizeRequestMode (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_request_mode_>;
  if (init_data.grab_focus) methods->grab_focus = (decltype (methods->grab_focus)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::grab_focus_>;
  if (init_data.hide) methods->hide = (decltype (methods->hide)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::hide_>;
  if (init_data.keynav_failed) methods->keynav_failed = (decltype (methods->keynav_failed)) gi::detail::method_wrapper<self, bool (*) (Gtk::DirectionType direction), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::keynav_failed_>;
  if (init_data.map) methods->map = (decltype (methods->map)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::map_>;
  if (init_data.measure) methods->measure = (decltype (methods->measure)) gi::detail::method_wrapper<self, void (*) (Gtk::Orientation orientation, gint for_size, gint & minimum, gint & natural, gint & minimum_baseline, gint & natural_baseline), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::measure_>;
  if (init_data.mnemonic_activate) methods->mnemonic_activate = (decltype (methods->mnemonic_activate)) gi::detail::method_wrapper<self, bool (*) (gboolean group_cycling), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::mnemonic_activate_>;
  if (init_data.move_focus) methods->move_focus = (decltype (methods->move_focus)) gi::detail::method_wrapper<self, void (*) (Gtk::DirectionType direction), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::move_focus_>;
  if (init_data.query_tooltip) methods->query_tooltip = (decltype (methods->query_tooltip)) gi::detail::method_wrapper<self, bool (*) (gint x, gint y, gboolean keyboard_tooltip, Gtk::Tooltip tooltip), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::query_tooltip_>;
  if (init_data.realize) methods->realize = (decltype (methods->realize)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::realize_>;
  if (init_data.root) methods->root = (decltype (methods->root)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::root_>;
  if (init_data.set_focus_child) methods->set_focus_child = (decltype (methods->set_focus_child)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget child), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_focus_child_>;
  if (init_data.show) methods->show = (decltype (methods->show)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::show_>;
  if (init_data.size_allocate) methods->size_allocate = (decltype (methods->size_allocate)) gi::detail::method_wrapper<self, void (*) (gint width, gint height, gint baseline), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::size_allocate_>;
  if (init_data.snapshot) methods->snapshot = (decltype (methods->snapshot)) gi::detail::method_wrapper<self, void (*) (Gtk::Snapshot snapshot), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::snapshot_>;
  if (init_data.state_flags_changed) methods->state_flags_changed = (decltype (methods->state_flags_changed)) gi::detail::method_wrapper<self, void (*) (Gtk::StateFlags previous_state_flags), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::state_flags_changed_>;
  if (init_data.system_setting_changed) methods->system_setting_changed = (decltype (methods->system_setting_changed)) gi::detail::method_wrapper<self, void (*) (Gtk::SystemSetting settings), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::system_setting_changed_>;
  if (init_data.unmap) methods->unmap = (decltype (methods->unmap)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::unmap_>;
  if (init_data.unrealize) methods->unrealize = (decltype (methods->unrealize)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::unrealize_>;
  if (init_data.unroot) methods->unroot = (decltype (methods->unroot)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::unroot_>;
}
...
// void Widget::snapshot (::GtkWidget* widget /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/);
void WidgetClass::snapshot_ (Gtk::Snapshot snapshot) noexcept
{
  if (!get_struct_()->snapshot) { g_critical ("no method in class struct"); return ; }
  typedef void (*call_wrap_t) (::GtkWidget* widget, ::GI_PATCH_GtkSnapshot* snapshot);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->snapshot;
  auto snapshot_to_c = gi::unwrap (snapshot, gi::transfer_none);
  call_wrap_v ((::GtkWidget*) (gobj_()), (::GI_PATCH_GtkSnapshot*) (snapshot_to_c));
}
