...
void ActionableInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_action_name) methods->get_action_name = (decltype (methods->get_action_name)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_action_name_>;
  if (init_data.get_action_target_value) methods->get_action_target_value = (decltype (methods->get_action_target_value)) gi::detail::method_wrapper<self, GLib::Variant (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_action_target_value_>;
  if (init_data.set_action_name) methods->set_action_name = (decltype (methods->set_action_name)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v action_name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_action_name_>;
  if (init_data.set_action_target_value) methods->set_action_target_value = (decltype (methods->set_action_target_value)) gi::detail::method_wrapper<self, void (*) (GLib::Variant target_value), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_action_target_value_>;
}
