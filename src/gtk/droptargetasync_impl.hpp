...
// GdkContentFormats* /*none,nullable*/ gtk_drop_target_async_get_formats (GtkDropTargetAsync* self /*none*/);
// ::GdkContentFormats* /*none,nullable*/ gtk_drop_target_async_get_formats (::GtkDropTargetAsync* self /*none*/);
Gdk::ContentFormats_Ref base::DropTargetAsyncBase::get_formats () noexcept
{
