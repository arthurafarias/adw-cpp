...
// void gtk_spin_button_set_activates_default (::GtkSpinButton* spin_button /*none*/, gboolean activates_default);
GI_INLINE_DECL void set_activates_default (gboolean activates_default) noexcept;
...
gi::property_proxy<bool, base::SpinButtonBase> property_activates_default()
{ return gi::property_proxy<bool, base::SpinButtonBase> (*this, "activates-default"); }
const gi::property_proxy<bool, base::SpinButtonBase> property_activates_default() const
{ return gi::property_proxy<bool, base::SpinButtonBase> (*this, "activates-default"); }
...
// (signal) void activate ();
gi::signal_proxy<void(Gtk::SpinButton)> signal_activate()
{ return gi::signal_proxy<void(Gtk::SpinButton)> (*this, "activate"); }
