...
// GtkGraphicsOffloadEnabled gtk_video_get_graphics_offload (GtkVideo* self /*none*/);
// ::GtkGraphicsOffloadEnabled gtk_video_get_graphics_offload (::GtkVideo* self /*none*/);
Gtk::GraphicsOffloadEnabled base::VideoBase::get_graphics_offload () noexcept
{
  typedef ::GtkGraphicsOffloadEnabled (*call_wrap_t) (::GtkVideo* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_video_get_graphics_offload;
  auto _temp_ret = call_wrap_v ((::GtkVideo*) (gobj_()));
...
// void gtk_video_set_graphics_offload (GtkVideo* self /*none*/, GtkGraphicsOffloadEnabled enabled);
// void gtk_video_set_graphics_offload (::GtkVideo* self /*none*/, ::GtkGraphicsOffloadEnabled enabled);
void base::VideoBase::set_graphics_offload (Gtk::GraphicsOffloadEnabled enabled) noexcept
{
  typedef void (*call_wrap_t) (::GtkVideo* self, ::GtkGraphicsOffloadEnabled enabled);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_video_set_graphics_offload;
  auto enabled_to_c = gi::unwrap (enabled);
  call_wrap_v ((::GtkVideo*) (gobj_()), (::GtkGraphicsOffloadEnabled) (enabled_to_c));
}
