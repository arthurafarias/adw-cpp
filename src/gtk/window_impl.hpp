...
// GtkWindowGravity gtk_window_get_gravity (GtkWindow* window /*none*/);
// ::GtkWindowGravity gtk_window_get_gravity (::GtkWindow* window /*none*/);
Gtk::WindowGravity base::WindowBase::get_gravity () noexcept
{
  typedef ::GtkWindowGravity (*call_wrap_t) (::GtkWindow* window);
...
// void gtk_window_set_gravity (GtkWindow* window /*none*/, GtkWindowGravity gravity);
// void gtk_window_set_gravity (::GtkWindow* window /*none*/, ::GtkWindowGravity gravity);
void base::WindowBase::set_gravity (Gtk::WindowGravity gravity) noexcept
{
  typedef void (*call_wrap_t) (::GtkWindow* window, ::GtkWindowGravity gravity);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_window_set_gravity;
  auto gravity_to_c = gi::unwrap (gravity);
  call_wrap_v ((::GtkWindow*) (gobj_()), (::GtkWindowGravity) (gravity_to_c));
}
...
void WindowClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.activate_default) methods->activate_default = (decltype (methods->activate_default)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::activate_default_>;
  if (init_data.activate_focus) methods->activate_focus = (decltype (methods->activate_focus)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::activate_focus_>;
  if (init_data.close_request) methods->close_request = (decltype (methods->close_request)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::close_request_>;
  if (init_data.enable_debugging) methods->enable_debugging = (decltype (methods->enable_debugging)) gi::detail::method_wrapper<self, bool (*) (gboolean toggle), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::enable_debugging_>;
  if (init_data.keys_changed) methods->keys_changed = (decltype (methods->keys_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::keys_changed_>;
}
