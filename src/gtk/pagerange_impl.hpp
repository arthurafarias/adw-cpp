...
GI_MODULE_STATIC_OR_INLINE gint _field_start_get (const ::GtkPageRange* obj) { return (gint) obj->start; }
...
GI_MODULE_STATIC_OR_INLINE void _field_start_set (::GtkPageRange* obj, gint _value) { obj->start = (decltype(obj->start)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_end_get (const ::GtkPageRange* obj) { return (gint) obj->end; }
...
GI_MODULE_STATIC_OR_INLINE void _field_end_set (::GtkPageRange* obj, gint _value) { obj->end = (decltype(obj->end)) _value; }
