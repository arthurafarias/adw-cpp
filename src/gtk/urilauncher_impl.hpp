...
// gboolean gtk_uri_launcher_can_launch (GtkUriLauncher* self /*none*/, GtkWindow* parent /*none,nullable*/);
// gboolean gtk_uri_launcher_can_launch (::GtkUriLauncher* self /*none*/, ::GtkWindow* parent /*none,nullable*/);
bool base::UriLauncherBase::can_launch (Gtk::Window parent) noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkUriLauncher* self, ::GtkWindow* parent);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_uri_launcher_can_launch;
  auto parent_to_c = gi::unwrap (parent, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((::GtkUriLauncher*) (gobj_()), (::GtkWindow*) (parent_to_c));
  return _temp_ret;
}
bool base::UriLauncherBase::can_launch () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkUriLauncher* self, ::GtkWindow* parent);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_uri_launcher_can_launch;
