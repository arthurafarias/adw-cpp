...
gi::cstring_v base::EntryBase::get_menu_entry_icon_text (Gtk::EntryIconPosition icon_pos) noexcept
{
  typedef const char* (*call_wrap_t) (::GtkEntry* entry, ::GtkEntryIconPosition icon_pos);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_entry_get_menu_entry_icon_text;
  auto icon_pos_to_c = gi::unwrap (icon_pos);
  auto _temp_ret = call_wrap_v ((::GtkEntry*) (gobj_()), (::GtkEntryIconPosition) (icon_pos_to_c));
  return gi::wrap (_temp_ret, gi::transfer_none);
}
...
void base::EntryBase::set_menu_entry_icon_text (Gtk::EntryIconPosition icon_pos, const gi::cstring_v text) noexcept
{
  typedef void (*call_wrap_t) (::GtkEntry* entry, ::GtkEntryIconPosition icon_pos, const char* text);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_entry_set_menu_entry_icon_text;
  auto text_to_c = gi::unwrap (text, gi::transfer_none);
  auto icon_pos_to_c = gi::unwrap (icon_pos);
  call_wrap_v ((::GtkEntry*) (gobj_()), (::GtkEntryIconPosition) (icon_pos_to_c), (const char*) (text_to_c));
}
