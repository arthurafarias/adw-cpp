...
void ScrollableInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_border) methods->get_border = (decltype (methods->get_border)) gi::detail::method_wrapper<self, bool (*) (Gtk::Border_Ref border), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_border_>;
}
