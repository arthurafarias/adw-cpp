...
// void gtk_accessible_announce (GtkAccessible* self /*none*/, const char* message /*none*/, GtkAccessibleAnnouncementPriority priority);
// void gtk_accessible_announce (::GtkAccessible* self /*none*/, const char* message /*none*/, ::GtkAccessibleAnnouncementPriority priority);
void base::AccessibleBase::announce (const gi::cstring_v message, Gtk::AccessibleAnnouncementPriority priority) noexcept
{
  typedef void (*call_wrap_t) (::GtkAccessible* self, const char* message, ::GtkAccessibleAnnouncementPriority priority);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_accessible_announce;
  auto priority_to_c = gi::unwrap (priority);
  auto message_to_c = gi::unwrap (message, gi::transfer_none);
  call_wrap_v ((::GtkAccessible*) (gobj_()), (const char*) (message_to_c), (::GtkAccessibleAnnouncementPriority) (priority_to_c));
}

// char* /*full,nullable*/ gtk_accessible_get_accessible_id (GtkAccessible* self /*none*/);
// char* /*full,nullable*/ gtk_accessible_get_accessible_id (::GtkAccessible* self /*none*/);
gi::cstring base::AccessibleBase::get_accessible_id () noexcept
{
  typedef char* (*call_wrap_t) (::GtkAccessible* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_accessible_get_accessible_id;
...
// void gtk_accessible_update_platform_state (GtkAccessible* self /*none*/, GtkAccessiblePlatformState state);
// void gtk_accessible_update_platform_state (::GtkAccessible* self /*none*/, ::GtkAccessiblePlatformState state);
void base::AccessibleBase::update_platform_state (Gtk::AccessiblePlatformState state) noexcept
{
  typedef void (*call_wrap_t) (::GtkAccessible* self, ::GtkAccessiblePlatformState state);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_accessible_update_platform_state;
  auto state_to_c = gi::unwrap (state);
  call_wrap_v ((::GtkAccessible*) (gobj_()), (::GtkAccessiblePlatformState) (state_to_c));
}
...
void AccessibleInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_accessible_id) methods->get_accessible_id = (decltype (methods->get_accessible_id)) gi::detail::method_wrapper<self, gi::cstring (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_accessible_id_>;
  if (init_data.get_accessible_parent) methods->get_accessible_parent = (decltype (methods->get_accessible_parent)) gi::detail::method_wrapper<self, Gtk::Accessible (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_accessible_parent_>;
  if (init_data.get_at_context) methods->get_at_context = (decltype (methods->get_at_context)) gi::detail::method_wrapper<self, Gtk::ATContext (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_at_context_>;
  if (init_data.get_bounds) methods->get_bounds = (decltype (methods->get_bounds)) gi::detail::method_wrapper<self, bool (*) (gint & x, gint & y, gint & width, gint & height), gi::transfer_none_t, std::tuple<gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_bounds_>;
  if (init_data.get_first_accessible_child) methods->get_first_accessible_child = (decltype (methods->get_first_accessible_child)) gi::detail::method_wrapper<self, Gtk::Accessible (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_first_accessible_child_>;
  if (init_data.get_next_accessible_sibling) methods->get_next_accessible_sibling = (decltype (methods->get_next_accessible_sibling)) gi::detail::method_wrapper<self, Gtk::Accessible (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_next_accessible_sibling_>;
  if (init_data.get_platform_state) methods->get_platform_state = (decltype (methods->get_platform_state)) gi::detail::method_wrapper<self, bool (*) (Gtk::AccessiblePlatformState state), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_platform_state_>;
}

// char* /*full,nullable*/ Accessible::get_accessible_id (GtkAccessible* self /*none*/);
// char* /*full,nullable*/ Accessible::get_accessible_id (::GtkAccessible* self /*none*/);
gi::cstring AccessibleInterfaceClassImpl::get_accessible_id_ () noexcept
{
  if (!get_struct_()->get_accessible_id) { g_critical ("no method in class struct"); return {}; }
  typedef char* (*call_wrap_t) (::GtkAccessible* self);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->get_accessible_id;
  auto _temp_ret = call_wrap_v ((::GtkAccessible*) (gobj_()));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
