...
// gboolean gtk_file_launcher_get_writable (GtkFileLauncher* self /*none*/);
// gboolean gtk_file_launcher_get_writable (::GtkFileLauncher* self /*none*/);
bool base::FileLauncherBase::get_writable () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkFileLauncher* self);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_launcher_get_writable;
  auto _temp_ret = call_wrap_v ((::GtkFileLauncher*) (gobj_()));
  return _temp_ret;
}
...
// void gtk_file_launcher_set_writable (GtkFileLauncher* self /*none*/, gboolean writable);
// void gtk_file_launcher_set_writable (::GtkFileLauncher* self /*none*/, gboolean writable);
void base::FileLauncherBase::set_writable (gboolean writable) noexcept
{
  typedef void (*call_wrap_t) (::GtkFileLauncher* self, gboolean writable);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_file_launcher_set_writable;
  auto writable_to_c = writable;
  call_wrap_v ((::GtkFileLauncher*) (gobj_()), (gboolean) (writable_to_c));
}
