...
// GtkInputHints gtk_search_entry_get_input_hints (GtkSearchEntry* entry /*none*/);
// ::GtkInputHints gtk_search_entry_get_input_hints (::GtkSearchEntry* entry /*none*/);
Gtk::InputHints base::SearchEntryBase::get_input_hints () noexcept
{
  typedef ::GtkInputHints (*call_wrap_t) (::GtkSearchEntry* entry);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_search_entry_get_input_hints;
  auto _temp_ret = call_wrap_v ((::GtkSearchEntry*) (gobj_()));
  return gi::wrap (_temp_ret);
}

// GtkInputPurpose gtk_search_entry_get_input_purpose (GtkSearchEntry* entry /*none*/);
// ::GtkInputPurpose gtk_search_entry_get_input_purpose (::GtkSearchEntry* entry /*none*/);
Gtk::InputPurpose base::SearchEntryBase::get_input_purpose () noexcept
{
  typedef ::GtkInputPurpose (*call_wrap_t) (::GtkSearchEntry* entry);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_search_entry_get_input_purpose;
  auto _temp_ret = call_wrap_v ((::GtkSearchEntry*) (gobj_()));
  return gi::wrap (_temp_ret);
}
...
// void gtk_search_entry_set_input_hints (GtkSearchEntry* entry /*none*/, GtkInputHints hints);
// void gtk_search_entry_set_input_hints (::GtkSearchEntry* entry /*none*/, ::GtkInputHints hints);
void base::SearchEntryBase::set_input_hints (Gtk::InputHints hints) noexcept
{
  typedef void (*call_wrap_t) (::GtkSearchEntry* entry, ::GtkInputHints hints);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_search_entry_set_input_hints;
  auto hints_to_c = gi::unwrap (hints);
  call_wrap_v ((::GtkSearchEntry*) (gobj_()), (::GtkInputHints) (hints_to_c));
}

// void gtk_search_entry_set_input_purpose (GtkSearchEntry* entry /*none*/, GtkInputPurpose purpose);
// void gtk_search_entry_set_input_purpose (::GtkSearchEntry* entry /*none*/, ::GtkInputPurpose purpose);
void base::SearchEntryBase::set_input_purpose (Gtk::InputPurpose purpose) noexcept
{
  typedef void (*call_wrap_t) (::GtkSearchEntry* entry, ::GtkInputPurpose purpose);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_search_entry_set_input_purpose;
  auto purpose_to_c = gi::unwrap (purpose);
  call_wrap_v ((::GtkSearchEntry*) (gobj_()), (::GtkInputPurpose) (purpose_to_c));
}
