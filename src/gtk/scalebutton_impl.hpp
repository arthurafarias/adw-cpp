...
// gboolean gtk_scale_button_get_has_frame (GtkScaleButton* button /*none*/);
// gboolean gtk_scale_button_get_has_frame (::GtkScaleButton* button /*none*/);
bool base::ScaleButtonBase::get_has_frame () noexcept
{
  typedef gboolean (*call_wrap_t) (::GtkScaleButton* button);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_scale_button_get_has_frame;
  auto _temp_ret = call_wrap_v ((::GtkScaleButton*) (gobj_()));
  return _temp_ret;
}
...
// void gtk_scale_button_set_has_frame (GtkScaleButton* button /*none*/, gboolean has_frame);
// void gtk_scale_button_set_has_frame (::GtkScaleButton* button /*none*/, gboolean has_frame);
void base::ScaleButtonBase::set_has_frame (gboolean has_frame) noexcept
{
  typedef void (*call_wrap_t) (::GtkScaleButton* button, gboolean has_frame);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_scale_button_set_has_frame;
  auto has_frame_to_c = has_frame;
  call_wrap_v ((::GtkScaleButton*) (gobj_()), (gboolean) (has_frame_to_c));
}
...
void ScaleButtonClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.value_changed) methods->value_changed = (decltype (methods->value_changed)) gi::detail::method_wrapper<self, void (*) (gdouble value), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::value_changed_>;
}
