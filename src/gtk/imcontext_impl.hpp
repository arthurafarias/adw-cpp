...
// gboolean gtk_im_context_activate_osk (GtkIMContext* context /*none*/, GdkEvent* event /*none,nullable*/);
// gboolean gtk_im_context_activate_osk (::GtkIMContext* context /*none*/,  event /*none,nullable*/);
...
void IMContextClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.activate_osk) methods->activate_osk = (decltype (methods->activate_osk)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::activate_osk_>;
  if (init_data.commit) methods->commit = (decltype (methods->commit)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v str), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::commit_>;
  if (init_data.delete_surrounding) methods->delete_surrounding = (decltype (methods->delete_surrounding)) gi::detail::method_wrapper<self, bool (*) (gint offset, gint n_chars), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::delete_surrounding_>;
  if (init_data.focus_in) methods->focus_in = (decltype (methods->focus_in)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::focus_in_>;
  if (init_data.focus_out) methods->focus_out = (decltype (methods->focus_out)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::focus_out_>;
  if (init_data.get_preedit_string) methods->get_preedit_string = (decltype (methods->get_preedit_string)) gi::detail::method_wrapper<self, void (*) (gi::cstring & str, Pango::AttrList & attrs, gint & cursor_pos), gi::transfer_full_t, std::tuple<gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_preedit_string_>;
  if (init_data.get_surrounding) methods->get_surrounding = (decltype (methods->get_surrounding)) gi::detail::method_wrapper<self, bool (*) (gi::cstring & text, gint & cursor_index), gi::transfer_none_t, std::tuple<gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_surrounding_>;
  if (init_data.get_surrounding_with_selection) methods->get_surrounding_with_selection = (decltype (methods->get_surrounding_with_selection)) gi::detail::method_wrapper<self, bool (*) (gi::cstring & text, gint & cursor_index, gint & anchor_index), gi::transfer_none_t, std::tuple<gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_surrounding_with_selection_>;
  if (init_data.invalid_composition) methods->invalid_composition = (decltype (methods->invalid_composition)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v str), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::invalid_composition_>;
  if (init_data.preedit_changed) methods->preedit_changed = (decltype (methods->preedit_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::preedit_changed_>;
  if (init_data.preedit_end) methods->preedit_end = (decltype (methods->preedit_end)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::preedit_end_>;
  if (init_data.preedit_start) methods->preedit_start = (decltype (methods->preedit_start)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::preedit_start_>;
  if (init_data.reset) methods->reset = (decltype (methods->reset)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::reset_>;
  if (init_data.retrieve_surrounding) methods->retrieve_surrounding = (decltype (methods->retrieve_surrounding)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::retrieve_surrounding_>;
  if (init_data.set_client_widget) methods->set_client_widget = (decltype (methods->set_client_widget)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_client_widget_>;
  if (init_data.set_cursor_location) methods->set_cursor_location = (decltype (methods->set_cursor_location)) gi::detail::method_wrapper<self, void (*) (Gdk::Rectangle_Ref area), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_cursor_location_>;
  if (init_data.set_surrounding) methods->set_surrounding = (decltype (methods->set_surrounding)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v text, gint len, gint cursor_index), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::set_surrounding_>;
  if (init_data.set_surrounding_with_selection) methods->set_surrounding_with_selection = (decltype (methods->set_surrounding_with_selection)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v text, gint len, gint cursor_index, gint anchor_index), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::set_surrounding_with_selection_>;
  if (init_data.set_use_preedit) methods->set_use_preedit = (decltype (methods->set_use_preedit)) gi::detail::method_wrapper<self, void (*) (gboolean use_preedit), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_use_preedit_>;
}
...
// gboolean IMContext::activate_osk_with_event (GtkIMContext* context /*none*/, GdkEvent* event /*none*/);
// gboolean IMContext::activate_osk_with_event (::GtkIMContext* context /*none*/,  event /*none*/);
// SKIP; event type  not supported
...
// gboolean IMContext::invalid_composition (GtkIMContext* context /*none*/, const char* str /*none*/);
// gboolean IMContext::invalid_composition (::GtkIMContext* context /*none*/, const char* str /*none*/);
bool IMContextClass::invalid_composition_ (const gi::cstring_v str) noexcept
{
  if (!get_struct_()->invalid_composition) { g_critical ("no method in class struct"); return {}; }
  typedef gboolean (*call_wrap_t) (::GtkIMContext* context, const char* str);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->invalid_composition;
  auto str_to_c = gi::unwrap (str, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((::GtkIMContext*) (gobj_()), (const char*) (str_to_c));
  return _temp_ret;
}
