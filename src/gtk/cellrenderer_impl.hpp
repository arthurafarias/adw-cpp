...
// void gtk_cell_renderer_snapshot (::GtkCellRenderer* cell /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/, ::GtkWidget* widget /*none*/, const ::GdkRectangle* background_area /*none*/, const ::GdkRectangle* cell_area /*none*/, ::GtkCellRendererState flags);
void base::CellRendererBase::snapshot (Gtk::Snapshot snapshot, Gtk::Widget widget, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags) noexcept
{
  typedef void (*call_wrap_t) (::GtkCellRenderer* cell, ::GI_PATCH_GtkSnapshot* snapshot, ::GtkWidget* widget, const ::GdkRectangle* background_area, const ::GdkRectangle* cell_area, ::GtkCellRendererState flags);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_cell_renderer_snapshot;
  auto flags_to_c = gi::unwrap (flags);
  auto cell_area_to_c = gi::unwrap (cell_area, gi::transfer_none);
  ...
  call_wrap_v ((::GtkCellRenderer*) (gobj_()), (::GI_PATCH_GtkSnapshot*) (snapshot_to_c), (::GtkWidget*) (widget_to_c), (const ::GdkRectangle*) (background_area_to_c), (const ::GdkRectangle*) (cell_area_to_c), (::GtkCellRendererState) (flags_to_c));
}
...
void CellRendererClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.editing_canceled) methods->editing_canceled = (decltype (methods->editing_canceled)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::editing_canceled_>;
  if (init_data.editing_started) methods->editing_started = (decltype (methods->editing_started)) gi::detail::method_wrapper<self, void (*) (Gtk::CellEditable editable, const gi::cstring_v path), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::editing_started_>;
  if (init_data.get_aligned_area) methods->get_aligned_area = (decltype (methods->get_aligned_area)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget, Gtk::CellRendererState flags, const Gdk::Rectangle_Ref cell_area, Gdk::Rectangle_Ref aligned_area), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_aligned_area_>;
  if (init_data.get_preferred_height) methods->get_preferred_height = (decltype (methods->get_preferred_height)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget, gint & minimum_size, gint & natural_size), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_preferred_height_>;
  if (init_data.get_preferred_height_for_width) methods->get_preferred_height_for_width = (decltype (methods->get_preferred_height_for_width)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget, gint width, gint & minimum_height, gint & natural_height), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_preferred_height_for_width_>;
  if (init_data.get_preferred_width) methods->get_preferred_width = (decltype (methods->get_preferred_width)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget, gint & minimum_size, gint & natural_size), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_preferred_width_>;
  if (init_data.get_preferred_width_for_height) methods->get_preferred_width_for_height = (decltype (methods->get_preferred_width_for_height)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget, gint height, gint & minimum_width, gint & natural_width), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::get_preferred_width_for_height_>;
  ...
  if (init_data.snapshot) methods->snapshot = (decltype (methods->snapshot)) gi::detail::method_wrapper<self, void (*) (Gtk::Snapshot snapshot, Gtk::Widget widget, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::snapshot_>;
}
...
// void CellRenderer::snapshot (::GtkCellRenderer* cell /*none*/, ::GI_PATCH_GtkSnapshot* snapshot /*none*/, ::GtkWidget* widget /*none*/, const ::GdkRectangle* background_area /*none*/, const ::GdkRectangle* cell_area /*none*/, ::GtkCellRendererState flags);
void CellRendererClass::snapshot_ (Gtk::Snapshot snapshot, Gtk::Widget widget, const Gdk::Rectangle_Ref background_area, const Gdk::Rectangle_Ref cell_area, Gtk::CellRendererState flags) noexcept
{
