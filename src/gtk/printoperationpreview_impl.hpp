...
void PrintOperationPreviewIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.end_preview) methods->end_preview = (decltype (methods->end_preview)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::end_preview_>;
  if (init_data.got_page_size) methods->got_page_size = (decltype (methods->got_page_size)) gi::detail::method_wrapper<self, void (*) (Gtk::PrintContext context, Gtk::PageSetup page_setup), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::got_page_size_>;
  if (init_data.is_selected) methods->is_selected = (decltype (methods->is_selected)) gi::detail::method_wrapper<self, bool (*) (gint page_nr), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::is_selected_>;
  if (init_data.ready) methods->ready = (decltype (methods->ready)) gi::detail::method_wrapper<self, void (*) (Gtk::PrintContext context), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::ready_>;
  if (init_data.render_page) methods->render_page = (decltype (methods->render_page)) gi::detail::method_wrapper<self, void (*) (gint page_nr), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::render_page_>;
}
