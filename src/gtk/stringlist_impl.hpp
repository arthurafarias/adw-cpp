...
// guint gtk_string_list_find (::GtkStringList* self /*none*/, const char* string /*none*/);
guint base::StringListBase::find (const gi::cstring_v string) noexcept
{
  typedef guint (*call_wrap_t) (::GtkStringList* self, const char* string);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_string_list_find;
  auto string_to_c = gi::unwrap (string, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((::GtkStringList*) (gobj_()), (const char*) (string_to_c));
  return _temp_ret;
}
