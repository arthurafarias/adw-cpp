...
// ::GtkCssSection* /*full*/ gtk_css_section_new_with_bytes (::GFile* file /*none,nullable*/, ::GBytes* bytes /*none,nullable*/, const ::GtkCssLocation* start /*none*/, const ::GtkCssLocation* end /*none*/);
static GI_INLINE_DECL Gtk::CssSection new_with_bytes (Gio::File file, GLib::Bytes_Ref bytes, const Gtk::CssLocation_Ref start, const Gtk::CssLocation_Ref end) noexcept;
static GI_INLINE_DECL Gtk::CssSection new_with_bytes (const Gtk::CssLocation_Ref start, const Gtk::CssLocation_Ref end) noexcept;

// GBytes* /*none,nullable*/ gtk_css_section_get_bytes (const GtkCssSection* section /*none*/);
// ::GBytes* /*none,nullable*/ gtk_css_section_get_bytes (const ::GtkCssSection* section /*none*/);
GI_INLINE_DECL GLib::Bytes_Ref get_bytes () const noexcept;
