...
void LayoutManagerClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.allocate) methods->allocate = (decltype (methods->allocate)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget, gint width, gint height, gint baseline), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::allocate_>;
  if (init_data.create_layout_child) methods->create_layout_child = (decltype (methods->create_layout_child)) gi::detail::method_wrapper<self, Gtk::LayoutChild (*) (Gtk::Widget widget, Gtk::Widget for_child), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::create_layout_child_>;
  if (init_data.get_request_mode) methods->get_request_mode = (decltype (methods->get_request_mode)) gi::detail::method_wrapper<self, Gtk::SizeRequestMode (*) (Gtk::Widget widget), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_request_mode_>;
  if (init_data.measure) methods->measure = (decltype (methods->measure)) gi::detail::method_wrapper<self, void (*) (Gtk::Widget widget, Gtk::Orientation orientation, gint for_size, gint & minimum, gint & natural, gint & minimum_baseline, gint & natural_baseline), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::measure_>;
