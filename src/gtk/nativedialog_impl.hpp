...
void NativeDialogClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.response) methods->response = (decltype (methods->response)) gi::detail::method_wrapper<self, void (*) (gint response_id), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::response_>;
