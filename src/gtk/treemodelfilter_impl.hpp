...
void TreeModelFilterClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.modify) methods->modify = (decltype (methods->modify)) gi::detail::method_wrapper<self, void (*) (Gtk::TreeModel child_model, Gtk::TreeIter_Ref iter, GObject::Value_Ref value, gint column), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::modify_>;
  if (init_data.visible) methods->visible = (decltype (methods->visible)) gi::detail::method_wrapper<self, bool (*) (Gtk::TreeModel child_model, Gtk::TreeIter_Ref iter), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::visible_>;
}
