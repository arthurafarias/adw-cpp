...
Gtk::AccessibleHypertext LabelBase::interface_ (gi::interface_tag<Gtk::AccessibleHypertext>)
{ return gi::wrap ((Gtk::AccessibleHypertext::BaseObjectType*) gobj_copy_(), gi::transfer_full); }

LabelBase::operator Gtk::AccessibleHypertext ()
{ return interface_ (gi::interface_tag<Gtk::AccessibleHypertext>()); }

Gtk::AccessibleText LabelBase::interface_ (gi::interface_tag<Gtk::AccessibleText>)
{ return gi::wrap ((Gtk::AccessibleText::BaseObjectType*) gobj_copy_(), gi::transfer_full); }

LabelBase::operator Gtk::AccessibleText ()
