...
gi::property_proxy<Gtk::FontRendering, base::SettingsBase> property_gtk_font_rendering()
{ return gi::property_proxy<Gtk::FontRendering, base::SettingsBase> (*this, "gtk-font-rendering"); }
const gi::property_proxy<Gtk::FontRendering, base::SettingsBase> property_gtk_font_rendering() const
{ return gi::property_proxy<Gtk::FontRendering, base::SettingsBase> (*this, "gtk-font-rendering"); }
...
gi::property_proxy<Gtk::InterfaceColorScheme, base::SettingsBase> property_gtk_interface_color_scheme()
{ return gi::property_proxy<Gtk::InterfaceColorScheme, base::SettingsBase> (*this, "gtk-interface-color-scheme"); }
const gi::property_proxy<Gtk::InterfaceColorScheme, base::SettingsBase> property_gtk_interface_color_scheme() const
{ return gi::property_proxy<Gtk::InterfaceColorScheme, base::SettingsBase> (*this, "gtk-interface-color-scheme"); }

gi::property_proxy<Gtk::InterfaceContrast, base::SettingsBase> property_gtk_interface_contrast()
{ return gi::property_proxy<Gtk::InterfaceContrast, base::SettingsBase> (*this, "gtk-interface-contrast"); }
const gi::property_proxy<Gtk::InterfaceContrast, base::SettingsBase> property_gtk_interface_contrast() const
{ return gi::property_proxy<Gtk::InterfaceContrast, base::SettingsBase> (*this, "gtk-interface-contrast"); }

gi::property_proxy<Gtk::ReducedMotion, base::SettingsBase> property_gtk_interface_reduced_motion()
{ return gi::property_proxy<Gtk::ReducedMotion, base::SettingsBase> (*this, "gtk-interface-reduced-motion"); }
const gi::property_proxy<Gtk::ReducedMotion, base::SettingsBase> property_gtk_interface_reduced_motion() const
{ return gi::property_proxy<Gtk::ReducedMotion, base::SettingsBase> (*this, "gtk-interface-reduced-motion"); }
...
gi::property_proxy<bool, base::SettingsBase> property_gtk_show_status_shapes()
{ return gi::property_proxy<bool, base::SettingsBase> (*this, "gtk-show-status-shapes"); }
const gi::property_proxy<bool, base::SettingsBase> property_gtk_show_status_shapes() const
{ return gi::property_proxy<bool, base::SettingsBase> (*this, "gtk-show-status-shapes"); }
