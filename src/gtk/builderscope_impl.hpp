...
void BuilderScopeInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.create_closure) methods->create_closure = (decltype (methods->create_closure)) gi::detail::method_wrapper<self, GObject::Closure (*) (Gtk::Builder builder, const gi::cstring_v function_name, Gtk::BuilderClosureFlags flags, GObject::Object object, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::create_closure_>;
  if (init_data.get_type_from_function) methods->get_type_from_function = (decltype (methods->get_type_from_function)) gi::detail::method_wrapper<self, GType (*) (Gtk::Builder builder, const gi::cstring_v function_name), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_type_from_function_>;
  if (init_data.get_type_from_name) methods->get_type_from_name = (decltype (methods->get_type_from_name)) gi::detail::method_wrapper<self, GType (*) (Gtk::Builder builder, const gi::cstring_v type_name), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_type_from_name_>;
}
