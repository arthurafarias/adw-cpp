...
gi::property_proxy<Gdk::Drop, base::DropTargetBase> property_drop()
{ return gi::property_proxy<Gdk::Drop, base::DropTargetBase> (*this, "drop"); }
const gi::property_proxy<Gdk::Drop, base::DropTargetBase> property_drop() const
{ return gi::property_proxy<Gdk::Drop, base::DropTargetBase> (*this, "drop"); }
