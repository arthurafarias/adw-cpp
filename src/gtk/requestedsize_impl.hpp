...
GI_MODULE_STATIC_OR_INLINE gint _field_minimum_size_get (const ::GtkRequestedSize* obj) { return (gint) obj->minimum_size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_minimum_size_set (::GtkRequestedSize* obj, gint _value) { obj->minimum_size = (decltype(obj->minimum_size)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_natural_size_get (const ::GtkRequestedSize* obj) { return (gint) obj->natural_size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_natural_size_set (::GtkRequestedSize* obj, gint _value) { obj->natural_size = (decltype(obj->natural_size)) _value; }
