...
void RangeClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.adjust_bounds) methods->adjust_bounds = (decltype (methods->adjust_bounds)) gi::detail::method_wrapper<self, void (*) (gdouble new_value), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::adjust_bounds_>;
  if (init_data.change_value) methods->change_value = (decltype (methods->change_value)) gi::detail::method_wrapper<self, bool (*) (Gtk::ScrollType scroll, gdouble new_value), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::change_value_>;
  if (init_data.get_range_border) methods->get_range_border = (decltype (methods->get_range_border)) gi::detail::method_wrapper<self, void (*) (Gtk::Border_Ref border_), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_range_border_>;
  if (init_data.move_slider) methods->move_slider = (decltype (methods->move_slider)) gi::detail::method_wrapper<self, void (*) (Gtk::ScrollType scroll), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::move_slider_>;
  if (init_data.value_changed) methods->value_changed = (decltype (methods->value_changed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::value_changed_>;
}
