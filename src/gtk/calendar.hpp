...
GI_INLINE_DECL void set_year (gint year) noexcept;

// void gtk_calendar_unmark_day (GtkCalendar* calendar /*none*/, guint day);
// void gtk_calendar_unmark_day (::GtkCalendar* calendar /*none*/, guint day);
GI_INLINE_DECL void unmark_day (guint day) noexcept;

gi::property_proxy<GLib::DateTime, base::CalendarBase> property_date()
{ return gi::property_proxy<GLib::DateTime, base::CalendarBase> (*this, "date"); }
const gi::property_proxy<GLib::DateTime, base::CalendarBase> property_date() const
{ return gi::property_proxy<GLib::DateTime, base::CalendarBase> (*this, "date"); }
