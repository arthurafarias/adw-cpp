...
// gboolean gtk_filter_list_model_get_watch_items (::GtkFilterListModel* self /*none*/);
GI_INLINE_DECL bool get_watch_items () noexcept;
...
// void gtk_filter_list_model_set_watch_items (::GtkFilterListModel* self /*none*/, gboolean watch_items);
GI_INLINE_DECL void set_watch_items (gboolean watch_items) noexcept;
...
gi::property_proxy<bool, base::FilterListModelBase> property_watch_items()
{ return gi::property_proxy<bool, base::FilterListModelBase> (*this, "watch-items"); }
const gi::property_proxy<bool, base::FilterListModelBase> property_watch_items() const
{ return gi::property_proxy<bool, base::FilterListModelBase> (*this, "watch-items"); }
