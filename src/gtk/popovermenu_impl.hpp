...
// GtkPopoverMenuFlags gtk_popover_menu_get_flags (GtkPopoverMenu* popover /*none*/);
// ::GtkPopoverMenuFlags gtk_popover_menu_get_flags (::GtkPopoverMenu* popover /*none*/);
Gtk::PopoverMenuFlags base::PopoverMenuBase::get_flags () noexcept
{
  typedef ::GtkPopoverMenuFlags (*call_wrap_t) (::GtkPopoverMenu* popover);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_popover_menu_get_flags;
...
// void gtk_popover_menu_set_flags (GtkPopoverMenu* popover /*none*/, GtkPopoverMenuFlags flags);
// void gtk_popover_menu_set_flags (::GtkPopoverMenu* popover /*none*/, ::GtkPopoverMenuFlags flags);
void base::PopoverMenuBase::set_flags (Gtk::PopoverMenuFlags flags) noexcept
{
  typedef void (*call_wrap_t) (::GtkPopoverMenu* popover, ::GtkPopoverMenuFlags flags);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gtk_popover_menu_set_flags;
  auto flags_to_c = gi::unwrap (flags);
  call_wrap_v ((::GtkPopoverMenu*) (gobj_()), (::GtkPopoverMenuFlags) (flags_to_c));
}
