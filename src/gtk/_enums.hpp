...
enum class AccessibleAnnouncementPriority : std::underlying_type<GtkAccessibleAnnouncementPriority>::type {
  LOW_ = GTK_ACCESSIBLE_ANNOUNCEMENT_PRIORITY_LOW,
  MEDIUM_ = GTK_ACCESSIBLE_ANNOUNCEMENT_PRIORITY_MEDIUM,
  HIGH_ = GTK_ACCESSIBLE_ANNOUNCEMENT_PRIORITY_HIGH,
};
...
template<> struct declare_ctype_of<Gtk::AccessibleAnnouncementPriority>
{ typedef GtkAccessibleAnnouncementPriority type; }; 
template<> struct declare_cpptype_of<GtkAccessibleAnnouncementPriority>
{ typedef Gtk::AccessibleAnnouncementPriority type; }; 

template<> struct declare_gtype_of<Gtk::AccessibleAnnouncementPriority>
{ static GType get_type() { return gtk_accessible_announcement_priority_get_type(); } };
...
enum class AccessibleProperty : std::underlying_type<GtkAccessibleProperty>::type {
  ...
  HELP_TEXT_ = GTK_ACCESSIBLE_PROPERTY_HELP_TEXT,
};
...
enum class AccessibleRelation : std::underlying_type<GtkAccessibleRelation>::type {
  ...
  LABEL_FOR_ = GTK_ACCESSIBLE_RELATION_LABEL_FOR,
  DESCRIPTION_FOR_ = GTK_ACCESSIBLE_RELATION_DESCRIPTION_FOR,
  CONTROLLED_BY_ = GTK_ACCESSIBLE_RELATION_CONTROLLED_BY,
  DETAILS_FOR_ = GTK_ACCESSIBLE_RELATION_DETAILS_FOR,
  ERROR_MESSAGE_FOR_ = GTK_ACCESSIBLE_RELATION_ERROR_MESSAGE_FOR,
  FLOW_FROM_ = GTK_ACCESSIBLE_RELATION_FLOW_FROM,
};
...
enum class AccessibleRole : std::underlying_type<GtkAccessibleRole>::type {
  ...
  PARAGRAPH_ = GTK_ACCESSIBLE_ROLE_PARAGRAPH,
  BLOCK_QUOTE_ = GTK_ACCESSIBLE_ROLE_BLOCK_QUOTE,
  ARTICLE_ = GTK_ACCESSIBLE_ROLE_ARTICLE,
  COMMENT_ = GTK_ACCESSIBLE_ROLE_COMMENT,
  TERMINAL_ = GTK_ACCESSIBLE_ROLE_TERMINAL,
};
...
enum class AccessibleTextContentChange : std::underlying_type<GtkAccessibleTextContentChange>::type {
  INSERT_ = GTK_ACCESSIBLE_TEXT_CONTENT_CHANGE_INSERT,
  REMOVE_ = GTK_ACCESSIBLE_TEXT_CONTENT_CHANGE_REMOVE,
};
...
template<> struct declare_ctype_of<Gtk::AccessibleTextContentChange>
{ typedef GtkAccessibleTextContentChange type; }; 
template<> struct declare_cpptype_of<GtkAccessibleTextContentChange>
{ typedef Gtk::AccessibleTextContentChange type; }; 

template<> struct declare_gtype_of<Gtk::AccessibleTextContentChange>
{ static GType get_type() { return gtk_accessible_text_content_change_get_type(); } };
...
enum class AccessibleTextGranularity : std::underlying_type<GtkAccessibleTextGranularity>::type {
  CHARACTER_ = GTK_ACCESSIBLE_TEXT_GRANULARITY_CHARACTER,
  WORD_ = GTK_ACCESSIBLE_TEXT_GRANULARITY_WORD,
  SENTENCE_ = GTK_ACCESSIBLE_TEXT_GRANULARITY_SENTENCE,
  LINE_ = GTK_ACCESSIBLE_TEXT_GRANULARITY_LINE,
  PARAGRAPH_ = GTK_ACCESSIBLE_TEXT_GRANULARITY_PARAGRAPH,
};
...
template<> struct declare_ctype_of<Gtk::AccessibleTextGranularity>
{ typedef GtkAccessibleTextGranularity type; }; 
template<> struct declare_cpptype_of<GtkAccessibleTextGranularity>
{ typedef Gtk::AccessibleTextGranularity type; }; 

template<> struct declare_gtype_of<Gtk::AccessibleTextGranularity>
{ static GType get_type() { return gtk_accessible_text_granularity_get_type(); } };
...
enum class ConstraintVflParserError : std::underlying_type<GtkConstraintVflParserError>::type {
  INVALID_SYMBOL_ = GTK_CONSTRAINT_VFL_PARSER_ERROR_INVALID_SYMBOL,
  INVALID_ATTRIBUTE_ = GTK_CONSTRAINT_VFL_PARSER_ERROR_INVALID_ATTRIBUTE,
  INVALID_VIEW_ = GTK_CONSTRAINT_VFL_PARSER_ERROR_INVALID_VIEW,
  INVALID_METRIC_ = GTK_CONSTRAINT_VFL_PARSER_ERROR_INVALID_METRIC,
  INVALID_PRIORITY_ = GTK_CONSTRAINT_VFL_PARSER_ERROR_INVALID_PRIORITY,
  INVALID_RELATION_ = GTK_CONSTRAINT_VFL_PARSER_ERROR_INVALID_RELATION,
};
...
enum class FilterChange : std::underlying_type<GtkFilterChange>::type {
  ...
  DIFFERENT_REWATCH_ = GTK_FILTER_CHANGE_DIFFERENT_REWATCH,
  LESS_STRICT_REWATCH_ = GTK_FILTER_CHANGE_LESS_STRICT_REWATCH,
  MORE_STRICT_REWATCH_ = GTK_FILTER_CHANGE_MORE_STRICT_REWATCH,
};
...
enum class FontRendering : std::underlying_type<GtkFontRendering>::type {
  AUTOMATIC_ = GTK_FONT_RENDERING_AUTOMATIC,
  MANUAL_ = GTK_FONT_RENDERING_MANUAL,
};
...
template<> struct declare_ctype_of<Gtk::FontRendering>
{ typedef GtkFontRendering type; }; 
template<> struct declare_cpptype_of<GtkFontRendering>
{ typedef Gtk::FontRendering type; }; 

template<> struct declare_gtype_of<Gtk::FontRendering>
{ static GType get_type() { return gtk_font_rendering_get_type(); } };
...
enum class GraphicsOffloadEnabled : std::underlying_type<GtkGraphicsOffloadEnabled>::type {
  ENABLED_ = GTK_GRAPHICS_OFFLOAD_ENABLED,
  DISABLED_ = GTK_GRAPHICS_OFFLOAD_DISABLED,
};
...
template<> struct declare_ctype_of<Gtk::GraphicsOffloadEnabled>
{ typedef GtkGraphicsOffloadEnabled type; }; 
template<> struct declare_cpptype_of<GtkGraphicsOffloadEnabled>
{ typedef Gtk::GraphicsOffloadEnabled type; }; 

template<> struct declare_gtype_of<Gtk::GraphicsOffloadEnabled>
{ static GType get_type() { return gtk_graphics_offload_enabled_get_type(); } };
...
enum class InterfaceColorScheme : std::underlying_type<GtkInterfaceColorScheme>::type {
  UNSUPPORTED_ = GTK_INTERFACE_COLOR_SCHEME_UNSUPPORTED,
  DEFAULT_ = GTK_INTERFACE_COLOR_SCHEME_DEFAULT,
  DARK_ = GTK_INTERFACE_COLOR_SCHEME_DARK,
  LIGHT_ = GTK_INTERFACE_COLOR_SCHEME_LIGHT,
};
...
template<> struct declare_ctype_of<Gtk::InterfaceColorScheme>
{ typedef GtkInterfaceColorScheme type; }; 
template<> struct declare_cpptype_of<GtkInterfaceColorScheme>
{ typedef Gtk::InterfaceColorScheme type; }; 

template<> struct declare_gtype_of<Gtk::InterfaceColorScheme>
{ static GType get_type() { return gtk_interface_color_scheme_get_type(); } };
...
enum class InterfaceContrast : std::underlying_type<GtkInterfaceContrast>::type {
  UNSUPPORTED_ = GTK_INTERFACE_CONTRAST_UNSUPPORTED,
  NO_PREFERENCE_ = GTK_INTERFACE_CONTRAST_NO_PREFERENCE,
  MORE_ = GTK_INTERFACE_CONTRAST_MORE,
  LESS_ = GTK_INTERFACE_CONTRAST_LESS,
};
...
template<> struct declare_ctype_of<Gtk::InterfaceContrast>
{ typedef GtkInterfaceContrast type; }; 
template<> struct declare_cpptype_of<GtkInterfaceContrast>
{ typedef Gtk::InterfaceContrast type; }; 

template<> struct declare_gtype_of<Gtk::InterfaceContrast>
{ static GType get_type() { return gtk_interface_contrast_get_type(); } };
...
enum class ReducedMotion : std::underlying_type<GtkReducedMotion>::type {
  NO_PREFERENCE_ = GTK_REDUCED_MOTION_NO_PREFERENCE,
  REDUCE_ = GTK_REDUCED_MOTION_REDUCE,
};
...
template<> struct declare_ctype_of<Gtk::ReducedMotion>
{ typedef GtkReducedMotion type; }; 
template<> struct declare_cpptype_of<GtkReducedMotion>
{ typedef Gtk::ReducedMotion type; }; 

template<> struct declare_gtype_of<Gtk::ReducedMotion>
{ static GType get_type() { return gtk_reduced_motion_get_type(); } };
...
enum class RevealerTransitionType : std::underlying_type<GtkRevealerTransitionType>::type {
  ...
  FADE_SLIDE_RIGHT_ = GTK_REVEALER_TRANSITION_TYPE_FADE_SLIDE_RIGHT,
  FADE_SLIDE_LEFT_ = GTK_REVEALER_TRANSITION_TYPE_FADE_SLIDE_LEFT,
  FADE_SLIDE_UP_ = GTK_REVEALER_TRANSITION_TYPE_FADE_SLIDE_UP,
  FADE_SLIDE_DOWN_ = GTK_REVEALER_TRANSITION_TYPE_FADE_SLIDE_DOWN,
};
...
enum class SvgError : std::underlying_type<GtkSvgError>::type {
  INVALID_SYNTAX_ = GTK_SVG_ERROR_INVALID_SYNTAX,
  INVALID_ELEMENT_ = GTK_SVG_ERROR_INVALID_ELEMENT,
  INVALID_ATTRIBUTE_ = GTK_SVG_ERROR_INVALID_ATTRIBUTE,
  MISSING_ATTRIBUTE_ = GTK_SVG_ERROR_MISSING_ATTRIBUTE,
  INVALID_REFERENCE_ = GTK_SVG_ERROR_INVALID_REFERENCE,
  FAILED_UPDATE_ = GTK_SVG_ERROR_FAILED_UPDATE,
  FAILED_RENDERING_ = GTK_SVG_ERROR_FAILED_RENDERING,
  IGNORED_ELEMENT_ = GTK_SVG_ERROR_IGNORED_ELEMENT,
  LIMITS_EXCEEDED_ = GTK_SVG_ERROR_LIMITS_EXCEEDED,
  NOT_IMPLEMENTED_ = GTK_SVG_ERROR_NOT_IMPLEMENTED,
};
...
template<> struct declare_ctype_of<Gtk::SvgError>
{ typedef GtkSvgError type; }; 
template<> struct declare_cpptype_of<GtkSvgError>
{ typedef Gtk::SvgError type; }; 

template<> struct declare_gtype_of<Gtk::SvgError>
{ static GType get_type() { return gtk_svg_error_get_type(); } };
...
enum class SymbolicColor : std::underlying_type<GtkSymbolicColor>::type {
  ...
  ACCENT_ = GTK_SYMBOLIC_COLOR_ACCENT,
};
...
enum class WindowGravity : std::underlying_type<GtkWindowGravity>::type {
  TOP_LEFT_ = GTK_WINDOW_GRAVITY_TOP_LEFT,
  TOP_ = GTK_WINDOW_GRAVITY_TOP,
  TOP_RIGHT_ = GTK_WINDOW_GRAVITY_TOP_RIGHT,
  LEFT_ = GTK_WINDOW_GRAVITY_LEFT,
  CENTER_ = GTK_WINDOW_GRAVITY_CENTER,
  RIGHT_ = GTK_WINDOW_GRAVITY_RIGHT,
  BOTTOM_LEFT_ = GTK_WINDOW_GRAVITY_BOTTOM_LEFT,
  BOTTOM_ = GTK_WINDOW_GRAVITY_BOTTOM,
  BOTTOM_RIGHT_ = GTK_WINDOW_GRAVITY_BOTTOM_RIGHT,
  TOP_START_ = GTK_WINDOW_GRAVITY_TOP_START,
  TOP_END_ = GTK_WINDOW_GRAVITY_TOP_END,
  START_ = GTK_WINDOW_GRAVITY_START,
  END_ = GTK_WINDOW_GRAVITY_END,
  BOTTOM_START_ = GTK_WINDOW_GRAVITY_BOTTOM_START,
  BOTTOM_END_ = GTK_WINDOW_GRAVITY_BOTTOM_END,
};
...
template<> struct declare_ctype_of<Gtk::WindowGravity>
{ typedef GtkWindowGravity type; }; 
template<> struct declare_cpptype_of<GtkWindowGravity>
{ typedef Gtk::WindowGravity type; }; 

template<> struct declare_gtype_of<Gtk::WindowGravity>
{ static GType get_type() { return gtk_window_gravity_get_type(); } };
