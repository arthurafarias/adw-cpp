...
GI_MODULE_STATIC_OR_INLINE ::PangoItem* _field_item_get (const ::PangoGlyphItem* obj) { return (::PangoItem*) obj->item; }
...
GI_MODULE_STATIC_OR_INLINE ::PangoGlyphString* _field_glyphs_get (const ::PangoGlyphItem* obj) { return (::PangoGlyphString*) obj->glyphs; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_y_offset_get (const ::PangoGlyphItem* obj) { return (gint) obj->y_offset; }
...
GI_MODULE_STATIC_OR_INLINE void _field_y_offset_set (::PangoGlyphItem* obj, gint _value) { obj->y_offset = (decltype(obj->y_offset)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_start_x_offset_get (const ::PangoGlyphItem* obj) { return (gint) obj->start_x_offset; }
...
GI_MODULE_STATIC_OR_INLINE void _field_start_x_offset_set (::PangoGlyphItem* obj, gint _value) { obj->start_x_offset = (decltype(obj->start_x_offset)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_end_x_offset_get (const ::PangoGlyphItem* obj) { return (gint) obj->end_x_offset; }
...
GI_MODULE_STATIC_OR_INLINE void _field_end_x_offset_set (::PangoGlyphItem* obj, gint _value) { obj->end_x_offset = (decltype(obj->end_x_offset)) _value; }
...
// GSList* /*full*/ pango_glyph_item_apply_attrs (PangoGlyphItem* glyph_item /*full*/, const char* text /*none*/, PangoAttrList* list /*none*/);
// ::GSList* /*full*/ pango_glyph_item_apply_attrs (::PangoGlyphItem* glyph_item /*full*/, const char* text /*none*/, ::PangoAttrList* list /*none*/);
...
// void pango_glyph_item_get_logical_widths (PangoGlyphItem* glyph_item /*none*/, const char* text /*none*/,  logical_widths /*none,out,ca*/);
// void pango_glyph_item_get_logical_widths (::PangoGlyphItem* glyph_item /*none*/, const char* text /*none*/, * logical_widths /*none,out,ca*/);
