...
// gboolean pango_font_map_add_font_file (::PangoFontMap* fontmap /*none*/, const char* filename /*none*/, GError ** error);
GI_INLINE_DECL bool add_font_file (const gi::cstring_v filename);
GI_INLINE_DECL bool add_font_file (const gi::cstring_v filename, GLib::Error * _error) noexcept;
...
GI_INLINE_DECL Pango::Font reload_font (Pango::Font font, gdouble scale, Pango::Context context, const gi::cstring_v variations) noexcept;
GI_INLINE_DECL Pango::Font reload_font (Pango::Font font, gdouble scale) noexcept;
