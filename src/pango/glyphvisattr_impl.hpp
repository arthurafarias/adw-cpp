...
GI_MODULE_STATIC_OR_INLINE guint _field_is_cluster_start_get (const ::PangoGlyphVisAttr* obj) { return (guint) obj->is_cluster_start; }
...
GI_MODULE_STATIC_OR_INLINE void _field_is_cluster_start_set (::PangoGlyphVisAttr* obj, guint _value) { obj->is_cluster_start = (decltype(obj->is_cluster_start)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_is_color_get (const ::PangoGlyphVisAttr* obj) { return (guint) obj->is_color; }
...
GI_MODULE_STATIC_OR_INLINE void _field_is_color_set (::PangoGlyphVisAttr* obj, guint _value) { obj->is_color = (decltype(obj->is_color)) _value; }
