...
// gboolean pango_font_map_add_font_file (PangoFontMap* fontmap /*none*/, const char* filename /*none*/, GError ** error);
// gboolean pango_font_map_add_font_file (::PangoFontMap* fontmap /*none*/, const char* filename /*none*/, GError ** error);
bool base::FontMapBase::add_font_file (const gi::cstring_v filename)
{
  typedef gboolean (*call_wrap_t) (::PangoFontMap* fontmap, const char* filename, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_map_add_font_file;
  auto filename_to_c = gi::unwrap (filename, gi::transfer_none);
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::PangoFontMap*) (gobj_()), (const char*) (filename_to_c), &error);
  gi::check_error (error);
  return _temp_ret;
}
bool base::FontMapBase::add_font_file (const gi::cstring_v filename, GLib::Error * _error) noexcept
{
  typedef gboolean (*call_wrap_t) (::PangoFontMap* fontmap, const char* filename, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_map_add_font_file;
  auto filename_to_c = gi::unwrap (filename, gi::transfer_none);
  GError* _error_o {};
  auto _temp_ret = call_wrap_v ((::PangoFontMap*) (gobj_()), (const char*) (filename_to_c), _error ? &_error_o : nullptr);
...
// PangoFontFamily* /*none,nullable*/ pango_font_map_get_family (PangoFontMap* fontmap /*none*/, const char* name /*none*/);
// ::PangoFontFamily* /*none,nullable*/ pango_font_map_get_family (::PangoFontMap* fontmap /*none*/, const char* name /*none*/);
...
// PangoFont* /*full*/ pango_font_map_reload_font (PangoFontMap* fontmap /*none*/, PangoFont* font /*none*/, double scale, PangoContext* context /*none,nullable*/, const char* variations /*none,nullable*/);
// ::PangoFont* /*full*/ pango_font_map_reload_font (::PangoFontMap* fontmap /*none*/, ::PangoFont* font /*none*/, gdouble scale, ::PangoContext* context /*none,nullable*/, const char* variations /*none,nullable*/);
Pango::Font base::FontMapBase::reload_font (Pango::Font font, gdouble scale, Pango::Context context, const gi::cstring_v variations) noexcept
{
  typedef ::PangoFont* (*call_wrap_t) (::PangoFontMap* fontmap, ::PangoFont* font, gdouble scale, ::PangoContext* context, const char* variations);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_map_reload_font;
  ...
  auto _temp_ret = call_wrap_v ((::PangoFontMap*) (gobj_()), (::PangoFont*) (font_to_c), (gdouble) (scale_to_c), (::PangoContext*) (context_to_c), (const char*) (variations_to_c));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
Pango::Font base::FontMapBase::reload_font (Pango::Font font, gdouble scale) noexcept
{
  typedef ::PangoFont* (*call_wrap_t) (::PangoFontMap* fontmap, ::PangoFont* font, gdouble scale, ::PangoContext* context, const char* variations);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_map_reload_font;
...
void FontMapClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.get_family) methods->get_family = (decltype (methods->get_family)) gi::detail::method_wrapper<self, Pango::FontFamily (*) (const gi::cstring_v name), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_family_>;
  if (init_data.get_serial) methods->get_serial = (decltype (methods->get_serial)) gi::detail::method_wrapper<self, guint (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_serial_>;
  if (init_data.list_families) methods->list_families = (decltype (methods->list_families)) gi::detail::method_wrapper<self, void (*) (gi::Collection<gi::DSpan, ::PangoFontFamily*, gi::transfer_container_t> & families), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_container_t, false, void, detail::args_index<0, 1>>>, void  (::PangoFontFamily*** families, gint* n_families)>::wrapper<&self::list_families_>;
  if (init_data.load_font) methods->load_font = (decltype (methods->load_font)) gi::detail::method_wrapper<self, Pango::Font (*) (Pango::Context context, const Pango::FontDescription_Ref desc), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::load_font_>;
  if (init_data.load_fontset) methods->load_fontset = (decltype (methods->load_fontset)) gi::detail::method_wrapper<self, Pango::Fontset (*) (Pango::Context context, const Pango::FontDescription_Ref desc, Pango::Language_Ref language), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::load_fontset_>;
}
...
// PangoFontFamily* /*none,nullable*/ FontMap::get_family (PangoFontMap* fontmap /*none*/, const char* name /*none*/);
// ::PangoFontFamily* /*none,nullable*/ FontMap::get_family (::PangoFontMap* fontmap /*none*/, const char* name /*none*/);
