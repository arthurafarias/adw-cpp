...
GI_MODULE_STATIC_OR_INLINE gdouble _field_xx_get (const ::PangoMatrix* obj) { return (gdouble) obj->xx; }
...
GI_MODULE_STATIC_OR_INLINE void _field_xx_set (::PangoMatrix* obj, gdouble _value) { obj->xx = (decltype(obj->xx)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gdouble _field_xy_get (const ::PangoMatrix* obj) { return (gdouble) obj->xy; }
...
GI_MODULE_STATIC_OR_INLINE void _field_xy_set (::PangoMatrix* obj, gdouble _value) { obj->xy = (decltype(obj->xy)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gdouble _field_yx_get (const ::PangoMatrix* obj) { return (gdouble) obj->yx; }
...
GI_MODULE_STATIC_OR_INLINE void _field_yx_set (::PangoMatrix* obj, gdouble _value) { obj->yx = (decltype(obj->yx)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gdouble _field_yy_get (const ::PangoMatrix* obj) { return (gdouble) obj->yy; }
...
GI_MODULE_STATIC_OR_INLINE void _field_yy_set (::PangoMatrix* obj, gdouble _value) { obj->yy = (decltype(obj->yy)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gdouble _field_x0_get (const ::PangoMatrix* obj) { return (gdouble) obj->x0; }
...
GI_MODULE_STATIC_OR_INLINE void _field_x0_set (::PangoMatrix* obj, gdouble _value) { obj->x0 = (decltype(obj->x0)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gdouble _field_y0_get (const ::PangoMatrix* obj) { return (gdouble) obj->y0; }
...
GI_MODULE_STATIC_OR_INLINE void _field_y0_set (::PangoMatrix* obj, gdouble _value) { obj->y0 = (decltype(obj->y0)) _value; }
