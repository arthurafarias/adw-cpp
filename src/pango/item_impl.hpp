...
GI_MODULE_STATIC_OR_INLINE gint _field_offset_get (const ::PangoItem* obj) { return (gint) obj->offset; }
...
GI_MODULE_STATIC_OR_INLINE void _field_offset_set (::PangoItem* obj, gint _value) { obj->offset = (decltype(obj->offset)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_length_get (const ::PangoItem* obj) { return (gint) obj->length; }
...
GI_MODULE_STATIC_OR_INLINE void _field_length_set (::PangoItem* obj, gint _value) { obj->length = (decltype(obj->length)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_num_chars_get (const ::PangoItem* obj) { return (gint) obj->num_chars; }
...
GI_MODULE_STATIC_OR_INLINE void _field_num_chars_set (::PangoItem* obj, gint _value) { obj->num_chars = (decltype(obj->num_chars)) _value; }
...
// int pango_item_get_char_offset (PangoItem* item /*none*/);
// gint pango_item_get_char_offset (::PangoItem* item /*none*/);
gint base::ItemBase::get_char_offset () noexcept
{
  typedef gint (*call_wrap_t) (::PangoItem* item);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_item_get_char_offset;
  auto _temp_ret = call_wrap_v ((::PangoItem*) (gobj_()));
  return _temp_ret;
}
