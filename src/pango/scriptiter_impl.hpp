...
// void pango_script_iter_get_range (PangoScriptIter* iter /*none*/, const char** start /*none,out,opt*/, const char** end /*none,out,opt*/, PangoScript* script);
// void pango_script_iter_get_range (::PangoScriptIter* iter /*none*/, const char** start /*none,out,opt*/, const char** end /*none,out,opt*/, ::PangoScript* script);
void base::ScriptIterBase::get_range (gi::cstring_v * start, gi::cstring_v * end, Pango::Script * script) noexcept
{
  ...
  if (start) *start = gi::wrap (start_o, gi::transfer_none);
}
std::tuple<gi::cstring_v, gi::cstring_v, Pango::Script> base::ScriptIterBase::get_range () noexcept
{
  typedef void (*call_wrap_t) (::PangoScriptIter* iter, const char** start, const char** end, ::PangoScript* script);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_script_iter_get_range;
  ::PangoScript script_o {};
  ...
  auto &&tmp_return_1 = gi::wrap (start_o, gi::transfer_none);
