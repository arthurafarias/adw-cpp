...
GI_MODULE_STATIC_OR_INLINE ::PangoGlyphItem* _field_glyph_item_get (const ::PangoGlyphItemIter* obj) { return (::PangoGlyphItem*) obj->glyph_item; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_text_get (const ::PangoGlyphItemIter* obj) { return (const char*) obj->text; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_start_glyph_get (const ::PangoGlyphItemIter* obj) { return (gint) obj->start_glyph; }
...
GI_MODULE_STATIC_OR_INLINE void _field_start_glyph_set (::PangoGlyphItemIter* obj, gint _value) { obj->start_glyph = (decltype(obj->start_glyph)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_start_index_get (const ::PangoGlyphItemIter* obj) { return (gint) obj->start_index; }
...
GI_MODULE_STATIC_OR_INLINE void _field_start_index_set (::PangoGlyphItemIter* obj, gint _value) { obj->start_index = (decltype(obj->start_index)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_start_char_get (const ::PangoGlyphItemIter* obj) { return (gint) obj->start_char; }
...
GI_MODULE_STATIC_OR_INLINE void _field_start_char_set (::PangoGlyphItemIter* obj, gint _value) { obj->start_char = (decltype(obj->start_char)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_end_glyph_get (const ::PangoGlyphItemIter* obj) { return (gint) obj->end_glyph; }
...
GI_MODULE_STATIC_OR_INLINE void _field_end_glyph_set (::PangoGlyphItemIter* obj, gint _value) { obj->end_glyph = (decltype(obj->end_glyph)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_end_index_get (const ::PangoGlyphItemIter* obj) { return (gint) obj->end_index; }
...
GI_MODULE_STATIC_OR_INLINE void _field_end_index_set (::PangoGlyphItemIter* obj, gint _value) { obj->end_index = (decltype(obj->end_index)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_end_char_get (const ::PangoGlyphItemIter* obj) { return (gint) obj->end_char; }
...
GI_MODULE_STATIC_OR_INLINE void _field_end_char_set (::PangoGlyphItemIter* obj, gint _value) { obj->end_char = (decltype(obj->end_char)) _value; }
