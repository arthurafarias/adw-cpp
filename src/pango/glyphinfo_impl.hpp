...
GI_MODULE_STATIC_OR_INLINE ::PangoGlyph _field_glyph_get (const ::PangoGlyphInfo* obj) { return (::PangoGlyph) obj->glyph; }
...
GI_MODULE_STATIC_OR_INLINE void _field_glyph_set (::PangoGlyphInfo* obj, ::PangoGlyph _value) { obj->glyph = (decltype(obj->glyph)) _value; }
