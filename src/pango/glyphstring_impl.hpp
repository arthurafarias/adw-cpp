...
GI_MODULE_STATIC_OR_INLINE gint _field_num_glyphs_get (const ::PangoGlyphString* obj) { return (gint) obj->num_glyphs; }
...
GI_MODULE_STATIC_OR_INLINE void _field_num_glyphs_set (::PangoGlyphString* obj, gint _value) { obj->num_glyphs = (decltype(obj->num_glyphs)) _value; }
...
// void pango_glyph_string_get_logical_widths (PangoGlyphString* glyphs /*none*/, const char* text /*none*/, int length, int embedding_level,  logical_widths /*none,out,ca*/);
// void pango_glyph_string_get_logical_widths (::PangoGlyphString* glyphs /*none*/, const char* text /*none*/, gint length, gint embedding_level, * logical_widths /*none,out,ca*/);
...
void base::GlyphStringBase::index_to_x (const gi::cstring_v text, gint length, Pango::Analysis_Ref analysis, gint index_, gboolean trailing, gint * x_pos) noexcept
{
  ...
  call_wrap_v ((::PangoGlyphString*) (gobj_()), (const char*) (text_to_c), (gint) (length_to_c), (::PangoAnalysis*) (analysis_to_c), (gint) (index__to_c), (gboolean) (trailing_to_c), (gint*) (x_pos ? &x_pos_o : nullptr));
...
void base::GlyphStringBase::index_to_x_full (const gi::cstring_v text, gint length, Pango::Analysis_Ref analysis, Pango::LogAttr_Ref attrs, gint index_, gboolean trailing, gint * x_pos) noexcept
{
  ...
  auto length_to_c = length;
  auto text_to_c = gi::unwrap (text, gi::transfer_none);
  call_wrap_v ((::PangoGlyphString*) (gobj_()), (const char*) (text_to_c), (gint) (length_to_c), (::PangoAnalysis*) (analysis_to_c), (::PangoLogAttr*) (attrs_to_c), (gint) (index__to_c), (gboolean) (trailing_to_c), (gint*) (x_pos ? &x_pos_o : nullptr));
  if (x_pos) *x_pos = x_pos_o;
}
...
void base::GlyphStringBase::x_to_index (const gi::cstring_v text, gint length, Pango::Analysis_Ref analysis, gint x_pos, gint * index_, gint * trailing) noexcept
{
  ...
  auto length_to_c = length;
  auto text_to_c = gi::unwrap (text, gi::transfer_none);
  call_wrap_v ((::PangoGlyphString*) (gobj_()), (const char*) (text_to_c), (gint) (length_to_c), (::PangoAnalysis*) (analysis_to_c), (gint) (x_pos_to_c), (gint*) (index_ ? &index__o : nullptr), (gint*) (trailing ? &trailing_o : nullptr));
