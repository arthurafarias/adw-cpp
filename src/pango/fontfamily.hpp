...
gi::property_proxy<bool, base::FontFamilyBase> property_is_monospace()
{ return gi::property_proxy<bool, base::FontFamilyBase> (*this, "is-monospace"); }
const gi::property_proxy<bool, base::FontFamilyBase> property_is_monospace() const
{ return gi::property_proxy<bool, base::FontFamilyBase> (*this, "is-monospace"); }

gi::property_proxy<bool, base::FontFamilyBase> property_is_variable()
{ return gi::property_proxy<bool, base::FontFamilyBase> (*this, "is-variable"); }
const gi::property_proxy<bool, base::FontFamilyBase> property_is_variable() const
{ return gi::property_proxy<bool, base::FontFamilyBase> (*this, "is-variable"); }
...
gi::property_proxy<gi::cstring, base::FontFamilyBase> property_name()
{ return gi::property_proxy<gi::cstring, base::FontFamilyBase> (*this, "name"); }
const gi::property_proxy<gi::cstring, base::FontFamilyBase> property_name() const
{ return gi::property_proxy<gi::cstring, base::FontFamilyBase> (*this, "name"); }
