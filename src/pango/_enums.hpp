...
enum class FontColor : std::underlying_type<PangoFontColor>::type {
  FORBIDDEN_ = PANGO_FONT_COLOR_FORBIDDEN,
  REQUIRED_ = PANGO_FONT_COLOR_REQUIRED,
  DONT_CARE_ = PANGO_FONT_COLOR_DONT_CARE,
};
...
template<> struct declare_ctype_of<Pango::FontColor>
{ typedef PangoFontColor type; }; 
template<> struct declare_cpptype_of<PangoFontColor>
{ typedef Pango::FontColor type; }; 

template<> struct declare_gtype_of<Pango::FontColor>
{ static GType get_type() { return pango_font_color_get_type(); } };
