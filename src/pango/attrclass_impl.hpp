...
GI_MODULE_STATIC_OR_INLINE ::PangoAttrType _field_type_get (const ::PangoAttrClass* obj) { return (::PangoAttrType) obj->type; }
...
GI_MODULE_STATIC_OR_INLINE void _field_type_set (::PangoAttrClass* obj, ::PangoAttrType _value) { obj->type = (decltype(obj->type)) _value; }
