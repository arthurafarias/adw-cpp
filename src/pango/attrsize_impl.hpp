...
GI_MODULE_STATIC_OR_INLINE gint _field_size_get (const ::PangoAttrSize* obj) { return (gint) obj->size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_size_set (::PangoAttrSize* obj, gint _value) { obj->size = (decltype(obj->size)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_absolute_get (const ::PangoAttrSize* obj) { return (guint) obj->absolute; }
...
GI_MODULE_STATIC_OR_INLINE void _field_absolute_set (::PangoAttrSize* obj, guint _value) { obj->absolute = (decltype(obj->absolute)) _value; }
