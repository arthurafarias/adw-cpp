...
GI_MODULE_STATIC_OR_INLINE gint _field_value_get (const ::PangoAttrInt* obj) { return (gint) obj->value; }
...
GI_MODULE_STATIC_OR_INLINE void _field_value_set (::PangoAttrInt* obj, gint _value) { obj->value = (decltype(obj->value)) _value; }
