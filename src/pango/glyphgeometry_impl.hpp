...
GI_MODULE_STATIC_OR_INLINE ::PangoGlyphUnit _field_width_get (const ::PangoGlyphGeometry* obj) { return (::PangoGlyphUnit) obj->width; }
...
GI_MODULE_STATIC_OR_INLINE void _field_width_set (::PangoGlyphGeometry* obj, ::PangoGlyphUnit _value) { obj->width = (decltype(obj->width)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::PangoGlyphUnit _field_x_offset_get (const ::PangoGlyphGeometry* obj) { return (::PangoGlyphUnit) obj->x_offset; }
...
GI_MODULE_STATIC_OR_INLINE void _field_x_offset_set (::PangoGlyphGeometry* obj, ::PangoGlyphUnit _value) { obj->x_offset = (decltype(obj->x_offset)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::PangoGlyphUnit _field_y_offset_get (const ::PangoGlyphGeometry* obj) { return (::PangoGlyphUnit) obj->y_offset; }
...
GI_MODULE_STATIC_OR_INLINE void _field_y_offset_set (::PangoGlyphGeometry* obj, ::PangoGlyphUnit _value) { obj->y_offset = (decltype(obj->y_offset)) _value; }
