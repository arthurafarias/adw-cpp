...
GI_INLINE_DECL void shape (const gi::cstring_v text, gint length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs) noexcept;
GI_INLINE_DECL Pango::GlyphString shape (const gi::cstring_v text, gint length, const Pango::Analysis_Ref analysis) noexcept;
...
GI_INLINE_DECL void shape_full (const gi::cstring_v item_text, gint item_length, const gi::cstring_v paragraph_text, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs) noexcept;
GI_INLINE_DECL void shape_full (const gi::cstring_v item_text, gint item_length, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs) noexcept;
GI_INLINE_DECL Pango::GlyphString shape_full (const gi::cstring_v item_text, gint item_length, const gi::cstring_v paragraph_text, gint paragraph_length, const Pango::Analysis_Ref analysis) noexcept;
GI_INLINE_DECL Pango::GlyphString shape_full (const gi::cstring_v item_text, gint item_length, gint paragraph_length, const Pango::Analysis_Ref analysis) noexcept;
...
GI_INLINE_DECL void shape_item (Pango::Item_Ref item, const gi::cstring_v paragraph_text, gint paragraph_length, Pango::LogAttr_Ref log_attrs, Pango::GlyphString & glyphs, Pango::ShapeFlags flags) noexcept;
GI_INLINE_DECL void shape_item (Pango::Item_Ref item, gint paragraph_length, Pango::GlyphString & glyphs, Pango::ShapeFlags flags) noexcept;
GI_INLINE_DECL Pango::GlyphString shape_item (Pango::Item_Ref item, const gi::cstring_v paragraph_text, gint paragraph_length, Pango::LogAttr_Ref log_attrs, Pango::ShapeFlags flags) noexcept;
GI_INLINE_DECL Pango::GlyphString shape_item (Pango::Item_Ref item, gint paragraph_length, Pango::ShapeFlags flags) noexcept;
...
GI_INLINE_DECL void shape_with_flags (const gi::cstring_v item_text, gint item_length, const gi::cstring_v paragraph_text, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs, Pango::ShapeFlags flags) noexcept;
GI_INLINE_DECL void shape_with_flags (const gi::cstring_v item_text, gint item_length, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs, Pango::ShapeFlags flags) noexcept;
GI_INLINE_DECL Pango::GlyphString shape_with_flags (const gi::cstring_v item_text, gint item_length, const gi::cstring_v paragraph_text, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::ShapeFlags flags) noexcept;
GI_INLINE_DECL Pango::GlyphString shape_with_flags (const gi::cstring_v item_text, gint item_length, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::ShapeFlags flags) noexcept;
