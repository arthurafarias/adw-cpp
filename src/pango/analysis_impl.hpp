...
GI_MODULE_STATIC_OR_INLINE ::PangoFont* _field_font_get (const ::PangoAnalysis* obj) { return (::PangoFont*) obj->font; }
...
GI_MODULE_STATIC_OR_INLINE guint8 _field_level_get (const ::PangoAnalysis* obj) { return (guint8) obj->level; }
...
GI_MODULE_STATIC_OR_INLINE void _field_level_set (::PangoAnalysis* obj, guint8 _value) { obj->level = (decltype(obj->level)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint8 _field_gravity_get (const ::PangoAnalysis* obj) { return (guint8) obj->gravity; }
...
GI_MODULE_STATIC_OR_INLINE void _field_gravity_set (::PangoAnalysis* obj, guint8 _value) { obj->gravity = (decltype(obj->gravity)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint8 _field_flags_get (const ::PangoAnalysis* obj) { return (guint8) obj->flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_flags_set (::PangoAnalysis* obj, guint8 _value) { obj->flags = (decltype(obj->flags)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint8 _field_script_get (const ::PangoAnalysis* obj) { return (guint8) obj->script; }
...
GI_MODULE_STATIC_OR_INLINE void _field_script_set (::PangoAnalysis* obj, guint8 _value) { obj->script = (decltype(obj->script)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::PangoLanguage* _field_language_get (const ::PangoAnalysis* obj) { return (::PangoLanguage*) obj->language; }
