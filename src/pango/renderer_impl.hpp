...
GI_MODULE_STATIC_OR_INLINE ::PangoMatrix* _field_matrix_get (const ::PangoRenderer* obj) { return (::PangoMatrix*) obj->matrix; }
...
void RendererClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.begin) methods->begin = (decltype (methods->begin)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::begin_>;
  if (init_data.draw_error_underline) methods->draw_error_underline = (decltype (methods->draw_error_underline)) gi::detail::method_wrapper<self, void (*) (gint x, gint y, gint width, gint height), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::draw_error_underline_>;
  if (init_data.draw_glyph) methods->draw_glyph = (decltype (methods->draw_glyph)) gi::detail::method_wrapper<self, void (*) (Pango::Font font, ::PangoGlyph glyph, gdouble x, gdouble y), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::draw_glyph_>;
  if (init_data.draw_glyph_item) methods->draw_glyph_item = (decltype (methods->draw_glyph_item)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v text, Pango::GlyphItem_Ref glyph_item, gint x, gint y), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::draw_glyph_item_>;
  if (init_data.draw_glyphs) methods->draw_glyphs = (decltype (methods->draw_glyphs)) gi::detail::method_wrapper<self, void (*) (Pango::Font font, Pango::GlyphString_Ref glyphs, gint x, gint y), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::draw_glyphs_>;
  if (init_data.draw_rectangle) methods->draw_rectangle = (decltype (methods->draw_rectangle)) gi::detail::method_wrapper<self, void (*) (Pango::RenderPart part, gint x, gint y, gint width, gint height), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::draw_rectangle_>;
  if (init_data.draw_shape) methods->draw_shape = (decltype (methods->draw_shape)) gi::detail::method_wrapper<self, void (*) (Pango::AttrShape_Ref attr, gint x, gint y), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::draw_shape_>;
  if (init_data.draw_trapezoid) methods->draw_trapezoid = (decltype (methods->draw_trapezoid)) gi::detail::method_wrapper<self, void (*) (Pango::RenderPart part, gdouble y1_, gdouble x11, gdouble x21, gdouble y2, gdouble x12, gdouble x22), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::draw_trapezoid_>;
  if (init_data.end) methods->end = (decltype (methods->end)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::end_>;
  if (init_data.part_changed) methods->part_changed = (decltype (methods->part_changed)) gi::detail::method_wrapper<self, void (*) (Pango::RenderPart part), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::part_changed_>;
}
