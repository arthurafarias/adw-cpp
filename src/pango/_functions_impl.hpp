...
// void pango_attr_break (const char* text /*none*/, int length, PangoAttrList* attr_list /*none*/, int offset, PangoLogAttr* attrs /*none,out,ca*/, int attrs_len);
// void pango_attr_break (const char* text /*none*/, gint length, ::PangoAttrList* attr_list /*none*/, gint offset, ::PangoLogAttr** attrs /*none,out,ca*/, gint attrs_len);
// SKIP; attrs out boxed array not supported (depth 1)
...
// void pango_default_break (const char* text /*none*/, int length, PangoAnalysis* analysis /*none,nullable*/, PangoLogAttr* attrs /*none,out,ca*/, int attrs_len);
// void pango_default_break (const char* text /*none*/, gint length, ::PangoAnalysis* analysis /*none,nullable*/, ::PangoLogAttr** attrs /*none,out,ca*/, gint attrs_len);
// SKIP; attrs out boxed array not supported (depth 1)

// void pango_extents_to_pixels (PangoRectangle* inclusive /*full,inout,opt*/, PangoRectangle* nearest /*full,inout,opt*/);
// void pango_extents_to_pixels (::PangoRectangle** inclusive /*full,inout,opt*/, ::PangoRectangle** nearest /*full,inout,opt*/);
// SKIP; inconsistent nearest inout pointer depth (1 vs 2), inconsistent inclusive inout pointer depth (1 vs 2)
...
void find_paragraph_boundary (const gi::cstring_v text, gint length, gint * paragraph_delimiter_index, gint * next_paragraph_start) noexcept
{
  ...
  auto length_to_c = length;
  auto text_to_c = gi::unwrap (text, gi::transfer_none);
  call_wrap_v ((const char*) (text_to_c), (gint) (length_to_c), (gint*) (paragraph_delimiter_index ? &paragraph_delimiter_index_o : nullptr), (gint*) (next_paragraph_start ? &next_paragraph_start_o : nullptr));
  if (next_paragraph_start) *next_paragraph_start = next_paragraph_start_o;
  if (paragraph_delimiter_index) *paragraph_delimiter_index = paragraph_delimiter_index_o;
}
...
// void pango_get_log_attrs (const char* text /*none*/, int length, int level, PangoLanguage* language /*none*/, PangoLogAttr* attrs /*none,out,ca*/, int attrs_len);
// void pango_get_log_attrs (const char* text /*none*/, gint length, gint level, ::PangoLanguage* language /*none*/, ::PangoLogAttr** attrs /*none,out,ca*/, gint attrs_len);
// SKIP; attrs out boxed array not supported (depth 1)
...
//  /*full*/ pango_log2vis_get_embedding_levels (const gchar* text /*none*/, int length, PangoDirection* pbase_dir);
// * /*full*/ pango_log2vis_get_embedding_levels (const char* text /*none*/, gint length, ::PangoDirection* pbase_dir);
...
// void pango_shape (const char* text /*none*/, int length, const PangoAnalysis* analysis /*none*/, PangoGlyphString* glyphs /*none,out,ca*/);
// void pango_shape (const char* text /*none*/, gint length, const ::PangoAnalysis* analysis /*none*/, ::PangoGlyphString* glyphs /*none,out,ca*/);
void shape (const gi::cstring_v text, gint length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs) noexcept
{
  ...
  detail::allocate(glyphs);
  static_assert(sizeof(::PangoGlyphString) == sizeof(*(glyphs).gobj_()), "");
  auto analysis_to_c = gi::unwrap (analysis, gi::transfer_none);
  auto length_to_c = length;
  auto text_to_c = gi::unwrap (text, gi::transfer_none);
  call_wrap_v ((const char*) (text_to_c), (gint) (length_to_c), (const ::PangoAnalysis*) (analysis_to_c), (::PangoGlyphString*) ((::PangoGlyphString*) (glyphs).gobj_()));
}
Pango::GlyphString shape (const gi::cstring_v text, gint length, const Pango::Analysis_Ref analysis) noexcept
{
  typedef void (*call_wrap_t) (const char* text, gint length, const ::PangoAnalysis* analysis, ::PangoGlyphString* glyphs);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape;
  Pango::GlyphString glyphs_c;
  auto glyphs = &glyphs_c;
  detail::allocate(*glyphs);
  static_assert(sizeof(::PangoGlyphString) == sizeof(*(*glyphs).gobj_()), "");
  auto analysis_to_c = gi::unwrap (analysis, gi::transfer_none);
  auto length_to_c = length;
  auto text_to_c = gi::unwrap (text, gi::transfer_none);
  call_wrap_v ((const char*) (text_to_c), (gint) (length_to_c), (const ::PangoAnalysis*) (analysis_to_c), (::PangoGlyphString*) (glyphs ? (::PangoGlyphString*) (*glyphs).gobj_() : nullptr));
  return glyphs_c;
}

// void pango_shape_full (const char* item_text /*none*/, int item_length, const char* paragraph_text /*none,nullable*/, int paragraph_length, const PangoAnalysis* analysis /*none*/, PangoGlyphString* glyphs /*none,out,ca*/);
// void pango_shape_full (const char* item_text /*none*/, gint item_length, const char* paragraph_text /*none,nullable*/, gint paragraph_length, const ::PangoAnalysis* analysis /*none*/, ::PangoGlyphString* glyphs /*none,out,ca*/);
void shape_full (const gi::cstring_v item_text, gint item_length, const gi::cstring_v paragraph_text, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs) noexcept
{
  ...
  call_wrap_v ((const char*) (item_text_to_c), (gint) (item_length_to_c), (const char*) (paragraph_text_to_c), (gint) (paragraph_length_to_c), (const ::PangoAnalysis*) (analysis_to_c), (::PangoGlyphString*) ((::PangoGlyphString*) (glyphs).gobj_()));
}
void shape_full (const gi::cstring_v item_text, gint item_length, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs) noexcept
{
  typedef void (*call_wrap_t) (const char* item_text, gint item_length, const char* paragraph_text, gint paragraph_length, const ::PangoAnalysis* analysis, ::PangoGlyphString* glyphs);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_full;
  detail::allocate(glyphs);
...
Pango::GlyphString shape_full (const gi::cstring_v item_text, gint item_length, const gi::cstring_v paragraph_text, gint paragraph_length, const Pango::Analysis_Ref analysis) noexcept
{
  typedef void (*call_wrap_t) (const char* item_text, gint item_length, const char* paragraph_text, gint paragraph_length, const ::PangoAnalysis* analysis, ::PangoGlyphString* glyphs);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_full;
  Pango::GlyphString glyphs_c;
  ...
  auto item_length_to_c = item_length;
  auto item_text_to_c = gi::unwrap (item_text, gi::transfer_none);
  call_wrap_v ((const char*) (item_text_to_c), (gint) (item_length_to_c), (const char*) (paragraph_text_to_c), (gint) (paragraph_length_to_c), (const ::PangoAnalysis*) (analysis_to_c), (::PangoGlyphString*) (glyphs ? (::PangoGlyphString*) (*glyphs).gobj_() : nullptr));
  return glyphs_c;
}
Pango::GlyphString shape_full (const gi::cstring_v item_text, gint item_length, gint paragraph_length, const Pango::Analysis_Ref analysis) noexcept
{
  typedef void (*call_wrap_t) (const char* item_text, gint item_length, const char* paragraph_text, gint paragraph_length, const ::PangoAnalysis* analysis, ::PangoGlyphString* glyphs);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_full;
  Pango::GlyphString glyphs_c;
...
// void pango_shape_item (PangoItem* item /*none*/, const char* paragraph_text /*none,nullable*/, int paragraph_length, PangoLogAttr* log_attrs /*none,nullable*/, PangoGlyphString* glyphs /*none,out,ca*/, PangoShapeFlags flags);
// void pango_shape_item (::PangoItem* item /*none*/, const char* paragraph_text /*none,nullable*/, gint paragraph_length, ::PangoLogAttr* log_attrs /*none,nullable*/, ::PangoGlyphString* glyphs /*none,out,ca*/, ::PangoShapeFlags flags);
void shape_item (Pango::Item_Ref item, const gi::cstring_v paragraph_text, gint paragraph_length, Pango::LogAttr_Ref log_attrs, Pango::GlyphString & glyphs, Pango::ShapeFlags flags) noexcept
{
  ...
  call_wrap_v ((::PangoItem*) (item_to_c), (const char*) (paragraph_text_to_c), (gint) (paragraph_length_to_c), (::PangoLogAttr*) (log_attrs_to_c), (::PangoGlyphString*) ((::PangoGlyphString*) (glyphs).gobj_()), (::PangoShapeFlags) (flags_to_c));
}
void shape_item (Pango::Item_Ref item, gint paragraph_length, Pango::GlyphString & glyphs, Pango::ShapeFlags flags) noexcept
{
  typedef void (*call_wrap_t) (::PangoItem* item, const char* paragraph_text, gint paragraph_length, ::PangoLogAttr* log_attrs, ::PangoGlyphString* glyphs, ::PangoShapeFlags flags);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_item;
  auto flags_to_c = gi::unwrap (flags);
...
Pango::GlyphString shape_item (Pango::Item_Ref item, const gi::cstring_v paragraph_text, gint paragraph_length, Pango::LogAttr_Ref log_attrs, Pango::ShapeFlags flags) noexcept
{
  typedef void (*call_wrap_t) (::PangoItem* item, const char* paragraph_text, gint paragraph_length, ::PangoLogAttr* log_attrs, ::PangoGlyphString* glyphs, ::PangoShapeFlags flags);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_item;
  auto flags_to_c = gi::unwrap (flags);
  ...
  auto paragraph_text_to_c = gi::unwrap (paragraph_text, gi::transfer_none);
  auto item_to_c = gi::unwrap (item, gi::transfer_none);
  call_wrap_v ((::PangoItem*) (item_to_c), (const char*) (paragraph_text_to_c), (gint) (paragraph_length_to_c), (::PangoLogAttr*) (log_attrs_to_c), (::PangoGlyphString*) (glyphs ? (::PangoGlyphString*) (*glyphs).gobj_() : nullptr), (::PangoShapeFlags) (flags_to_c));
  return glyphs_c;
}
Pango::GlyphString shape_item (Pango::Item_Ref item, gint paragraph_length, Pango::ShapeFlags flags) noexcept
{
  typedef void (*call_wrap_t) (::PangoItem* item, const char* paragraph_text, gint paragraph_length, ::PangoLogAttr* log_attrs, ::PangoGlyphString* glyphs, ::PangoShapeFlags flags);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_item;
  auto flags_to_c = gi::unwrap (flags);
...
// void pango_shape_with_flags (const char* item_text /*none*/, int item_length, const char* paragraph_text /*none,nullable*/, int paragraph_length, const PangoAnalysis* analysis /*none*/, PangoGlyphString* glyphs /*none,out,ca*/, PangoShapeFlags flags);
// void pango_shape_with_flags (const char* item_text /*none*/, gint item_length, const char* paragraph_text /*none,nullable*/, gint paragraph_length, const ::PangoAnalysis* analysis /*none*/, ::PangoGlyphString* glyphs /*none,out,ca*/, ::PangoShapeFlags flags);
void shape_with_flags (const gi::cstring_v item_text, gint item_length, const gi::cstring_v paragraph_text, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs, Pango::ShapeFlags flags) noexcept
{
  ...
  auto item_length_to_c = item_length;
  auto item_text_to_c = gi::unwrap (item_text, gi::transfer_none);
  call_wrap_v ((const char*) (item_text_to_c), (gint) (item_length_to_c), (const char*) (paragraph_text_to_c), (gint) (paragraph_length_to_c), (const ::PangoAnalysis*) (analysis_to_c), (::PangoGlyphString*) ((::PangoGlyphString*) (glyphs).gobj_()), (::PangoShapeFlags) (flags_to_c));
}
void shape_with_flags (const gi::cstring_v item_text, gint item_length, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::GlyphString & glyphs, Pango::ShapeFlags flags) noexcept
{
  typedef void (*call_wrap_t) (const char* item_text, gint item_length, const char* paragraph_text, gint paragraph_length, const ::PangoAnalysis* analysis, ::PangoGlyphString* glyphs, ::PangoShapeFlags flags);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_with_flags;
  auto flags_to_c = gi::unwrap (flags);
...
Pango::GlyphString shape_with_flags (const gi::cstring_v item_text, gint item_length, const gi::cstring_v paragraph_text, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::ShapeFlags flags) noexcept
{
  typedef void (*call_wrap_t) (const char* item_text, gint item_length, const char* paragraph_text, gint paragraph_length, const ::PangoAnalysis* analysis, ::PangoGlyphString* glyphs, ::PangoShapeFlags flags);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_with_flags;
  auto flags_to_c = gi::unwrap (flags);
  ...
  auto item_length_to_c = item_length;
  auto item_text_to_c = gi::unwrap (item_text, gi::transfer_none);
  call_wrap_v ((const char*) (item_text_to_c), (gint) (item_length_to_c), (const char*) (paragraph_text_to_c), (gint) (paragraph_length_to_c), (const ::PangoAnalysis*) (analysis_to_c), (::PangoGlyphString*) (glyphs ? (::PangoGlyphString*) (*glyphs).gobj_() : nullptr), (::PangoShapeFlags) (flags_to_c));
  return glyphs_c;
}
Pango::GlyphString shape_with_flags (const gi::cstring_v item_text, gint item_length, gint paragraph_length, const Pango::Analysis_Ref analysis, Pango::ShapeFlags flags) noexcept
{
  typedef void (*call_wrap_t) (const char* item_text, gint item_length, const char* paragraph_text, gint paragraph_length, const ::PangoAnalysis* analysis, ::PangoGlyphString* glyphs, ::PangoShapeFlags flags);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_shape_with_flags;
  auto flags_to_c = gi::unwrap (flags);
...
// void pango_tailor_break (const char* text /*none*/, int length, PangoAnalysis* analysis /*none*/, int offset, PangoLogAttr* attrs /*none,out,ca*/, int attrs_len);
// void pango_tailor_break (const char* text /*none*/, gint length, ::PangoAnalysis* analysis /*none*/, gint offset, ::PangoLogAttr** attrs /*none,out,ca*/, gint attrs_len);
// SKIP; attrs out boxed array not supported (depth 1)
