...
GI_MODULE_STATIC_OR_INLINE gdouble _field_value_get (const ::PangoAttrFloat* obj) { return (gdouble) obj->value; }
...
GI_MODULE_STATIC_OR_INLINE void _field_value_set (::PangoAttrFloat* obj, gdouble _value) { obj->value = (decltype(obj->value)) _value; }
