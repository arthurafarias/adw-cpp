...
// PangoFontColor pango_font_description_get_color (const PangoFontDescription* desc /*none*/);
// ::PangoFontColor pango_font_description_get_color (const ::PangoFontDescription* desc /*none*/);
Pango::FontColor base::FontDescriptionBase::get_color () const noexcept
{
  typedef ::PangoFontColor (*call_wrap_t) (const ::PangoFontDescription* desc);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_description_get_color;
  auto _temp_ret = call_wrap_v ((const ::PangoFontDescription*) (gobj_()));
...
// const char* /*none,nullable*/ pango_font_description_get_features (const PangoFontDescription* desc /*none*/);
// const char* /*none,nullable*/ pango_font_description_get_features (const ::PangoFontDescription* desc /*none*/);
gi::cstring_v base::FontDescriptionBase::get_features () const noexcept
{
  typedef const char* (*call_wrap_t) (const ::PangoFontDescription* desc);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_description_get_features;
  auto _temp_ret = call_wrap_v ((const ::PangoFontDescription*) (gobj_()));
  return gi::wrap (_temp_ret, gi::transfer_none);
}
...
// void pango_font_description_set_color (PangoFontDescription* desc /*none*/, PangoFontColor color);
// void pango_font_description_set_color (::PangoFontDescription* desc /*none*/, ::PangoFontColor color);
void base::FontDescriptionBase::set_color (Pango::FontColor color) noexcept
{
  typedef void (*call_wrap_t) (::PangoFontDescription* desc, ::PangoFontColor color);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_description_set_color;
  auto color_to_c = gi::unwrap (color);
  call_wrap_v ((::PangoFontDescription*) (gobj_()), (::PangoFontColor) (color_to_c));
}
...
// void pango_font_description_set_features (PangoFontDescription* desc /*none*/, const char* features /*none,nullable*/);
// void pango_font_description_set_features (::PangoFontDescription* desc /*none*/, const char* features /*none,nullable*/);
void base::FontDescriptionBase::set_features (const gi::cstring_v features) noexcept
{
  typedef void (*call_wrap_t) (::PangoFontDescription* desc, const char* features);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_description_set_features;
  auto features_to_c = gi::unwrap (features, gi::transfer_none);
  call_wrap_v ((::PangoFontDescription*) (gobj_()), (const char*) (features_to_c));
}
void base::FontDescriptionBase::set_features () noexcept
{
  typedef void (*call_wrap_t) (::PangoFontDescription* desc, const char* features);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_description_set_features;
...
// void pango_font_description_set_features_static (PangoFontDescription* desc /*none*/, const char* features /*none*/);
// void pango_font_description_set_features_static (::PangoFontDescription* desc /*none*/, const char* features /*none*/);
void base::FontDescriptionBase::set_features_static (const gi::cstring_v features) noexcept
{
  typedef void (*call_wrap_t) (::PangoFontDescription* desc, const char* features);
  call_wrap_t call_wrap_v = (call_wrap_t) ::pango_font_description_set_features_static;
  auto features_to_c = gi::unwrap (features, gi::transfer_none);
  call_wrap_v ((::PangoFontDescription*) (gobj_()), (const char*) (features_to_c));
}
