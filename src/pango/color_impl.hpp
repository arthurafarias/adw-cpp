...
GI_MODULE_STATIC_OR_INLINE guint16 _field_red_get (const ::PangoColor* obj) { return (guint16) obj->red; }
...
GI_MODULE_STATIC_OR_INLINE void _field_red_set (::PangoColor* obj, guint16 _value) { obj->red = (decltype(obj->red)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint16 _field_green_get (const ::PangoColor* obj) { return (guint16) obj->green; }
...
GI_MODULE_STATIC_OR_INLINE void _field_green_set (::PangoColor* obj, guint16 _value) { obj->green = (decltype(obj->green)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint16 _field_blue_get (const ::PangoColor* obj) { return (guint16) obj->blue; }
...
GI_MODULE_STATIC_OR_INLINE void _field_blue_set (::PangoColor* obj, guint16 _value) { obj->blue = (decltype(obj->blue)) _value; }
