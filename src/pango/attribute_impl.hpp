...
GI_MODULE_STATIC_OR_INLINE const ::PangoAttrClass* _field_klass_get (const ::PangoAttribute* obj) { return (const ::PangoAttrClass*) obj->klass; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_start_index_get (const ::PangoAttribute* obj) { return (guint) obj->start_index; }
...
GI_MODULE_STATIC_OR_INLINE void _field_start_index_set (::PangoAttribute* obj, guint _value) { obj->start_index = (decltype(obj->start_index)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_end_index_get (const ::PangoAttribute* obj) { return (guint) obj->end_index; }
...
GI_MODULE_STATIC_OR_INLINE void _field_end_index_set (::PangoAttribute* obj, guint _value) { obj->end_index = (decltype(obj->end_index)) _value; }
