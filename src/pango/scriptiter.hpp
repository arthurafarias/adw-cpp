...
// void pango_script_iter_get_range (::PangoScriptIter* iter /*none*/, const char** start /*none,out,opt*/, const char** end /*none,out,opt*/, ::PangoScript* script);
GI_INLINE_DECL void get_range (gi::cstring_v * start, gi::cstring_v * end, Pango::Script * script) noexcept;
GI_INLINE_DECL std::tuple<gi::cstring_v, gi::cstring_v, Pango::Script> get_range () noexcept;
