...
GI_MODULE_STATIC_OR_INLINE gfloat _field_x_get (const ::graphene_point_t* obj) { return (gfloat) obj->x; }
...
GI_MODULE_STATIC_OR_INLINE void _field_x_set (::graphene_point_t* obj, gfloat _value) { obj->x = (decltype(obj->x)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gfloat _field_y_get (const ::graphene_point_t* obj) { return (gfloat) obj->y; }
...
GI_MODULE_STATIC_OR_INLINE void _field_y_set (::graphene_point_t* obj, gfloat _value) { obj->y = (decltype(obj->y)) _value; }
