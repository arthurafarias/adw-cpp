...
GI_MODULE_STATIC_OR_INLINE gfloat _field_width_get (const ::graphene_size_t* obj) { return (gfloat) obj->width; }
...
GI_MODULE_STATIC_OR_INLINE void _field_width_set (::graphene_size_t* obj, gfloat _value) { obj->width = (decltype(obj->width)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gfloat _field_height_get (const ::graphene_size_t* obj) { return (gfloat) obj->height; }
...
GI_MODULE_STATIC_OR_INLINE void _field_height_set (::graphene_size_t* obj, gfloat _value) { obj->height = (decltype(obj->height)) _value; }
