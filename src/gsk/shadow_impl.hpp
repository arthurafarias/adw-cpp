...
GI_MODULE_STATIC_OR_INLINE gfloat _field_dx_get (const ::GskShadow* obj) { return (gfloat) obj->dx; }
...
GI_MODULE_STATIC_OR_INLINE void _field_dx_set (::GskShadow* obj, gfloat _value) { obj->dx = (decltype(obj->dx)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gfloat _field_dy_get (const ::GskShadow* obj) { return (gfloat) obj->dy; }
...
GI_MODULE_STATIC_OR_INLINE void _field_dy_set (::GskShadow* obj, gfloat _value) { obj->dy = (decltype(obj->dy)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gfloat _field_radius_get (const ::GskShadow* obj) { return (gfloat) obj->radius; }
...
GI_MODULE_STATIC_OR_INLINE void _field_radius_set (::GskShadow* obj, gfloat _value) { obj->radius = (decltype(obj->radius)) _value; }
