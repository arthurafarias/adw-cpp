...
GI_MODULE_STATIC_OR_INLINE gfloat _field_offset_get (const ::GskColorStop* obj) { return (gfloat) obj->offset; }
...
GI_MODULE_STATIC_OR_INLINE void _field_offset_set (::GskColorStop* obj, gfloat _value) { obj->offset = (decltype(obj->offset)) _value; }
