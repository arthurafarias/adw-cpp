...
GI_MODULE_STATIC_OR_INLINE gsize _field_bytes_get (const ::GskParseLocation* obj) { return (gsize) obj->bytes; }
...
GI_MODULE_STATIC_OR_INLINE void _field_bytes_set (::GskParseLocation* obj, gsize _value) { obj->bytes = (decltype(obj->bytes)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gsize _field_chars_get (const ::GskParseLocation* obj) { return (gsize) obj->chars; }
...
GI_MODULE_STATIC_OR_INLINE void _field_chars_set (::GskParseLocation* obj, gsize _value) { obj->chars = (decltype(obj->chars)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gsize _field_lines_get (const ::GskParseLocation* obj) { return (gsize) obj->lines; }
...
GI_MODULE_STATIC_OR_INLINE void _field_lines_set (::GskParseLocation* obj, gsize _value) { obj->lines = (decltype(obj->lines)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gsize _field_line_bytes_get (const ::GskParseLocation* obj) { return (gsize) obj->line_bytes; }
...
GI_MODULE_STATIC_OR_INLINE void _field_line_bytes_set (::GskParseLocation* obj, gsize _value) { obj->line_bytes = (decltype(obj->line_bytes)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gsize _field_line_chars_get (const ::GskParseLocation* obj) { return (gsize) obj->line_chars; }
...
GI_MODULE_STATIC_OR_INLINE void _field_line_chars_set (::GskParseLocation* obj, gsize _value) { obj->line_chars = (decltype(obj->line_chars)) _value; }
