...
// GskTransform* /*full,nullable*/ gsk_transform_matrix_2d (GskTransform* next /*full,nullable*/, float xx, float yx, float xy, float yy, float dx, float dy);
// ::GskTransform* /*full,nullable*/ gsk_transform_matrix_2d (::GskTransform* next /*full,nullable*/, gfloat xx, gfloat yx, gfloat xy, gfloat yy, gfloat dx, gfloat dy);
Gsk::Transform base::TransformBase::matrix_2d (gfloat xx, gfloat yx, gfloat xy, gfloat yy, gfloat dx, gfloat dy) noexcept
{
  typedef ::GskTransform* (*call_wrap_t) (::GskTransform* next, gfloat xx, gfloat yx, gfloat xy, gfloat yy, gfloat dx, gfloat dy);
  call_wrap_t call_wrap_v = (call_wrap_t) ::gsk_transform_matrix_2d;
  auto dy_to_c = dy;
  auto dx_to_c = dx;
  auto yy_to_c = yy;
  auto xy_to_c = xy;
  auto yx_to_c = yx;
  auto xx_to_c = xx;
  auto _temp_ret = call_wrap_v ((::GskTransform*) (gobj_()), (gfloat) (xx_to_c), (gfloat) (yx_to_c), (gfloat) (xy_to_c), (gfloat) (yy_to_c), (gfloat) (dx_to_c), (gfloat) (dy_to_c));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
