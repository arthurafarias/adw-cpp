...
GI_MODULE_STATIC_OR_INLINE gint _field_fd_get (const ::GPollFD* obj) { return (gint) obj->fd; }
...
GI_MODULE_STATIC_OR_INLINE void _field_fd_set (::GPollFD* obj, gint _value) { obj->fd = (decltype(obj->fd)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gushort _field_events_get (const ::GPollFD* obj) { return (gushort) obj->events; }
...
GI_MODULE_STATIC_OR_INLINE void _field_events_set (::GPollFD* obj, gushort _value) { obj->events = (decltype(obj->events)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gushort _field_revents_get (const ::GPollFD* obj) { return (gushort) obj->revents; }
...
GI_MODULE_STATIC_OR_INLINE void _field_revents_set (::GPollFD* obj, gushort _value) { obj->revents = (decltype(obj->revents)) _value; }
