...
GI_MODULE_STATIC_OR_INLINE ::GHook* _field_next_get (const ::GHook* obj) { return (::GHook*) obj->next; }
...
GI_MODULE_STATIC_OR_INLINE ::GHook* _field_prev_get (const ::GHook* obj) { return (::GHook*) obj->prev; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_ref_count_get (const ::GHook* obj) { return (guint) obj->ref_count; }
...
GI_MODULE_STATIC_OR_INLINE void _field_ref_count_set (::GHook* obj, guint _value) { obj->ref_count = (decltype(obj->ref_count)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gulong _field_hook_id_get (const ::GHook* obj) { return (gulong) obj->hook_id; }
...
GI_MODULE_STATIC_OR_INLINE void _field_hook_id_set (::GHook* obj, gulong _value) { obj->hook_id = (decltype(obj->hook_id)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_flags_get (const ::GHook* obj) { return (guint) obj->flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_flags_set (::GHook* obj, guint _value) { obj->flags = (decltype(obj->flags)) _value; }
...
// GHook* /*full*/ g_hook_ref (GHookList* hook_list /*none*/, GHook* hook /*none*/);
// ::GHook* /*full*/ g_hook_ref (::GHookList* hook_list /*none*/, ::GHook* hook /*none*/);
// IGNORE; marked ignore
