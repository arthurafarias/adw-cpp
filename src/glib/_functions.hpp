...
GI_INLINE_DECL gint atomic_int_add (void* atomic, gint val) noexcept;

// guint g_atomic_int_and (volatile guint* atomic, guint val);
// guint g_atomic_int_and (void* atomic, guint val);
GI_INLINE_DECL guint atomic_int_and (void* atomic, guint val) noexcept;
...
GI_INLINE_DECL bool atomic_int_compare_and_exchange (void* atomic, gint oldval, gint newval) noexcept;
...
GI_INLINE_DECL bool atomic_int_compare_and_exchange_full (void* atomic, gint oldval, gint newval, gint & preval) noexcept;
GI_INLINE_DECL std::tuple<bool, gint> atomic_int_compare_and_exchange_full (void* atomic, gint oldval, gint newval) noexcept;

// gboolean g_atomic_int_dec_and_test (volatile gint* atomic);
// gboolean g_atomic_int_dec_and_test (void* atomic);
GI_INLINE_DECL bool atomic_int_dec_and_test (void* atomic) noexcept;

// gint g_atomic_int_exchange (gint* atomic, gint newval);
// gint g_atomic_int_exchange (void* atomic, gint newval);
GI_INLINE_DECL gint atomic_int_exchange (void* atomic, gint newval) noexcept;

// gint g_atomic_int_get (volatile const gint* atomic);
// gint g_atomic_int_get (const void* atomic);
GI_INLINE_DECL gint atomic_int_get (const void* atomic) noexcept;

// void g_atomic_int_inc (volatile gint* atomic);
// void g_atomic_int_inc (void* atomic);
GI_INLINE_DECL void atomic_int_inc (void* atomic) noexcept;

// guint g_atomic_int_or (volatile guint* atomic, guint val);
// guint g_atomic_int_or (void* atomic, guint val);
GI_INLINE_DECL guint atomic_int_or (void* atomic, guint val) noexcept;

// void g_atomic_int_set (volatile gint* atomic, gint newval);
// void g_atomic_int_set (void* atomic, gint newval);
GI_INLINE_DECL void atomic_int_set (void* atomic, gint newval) noexcept;

// guint g_atomic_int_xor (volatile guint* atomic, guint val);
// guint g_atomic_int_xor (void* atomic, guint val);
GI_INLINE_DECL guint atomic_int_xor (void* atomic, guint val) noexcept;
...
GI_INLINE_DECL void atomic_ref_count_init (gint & arc) noexcept;
GI_INLINE_DECL gint atomic_ref_count_init () noexcept;
...
GI_INLINE_DECL void bit_lock (void* address, gint lock_bit) noexcept;
...
GI_INLINE_DECL void bit_lock_and_get (void* address, guint lock_bit, gint * out_val) noexcept;
GI_INLINE_DECL gint bit_lock_and_get (void* address, guint lock_bit) noexcept;
...
GI_INLINE_DECL bool bit_trylock (void* address, gint lock_bit) noexcept;

// void g_bit_unlock (volatile gint* address, gint lock_bit);
// void g_bit_unlock (void* address, gint lock_bit);
GI_INLINE_DECL void bit_unlock (void* address, gint lock_bit) noexcept;
...
GI_INLINE_DECL void bit_unlock_and_set (void* address, guint lock_bit, gint new_val, gint preserve_mask) noexcept;
...
GI_INLINE_DECL guint64 get_monotonic_time_ns () noexcept;
...
// ::GLogLevelFlags g_log_get_always_fatal ();
GI_INLINE_DECL GLib::LogLevelFlags log_get_always_fatal () noexcept;
...
GI_INLINE_DECL void on_error_stack_trace () noexcept;
...
GI_INLINE_DECL void pointer_bit_lock_and_get (void* address, guint lock_bit, guintptr * out_ptr) noexcept;
GI_INLINE_DECL guintptr pointer_bit_lock_and_get (void* address, guint lock_bit) noexcept;
...
GI_INLINE_DECL gpointer pointer_bit_lock_mask_ptr (void* ptr, guint lock_bit, gboolean set, guintptr preserve_mask, void* preserve_ptr) noexcept;
...
GI_INLINE_DECL void pointer_bit_unlock_and_set (void* address, guint lock_bit, void* ptr, guintptr preserve_mask) noexcept;
...
GI_INLINE_DECL bool ref_count_dec (gint & rc) noexcept;

// void g_ref_count_inc (grefcount* rc);
// void g_ref_count_inc (gint* rc);
GI_INLINE_DECL void ref_count_inc (gint & rc) noexcept;

// void g_ref_count_init (grefcount* rc);
// void g_ref_count_init (gint* rc);
GI_INLINE_DECL void ref_count_init (gint & rc) noexcept;
GI_INLINE_DECL gint ref_count_init () noexcept;
...
// gboolean g_ref_string_equal (const char* str1 /*none*/, const char* str2 /*none*/);
GI_INLINE_DECL bool ref_string_equal (const gi::cstring_v str1, const gi::cstring_v str2) noexcept;
...
GI_INLINE_DECL gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> strdupv (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> str_array) noexcept;
...
GI_INLINE_DECL void strfreev (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_full_t> str_array) noexcept;
...
GI_INLINE_DECL gi::cstring strjoinv (const gi::cstring_v separator, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> str_array) noexcept;
GI_INLINE_DECL gi::cstring strjoinv (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> str_array) noexcept;
...
GI_INLINE_DECL gi::cstring strndup (gsize n) noexcept;
...
GI_INLINE_DECL gi::cstring_v strrstr (const gi::cstring_v haystack, const gi::cstring_v needle) noexcept;
...
GI_INLINE_DECL gi::cstring_v strrstr_len (const gi::cstring_v haystack, gssize haystack_len, const gi::cstring_v needle) noexcept;
...
GI_INLINE_DECL gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> strsplit_set (const gi::cstring_v string, gi::CollectionParameter<gi::ZTSpan, guint8, gi::transfer_none_t> delimiters, gint max_tokens) noexcept;
...
GI_INLINE_DECL gi::cstring_v strstr_len (const gi::cstring_v haystack, gssize haystack_len, const gi::cstring_v needle) noexcept;
...
GI_INLINE_DECL bool strv_equal (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> strv1, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> strv2) noexcept;
...
GI_INLINE_DECL guint strv_length (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> str_array) noexcept;
...
GI_INLINE_DECL void test_queue_destroy (GLib::DestroyNotify destroy_func) noexcept;
...
// gboolean g_test_trap_has_skipped ();
GI_INLINE_DECL bool test_trap_has_skipped () noexcept;
...
GI_INLINE_DECL bool utf8_validate (const guint8 * str, gssize max_len, gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t> * end) noexcept;
GI_INLINE_DECL std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t>> utf8_validate (const guint8 * str, gssize max_len) noexcept;
...
GI_INLINE_DECL bool utf8_validate_len (const guint8 * str, gsize max_len, gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t> * end) noexcept;
GI_INLINE_DECL std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t>> utf8_validate_len (const guint8 * str, gsize max_len) noexcept;
