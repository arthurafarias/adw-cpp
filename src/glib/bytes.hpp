...
// ::GBytes* /*full*/ g_bytes_new_from_bytes (::GBytes* bytes /*none*/, gsize offset, gsize length);
static GI_INLINE_DECL GLib::Bytes new_from_bytes (GLib::Bytes_Ref bytes, gsize offset, gsize length) noexcept;
...
static GI_INLINE_DECL GLib::Bytes new_with_free_func (const guint8 * data, gsize size, GLib::DestroyNotify free_func) noexcept;
