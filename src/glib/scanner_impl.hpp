...
GI_MODULE_STATIC_OR_INLINE guint _field_max_parse_errors_get (const ::GScanner* obj) { return (guint) obj->max_parse_errors; }
...
GI_MODULE_STATIC_OR_INLINE void _field_max_parse_errors_set (::GScanner* obj, guint _value) { obj->max_parse_errors = (decltype(obj->max_parse_errors)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_parse_errors_get (const ::GScanner* obj) { return (guint) obj->parse_errors; }
...
GI_MODULE_STATIC_OR_INLINE void _field_parse_errors_set (::GScanner* obj, guint _value) { obj->parse_errors = (decltype(obj->parse_errors)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_input_name_get (const ::GScanner* obj) { return (const char*) obj->input_name; }
...
GI_MODULE_STATIC_OR_INLINE ::GScannerConfig* _field_config_get (const ::GScanner* obj) { return (::GScannerConfig*) obj->config; }
...
GI_MODULE_STATIC_OR_INLINE ::GTokenType _field_token_get (const ::GScanner* obj) { return (::GTokenType) obj->token; }
...
GI_MODULE_STATIC_OR_INLINE void _field_token_set (::GScanner* obj, ::GTokenType _value) { obj->token = (decltype(obj->token)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_line_get (const ::GScanner* obj) { return (guint) obj->line; }
...
GI_MODULE_STATIC_OR_INLINE void _field_line_set (::GScanner* obj, guint _value) { obj->line = (decltype(obj->line)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_position_get (const ::GScanner* obj) { return (guint) obj->position; }
...
GI_MODULE_STATIC_OR_INLINE void _field_position_set (::GScanner* obj, guint _value) { obj->position = (decltype(obj->position)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::GTokenType _field_next_token_get (const ::GScanner* obj) { return (::GTokenType) obj->next_token; }
...
GI_MODULE_STATIC_OR_INLINE void _field_next_token_set (::GScanner* obj, ::GTokenType _value) { obj->next_token = (decltype(obj->next_token)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_next_line_get (const ::GScanner* obj) { return (guint) obj->next_line; }
...
GI_MODULE_STATIC_OR_INLINE void _field_next_line_set (::GScanner* obj, guint _value) { obj->next_line = (decltype(obj->next_line)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_next_position_get (const ::GScanner* obj) { return (guint) obj->next_position; }
...
GI_MODULE_STATIC_OR_INLINE void _field_next_position_set (::GScanner* obj, guint _value) { obj->next_position = (decltype(obj->next_position)) _value; }
