...
// gsize g_markup_parse_context_get_offset (GMarkupParseContext* context /*none*/);
// gsize g_markup_parse_context_get_offset (::GMarkupParseContext* context /*none*/);
gsize base::MarkupParseContextBase::get_offset () noexcept
{
  typedef gsize (*call_wrap_t) (::GMarkupParseContext* context);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_markup_parse_context_get_offset;
  auto _temp_ret = call_wrap_v ((::GMarkupParseContext*) (gobj_()));
  return _temp_ret;
}
...
// void g_markup_parse_context_get_tag_start (GMarkupParseContext* context /*none*/, gsize* line_number, gsize* char_number, gsize* offset);
// void g_markup_parse_context_get_tag_start (::GMarkupParseContext* context /*none*/, gsize* line_number, gsize* char_number, gsize* offset);
void base::MarkupParseContextBase::get_tag_start (gsize & line_number, gsize & char_number, gsize & offset) noexcept
{
  typedef void (*call_wrap_t) (::GMarkupParseContext* context, gsize* line_number, gsize* char_number, gsize* offset);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_markup_parse_context_get_tag_start;
  gsize offset_o {};
  gsize char_number_o {};
  gsize line_number_o {};
  call_wrap_v ((::GMarkupParseContext*) (gobj_()), (gsize*) (&line_number_o), (gsize*) (&char_number_o), (gsize*) (&offset_o));
  offset = offset_o;
  char_number = char_number_o;
  line_number = line_number_o;
}
std::tuple<gsize, gsize, gsize> base::MarkupParseContextBase::get_tag_start () noexcept
{
  typedef void (*call_wrap_t) (::GMarkupParseContext* context, gsize* line_number, gsize* char_number, gsize* offset);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_markup_parse_context_get_tag_start;
  gsize offset_o {};
