...
GI_MODULE_STATIC_OR_INLINE const char* _field_key_get (const ::GLogField* obj) { return (const char*) obj->key; }
...
GI_MODULE_STATIC_OR_INLINE gssize _field_length_get (const ::GLogField* obj) { return (gssize) obj->length; }
...
GI_MODULE_STATIC_OR_INLINE void _field_length_set (::GLogField* obj, gssize _value) { obj->length = (decltype(obj->length)) _value; }
