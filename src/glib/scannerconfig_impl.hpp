...
GI_MODULE_STATIC_OR_INLINE char* _field_cset_skip_characters_get (const ::GScannerConfig* obj) { return (char*) obj->cset_skip_characters; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_cset_identifier_first_get (const ::GScannerConfig* obj) { return (char*) obj->cset_identifier_first; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_cset_identifier_nth_get (const ::GScannerConfig* obj) { return (char*) obj->cset_identifier_nth; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_cpair_comment_single_get (const ::GScannerConfig* obj) { return (char*) obj->cpair_comment_single; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_case_sensitive_get (const ::GScannerConfig* obj) { return (guint) obj->case_sensitive; }
...
GI_MODULE_STATIC_OR_INLINE void _field_case_sensitive_set (::GScannerConfig* obj, guint _value) { obj->case_sensitive = (decltype(obj->case_sensitive)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_skip_comment_multi_get (const ::GScannerConfig* obj) { return (guint) obj->skip_comment_multi; }
...
GI_MODULE_STATIC_OR_INLINE void _field_skip_comment_multi_set (::GScannerConfig* obj, guint _value) { obj->skip_comment_multi = (decltype(obj->skip_comment_multi)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_skip_comment_single_get (const ::GScannerConfig* obj) { return (guint) obj->skip_comment_single; }
...
GI_MODULE_STATIC_OR_INLINE void _field_skip_comment_single_set (::GScannerConfig* obj, guint _value) { obj->skip_comment_single = (decltype(obj->skip_comment_single)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_comment_multi_get (const ::GScannerConfig* obj) { return (guint) obj->scan_comment_multi; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_comment_multi_set (::GScannerConfig* obj, guint _value) { obj->scan_comment_multi = (decltype(obj->scan_comment_multi)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_identifier_get (const ::GScannerConfig* obj) { return (guint) obj->scan_identifier; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_identifier_set (::GScannerConfig* obj, guint _value) { obj->scan_identifier = (decltype(obj->scan_identifier)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_identifier_1char_get (const ::GScannerConfig* obj) { return (guint) obj->scan_identifier_1char; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_identifier_1char_set (::GScannerConfig* obj, guint _value) { obj->scan_identifier_1char = (decltype(obj->scan_identifier_1char)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_identifier_NULL_get (const ::GScannerConfig* obj) { return (guint) obj->scan_identifier_NULL; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_identifier_NULL_set (::GScannerConfig* obj, guint _value) { obj->scan_identifier_NULL = (decltype(obj->scan_identifier_NULL)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_symbols_get (const ::GScannerConfig* obj) { return (guint) obj->scan_symbols; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_symbols_set (::GScannerConfig* obj, guint _value) { obj->scan_symbols = (decltype(obj->scan_symbols)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_binary_get (const ::GScannerConfig* obj) { return (guint) obj->scan_binary; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_binary_set (::GScannerConfig* obj, guint _value) { obj->scan_binary = (decltype(obj->scan_binary)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_octal_get (const ::GScannerConfig* obj) { return (guint) obj->scan_octal; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_octal_set (::GScannerConfig* obj, guint _value) { obj->scan_octal = (decltype(obj->scan_octal)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_float_get (const ::GScannerConfig* obj) { return (guint) obj->scan_float; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_float_set (::GScannerConfig* obj, guint _value) { obj->scan_float = (decltype(obj->scan_float)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_hex_get (const ::GScannerConfig* obj) { return (guint) obj->scan_hex; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_hex_set (::GScannerConfig* obj, guint _value) { obj->scan_hex = (decltype(obj->scan_hex)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_hex_dollar_get (const ::GScannerConfig* obj) { return (guint) obj->scan_hex_dollar; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_hex_dollar_set (::GScannerConfig* obj, guint _value) { obj->scan_hex_dollar = (decltype(obj->scan_hex_dollar)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_string_sq_get (const ::GScannerConfig* obj) { return (guint) obj->scan_string_sq; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_string_sq_set (::GScannerConfig* obj, guint _value) { obj->scan_string_sq = (decltype(obj->scan_string_sq)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scan_string_dq_get (const ::GScannerConfig* obj) { return (guint) obj->scan_string_dq; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scan_string_dq_set (::GScannerConfig* obj, guint _value) { obj->scan_string_dq = (decltype(obj->scan_string_dq)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_numbers_2_int_get (const ::GScannerConfig* obj) { return (guint) obj->numbers_2_int; }
...
GI_MODULE_STATIC_OR_INLINE void _field_numbers_2_int_set (::GScannerConfig* obj, guint _value) { obj->numbers_2_int = (decltype(obj->numbers_2_int)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_int_2_float_get (const ::GScannerConfig* obj) { return (guint) obj->int_2_float; }
...
GI_MODULE_STATIC_OR_INLINE void _field_int_2_float_set (::GScannerConfig* obj, guint _value) { obj->int_2_float = (decltype(obj->int_2_float)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_identifier_2_string_get (const ::GScannerConfig* obj) { return (guint) obj->identifier_2_string; }
...
GI_MODULE_STATIC_OR_INLINE void _field_identifier_2_string_set (::GScannerConfig* obj, guint _value) { obj->identifier_2_string = (decltype(obj->identifier_2_string)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_char_2_token_get (const ::GScannerConfig* obj) { return (guint) obj->char_2_token; }
...
GI_MODULE_STATIC_OR_INLINE void _field_char_2_token_set (::GScannerConfig* obj, guint _value) { obj->char_2_token = (decltype(obj->char_2_token)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_symbol_2_token_get (const ::GScannerConfig* obj) { return (guint) obj->symbol_2_token; }
...
GI_MODULE_STATIC_OR_INLINE void _field_symbol_2_token_set (::GScannerConfig* obj, guint _value) { obj->symbol_2_token = (decltype(obj->symbol_2_token)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_scope_0_fallback_get (const ::GScannerConfig* obj) { return (guint) obj->scope_0_fallback; }
...
GI_MODULE_STATIC_OR_INLINE void _field_scope_0_fallback_set (::GScannerConfig* obj, guint _value) { obj->scope_0_fallback = (decltype(obj->scope_0_fallback)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_store_int64_get (const ::GScannerConfig* obj) { return (guint) obj->store_int64; }
...
GI_MODULE_STATIC_OR_INLINE void _field_store_int64_set (::GScannerConfig* obj, guint _value) { obj->store_int64 = (decltype(obj->store_int64)) _value; }
