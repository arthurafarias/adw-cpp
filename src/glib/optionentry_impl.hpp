...
GI_MODULE_STATIC_OR_INLINE const char* _field_long_name_get (const ::GOptionEntry* obj) { return (const char*) obj->long_name; }
...
GI_MODULE_STATIC_OR_INLINE gchar _field_short_name_get (const ::GOptionEntry* obj) { return (gchar) obj->short_name; }
...
GI_MODULE_STATIC_OR_INLINE void _field_short_name_set (::GOptionEntry* obj, gchar _value) { obj->short_name = (decltype(obj->short_name)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_flags_get (const ::GOptionEntry* obj) { return (gint) obj->flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_flags_set (::GOptionEntry* obj, gint _value) { obj->flags = (decltype(obj->flags)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::GOptionArg _field_arg_get (const ::GOptionEntry* obj) { return (::GOptionArg) obj->arg; }
...
GI_MODULE_STATIC_OR_INLINE void _field_arg_set (::GOptionEntry* obj, ::GOptionArg _value) { obj->arg = (decltype(obj->arg)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_description_get (const ::GOptionEntry* obj) { return (const char*) obj->description; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_arg_description_get (const ::GOptionEntry* obj) { return (const char*) obj->arg_description; }
