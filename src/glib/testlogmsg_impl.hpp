...
GI_MODULE_STATIC_OR_INLINE ::GTestLogType _field_log_type_get (const ::GTestLogMsg* obj) { return (::GTestLogType) obj->log_type; }
...
GI_MODULE_STATIC_OR_INLINE void _field_log_type_set (::GTestLogMsg* obj, ::GTestLogType _value) { obj->log_type = (decltype(obj->log_type)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_n_strings_get (const ::GTestLogMsg* obj) { return (guint) obj->n_strings; }
...
GI_MODULE_STATIC_OR_INLINE void _field_n_strings_set (::GTestLogMsg* obj, guint _value) { obj->n_strings = (decltype(obj->n_strings)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_n_nums_get (const ::GTestLogMsg* obj) { return (guint) obj->n_nums; }
...
GI_MODULE_STATIC_OR_INLINE void _field_n_nums_set (::GTestLogMsg* obj, guint _value) { obj->n_nums = (decltype(obj->n_nums)) _value; }
