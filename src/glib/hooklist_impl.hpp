...
GI_MODULE_STATIC_OR_INLINE gulong _field_seq_id_get (const ::GHookList* obj) { return (gulong) obj->seq_id; }
...
GI_MODULE_STATIC_OR_INLINE void _field_seq_id_set (::GHookList* obj, gulong _value) { obj->seq_id = (decltype(obj->seq_id)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_hook_size_get (const ::GHookList* obj) { return (guint) obj->hook_size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_hook_size_set (::GHookList* obj, guint _value) { obj->hook_size = (decltype(obj->hook_size)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_is_setup_get (const ::GHookList* obj) { return (guint) obj->is_setup; }
...
GI_MODULE_STATIC_OR_INLINE void _field_is_setup_set (::GHookList* obj, guint _value) { obj->is_setup = (decltype(obj->is_setup)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::GHook* _field_hooks_get (const ::GHookList* obj) { return (::GHook*) obj->hooks; }
