...
// ::GByteArray* /*none*/ g_byte_array_append (::GByteArray* array /*none*/, const guint8* data /*none*/, guint len);
static GI_INLINE_DECL GLib::ByteArray_Ref append (GLib::ByteArray_Ref array, const guint8 * data, guint len) noexcept;
...
// ::GByteArray* /*none*/ g_byte_array_prepend (::GByteArray* array /*none*/, const guint8* data /*none*/, guint len);
static GI_INLINE_DECL GLib::ByteArray_Ref prepend (GLib::ByteArray_Ref array, const guint8 * data, guint len) noexcept;
...
// guint8* /*full*/ g_byte_array_steal (::GByteArray* array /*none*/, gsize* len);
static GI_INLINE_DECL gi::Collection<gi::DSpan, guint8, gi::transfer_full_t> steal (GLib::ByteArray_Ref array) noexcept;
