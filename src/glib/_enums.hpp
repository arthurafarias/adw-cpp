...
enum class UnicodeBreakType : std::underlying_type<GUnicodeBreakType>::type {
  ...
  UNAMBIGUOUS_HYPHEN_ = G_UNICODE_BREAK_UNAMBIGUOUS_HYPHEN,
};
...
enum class UnicodeScript : std::underlying_type<GUnicodeScript>::type {
  ...
  TODHRI_ = G_UNICODE_SCRIPT_TODHRI,
  GARAY_ = G_UNICODE_SCRIPT_GARAY,
  TULU_TIGALARI_ = G_UNICODE_SCRIPT_TULU_TIGALARI,
  SUNUWAR_ = G_UNICODE_SCRIPT_SUNUWAR,
  GURUNG_KHEMA_ = G_UNICODE_SCRIPT_GURUNG_KHEMA,
  KIRAT_RAI_ = G_UNICODE_SCRIPT_KIRAT_RAI,
  OL_ONAL_ = G_UNICODE_SCRIPT_OL_ONAL,
  SIDETIC_ = G_UNICODE_SCRIPT_SIDETIC,
  TOLONG_SIKI_ = G_UNICODE_SCRIPT_TOLONG_SIKI,
  TAI_YO_ = G_UNICODE_SCRIPT_TAI_YO,
  BERIA_ERFE_ = G_UNICODE_SCRIPT_BERIA_ERFE,
};
