...
GI_MODULE_STATIC_OR_INLINE ::GNode* _field_next_get (const ::GNode* obj) { return (::GNode*) obj->next; }
...
GI_MODULE_STATIC_OR_INLINE ::GNode* _field_prev_get (const ::GNode* obj) { return (::GNode*) obj->prev; }
...
GI_MODULE_STATIC_OR_INLINE ::GNode* _field_parent_get (const ::GNode* obj) { return (::GNode*) obj->parent; }
...
GI_MODULE_STATIC_OR_INLINE ::GNode* _field_children_get (const ::GNode* obj) { return (::GNode*) obj->children; }
