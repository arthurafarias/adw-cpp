...
// gint g_atomic_int_add (void* atomic, gint val);
gint atomic_int_add (void* atomic, gint val) noexcept
{
  typedef gint (*call_wrap_t) (void* atomic, gint val);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_add;
  auto val_to_c = val;
  auto atomic_to_c = atomic;
  auto _temp_ret = call_wrap_v ((void*) (atomic_to_c), (gint) (val_to_c));
  return _temp_ret;
}

// guint g_atomic_int_and (volatile guint* atomic, guint val);
// guint g_atomic_int_and (void* atomic, guint val);
guint atomic_int_and (void* atomic, guint val) noexcept
{
  typedef guint (*call_wrap_t) (void* atomic, guint val);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_and;
  auto val_to_c = val;
  auto atomic_to_c = atomic;
  auto _temp_ret = call_wrap_v ((void*) (atomic_to_c), (guint) (val_to_c));
  return _temp_ret;
}

// gboolean g_atomic_int_compare_and_exchange (volatile gint* atomic, gint oldval, gint newval);
// gboolean g_atomic_int_compare_and_exchange (void* atomic, gint oldval, gint newval);
bool atomic_int_compare_and_exchange (void* atomic, gint oldval, gint newval) noexcept
{
  typedef gboolean (*call_wrap_t) (void* atomic, gint oldval, gint newval);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_compare_and_exchange;
  auto newval_to_c = newval;
  auto oldval_to_c = oldval;
  auto atomic_to_c = atomic;
  auto _temp_ret = call_wrap_v ((void*) (atomic_to_c), (gint) (oldval_to_c), (gint) (newval_to_c));
  return _temp_ret;
}

// gboolean g_atomic_int_compare_and_exchange_full (gint* atomic, gint oldval, gint newval, gint* preval);
// gboolean g_atomic_int_compare_and_exchange_full (void* atomic, gint oldval, gint newval, gint* preval);
bool atomic_int_compare_and_exchange_full (void* atomic, gint oldval, gint newval, gint & preval) noexcept
{
  typedef gboolean (*call_wrap_t) (void* atomic, gint oldval, gint newval, gint* preval);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_compare_and_exchange_full;
  gint preval_o {};
  auto newval_to_c = newval;
  auto oldval_to_c = oldval;
  auto atomic_to_c = atomic;
  auto _temp_ret = call_wrap_v ((void*) (atomic_to_c), (gint) (oldval_to_c), (gint) (newval_to_c), (gint*) (&preval_o));
  preval = preval_o;
  return _temp_ret;
}
std::tuple<bool, gint> atomic_int_compare_and_exchange_full (void* atomic, gint oldval, gint newval) noexcept
{
  typedef gboolean (*call_wrap_t) (void* atomic, gint oldval, gint newval, gint* preval);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_compare_and_exchange_full;
  gint preval_o {};
  ...
  auto _temp_ret = call_wrap_v ((void*) (atomic_to_c), (gint) (oldval_to_c), (gint) (newval_to_c), (gint*) (&preval_o));
  auto &&tmp_return_1 = _temp_ret;
  auto &&tmp_return_2 = preval_o;
  return std::make_tuple (std::move(tmp_return_1),std::move(tmp_return_2));
}

// gboolean g_atomic_int_dec_and_test (volatile gint* atomic);
// gboolean g_atomic_int_dec_and_test (void* atomic);
bool atomic_int_dec_and_test (void* atomic) noexcept
{
  typedef gboolean (*call_wrap_t) (void* atomic);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_dec_and_test;
  auto atomic_to_c = atomic;
...
// gint g_atomic_int_exchange (void* atomic, gint newval);
gint atomic_int_exchange (void* atomic, gint newval) noexcept
{
  typedef gint (*call_wrap_t) (void* atomic, gint newval);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_exchange;
  auto newval_to_c = newval;
  auto atomic_to_c = atomic;
  auto _temp_ret = call_wrap_v ((void*) (atomic_to_c), (gint) (newval_to_c));
  return _temp_ret;
}

// gint g_atomic_int_get (volatile const gint* atomic);
// gint g_atomic_int_get (const void* atomic);
gint atomic_int_get (const void* atomic) noexcept
{
  typedef gint (*call_wrap_t) (const void* atomic);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_get;
  auto atomic_to_c = atomic;
  auto _temp_ret = call_wrap_v ((const void*) (atomic_to_c));
  return _temp_ret;
}

// void g_atomic_int_inc (volatile gint* atomic);
// void g_atomic_int_inc (void* atomic);
void atomic_int_inc (void* atomic) noexcept
{
  typedef void (*call_wrap_t) (void* atomic);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_inc;
  auto atomic_to_c = atomic;
  call_wrap_v ((void*) (atomic_to_c));
}

// guint g_atomic_int_or (volatile guint* atomic, guint val);
// guint g_atomic_int_or (void* atomic, guint val);
guint atomic_int_or (void* atomic, guint val) noexcept
{
  typedef guint (*call_wrap_t) (void* atomic, guint val);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_or;
  auto val_to_c = val;
  auto atomic_to_c = atomic;
  auto _temp_ret = call_wrap_v ((void*) (atomic_to_c), (guint) (val_to_c));
  return _temp_ret;
...
// void g_atomic_int_set (void* atomic, gint newval);
void atomic_int_set (void* atomic, gint newval) noexcept
{
  typedef void (*call_wrap_t) (void* atomic, gint newval);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_set;
  auto newval_to_c = newval;
  auto atomic_to_c = atomic;
  call_wrap_v ((void*) (atomic_to_c), (gint) (newval_to_c));
}

// guint g_atomic_int_xor (volatile guint* atomic, guint val);
// guint g_atomic_int_xor (void* atomic, guint val);
guint atomic_int_xor (void* atomic, guint val) noexcept
{
  typedef guint (*call_wrap_t) (void* atomic, guint val);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_int_xor;
  auto val_to_c = val;
  auto atomic_to_c = atomic;
  auto _temp_ret = call_wrap_v ((void*) (atomic_to_c), (guint) (val_to_c));
  return _temp_ret;
...
void atomic_ref_count_init (gint & arc) noexcept
{
  typedef void (*call_wrap_t) (gint* arc);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_ref_count_init;
  gint arc_o {};
  call_wrap_v ((gint*) (&arc_o));
  arc = arc_o;
}
gint atomic_ref_count_init () noexcept
{
  typedef void (*call_wrap_t) (gint* arc);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_atomic_ref_count_init;
  gint arc_o {};
...
// void g_bit_lock (void* address, gint lock_bit);
void bit_lock (void* address, gint lock_bit) noexcept
{
  typedef void (*call_wrap_t) (void* address, gint lock_bit);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_bit_lock;
...
// void g_bit_lock_and_get (void* address, guint lock_bit, gint* out_val);
void bit_lock_and_get (void* address, guint lock_bit, gint * out_val) noexcept
{
  typedef void (*call_wrap_t) (void* address, guint lock_bit, gint* out_val);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_bit_lock_and_get;
  gint out_val_o {};
  auto lock_bit_to_c = lock_bit;
  auto address_to_c = address;
  call_wrap_v ((void*) (address_to_c), (guint) (lock_bit_to_c), (gint*) (out_val ? &out_val_o : nullptr));
  if (out_val) *out_val = out_val_o;
}
gint bit_lock_and_get (void* address, guint lock_bit) noexcept
{
  typedef void (*call_wrap_t) (void* address, guint lock_bit, gint* out_val);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_bit_lock_and_get;
  gint out_val_o {};
  auto lock_bit_to_c = lock_bit;
  auto address_to_c = address;
  call_wrap_v ((void*) (address_to_c), (guint) (lock_bit_to_c), (gint*) (&out_val_o));
  return out_val_o;
}
...
// gboolean g_bit_trylock (void* address, gint lock_bit);
bool bit_trylock (void* address, gint lock_bit) noexcept
{
  typedef gboolean (*call_wrap_t) (void* address, gint lock_bit);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_bit_trylock;
  auto lock_bit_to_c = lock_bit;
  auto address_to_c = address;
...
// void g_bit_unlock (void* address, gint lock_bit);
void bit_unlock (void* address, gint lock_bit) noexcept
{
  typedef void (*call_wrap_t) (void* address, gint lock_bit);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_bit_unlock;
  auto lock_bit_to_c = lock_bit;
  auto address_to_c = address;
  call_wrap_v ((void*) (address_to_c), (gint) (lock_bit_to_c));
}
...
// void g_bit_unlock_and_set (void* address, guint lock_bit, gint new_val, gint preserve_mask);
void bit_unlock_and_set (void* address, guint lock_bit, gint new_val, gint preserve_mask) noexcept
{
  typedef void (*call_wrap_t) (void* address, guint lock_bit, gint new_val, gint preserve_mask);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_bit_unlock_and_set;
  auto preserve_mask_to_c = preserve_mask;
  auto new_val_to_c = new_val;
  auto lock_bit_to_c = lock_bit;
  auto address_to_c = address;
  call_wrap_v ((void*) (address_to_c), (guint) (lock_bit_to_c), (gint) (new_val_to_c), (gint) (preserve_mask_to_c));
}
...
// uint64_t g_get_monotonic_time_ns ();
// guint64 g_get_monotonic_time_ns ();
guint64 get_monotonic_time_ns () noexcept
{
  typedef guint64 (*call_wrap_t) ();
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_get_monotonic_time_ns;
  auto _temp_ret = call_wrap_v ();
  return _temp_ret;
}
...
// GLogLevelFlags g_log_get_always_fatal ();
// ::GLogLevelFlags g_log_get_always_fatal ();
GLib::LogLevelFlags log_get_always_fatal () noexcept
{
  typedef ::GLogLevelFlags (*call_wrap_t) ();
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_log_get_always_fatal;
  auto _temp_ret = call_wrap_v ();
  return gi::wrap (_temp_ret);
}
...
// void g_log_set_writer_func (GLogWriterFunc func /*none*/, gpointer user_data, GDestroyNotify user_data_free /*none*/);
// void g_log_set_writer_func ( func /*none*/, void* user_data, GLib::DestroyNotify::cfunction_type user_data_free /*none*/);
...
// GLogWriterOutput g_log_writer_syslog (GLogLevelFlags log_level, const GLogField* fields /*none*/, gsize n_fields, gpointer user_data);
// ::GLogWriterOutput g_log_writer_syslog (::GLogLevelFlags log_level, const ::GLogField** fields /*none*/, gsize n_fields, void* user_data);
// SKIP; fields in boxed array not supported (depth 1)
...
// void g_on_error_stack_trace (const gchar* prg_name /*none,nullable*/);
// void g_on_error_stack_trace (const char* prg_name /*none,nullable*/);
...
void on_error_stack_trace () noexcept
{
  typedef void (*call_wrap_t) (const char* prg_name);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_on_error_stack_trace;
  auto prg_name_to_c = nullptr;
  call_wrap_v ((const char*) (prg_name_to_c));
}
...
// void g_pointer_bit_lock_and_get (void* address, guint lock_bit, guintptr* out_ptr);
void pointer_bit_lock_and_get (void* address, guint lock_bit, guintptr * out_ptr) noexcept
{
  typedef void (*call_wrap_t) (void* address, guint lock_bit, guintptr* out_ptr);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_pointer_bit_lock_and_get;
  guintptr out_ptr_o {};
  auto lock_bit_to_c = lock_bit;
  auto address_to_c = address;
  call_wrap_v ((void*) (address_to_c), (guint) (lock_bit_to_c), (guintptr*) (out_ptr ? &out_ptr_o : nullptr));
  if (out_ptr) *out_ptr = out_ptr_o;
}
guintptr pointer_bit_lock_and_get (void* address, guint lock_bit) noexcept
{
  typedef void (*call_wrap_t) (void* address, guint lock_bit, guintptr* out_ptr);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_pointer_bit_lock_and_get;
  guintptr out_ptr_o {};
  auto lock_bit_to_c = lock_bit;
  auto address_to_c = address;
  call_wrap_v ((void*) (address_to_c), (guint) (lock_bit_to_c), (guintptr*) (&out_ptr_o));
  return out_ptr_o;
}
...
// void* g_pointer_bit_lock_mask_ptr (void* ptr, guint lock_bit, gboolean set, guintptr preserve_mask, void* preserve_ptr);
gpointer pointer_bit_lock_mask_ptr (void* ptr, guint lock_bit, gboolean set, guintptr preserve_mask, void* preserve_ptr) noexcept
{
  typedef void* (*call_wrap_t) (void* ptr, guint lock_bit, gboolean set, guintptr preserve_mask, void* preserve_ptr);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_pointer_bit_lock_mask_ptr;
  auto preserve_ptr_to_c = preserve_ptr;
  auto preserve_mask_to_c = preserve_mask;
  auto set_to_c = set;
  auto lock_bit_to_c = lock_bit;
  auto ptr_to_c = ptr;
  auto _temp_ret = call_wrap_v ((void*) (ptr_to_c), (guint) (lock_bit_to_c), (gboolean) (set_to_c), (guintptr) (preserve_mask_to_c), (void*) (preserve_ptr_to_c));
  return _temp_ret;
}
...
// void g_pointer_bit_unlock_and_set (void* address, guint lock_bit, void* ptr, guintptr preserve_mask);
void pointer_bit_unlock_and_set (void* address, guint lock_bit, void* ptr, guintptr preserve_mask) noexcept
{
  typedef void (*call_wrap_t) (void* address, guint lock_bit, void* ptr, guintptr preserve_mask);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_pointer_bit_unlock_and_set;
  auto preserve_mask_to_c = preserve_mask;
  auto ptr_to_c = ptr;
  auto lock_bit_to_c = lock_bit;
  auto address_to_c = address;
  call_wrap_v ((void*) (address_to_c), (guint) (lock_bit_to_c), (void*) (ptr_to_c), (guintptr) (preserve_mask_to_c));
}
...
bool ref_count_dec (gint & rc) noexcept
{
  typedef gboolean (*call_wrap_t) (gint* rc);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_ref_count_dec;
  auto rc_to_c = rc;
  gint rc_o = rc_to_c;
  auto _temp_ret = call_wrap_v ((gint*) (&rc_o));
  rc = rc_o;
  return _temp_ret;
}
...
void ref_count_inc (gint & rc) noexcept
{
  typedef void (*call_wrap_t) (gint* rc);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_ref_count_inc;
  auto rc_to_c = rc;
  gint rc_o = rc_to_c;
  call_wrap_v ((gint*) (&rc_o));
  rc = rc_o;
}

// void g_ref_count_init (grefcount* rc);
// void g_ref_count_init (gint* rc);
void ref_count_init (gint & rc) noexcept
{
  typedef void (*call_wrap_t) (gint* rc);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_ref_count_init;
  gint rc_o {};
  call_wrap_v ((gint*) (&rc_o));
  rc = rc_o;
}
gint ref_count_init () noexcept
{
  typedef void (*call_wrap_t) (gint* rc);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_ref_count_init;
  gint rc_o {};
...
// gboolean g_ref_string_equal (const char* str1 /*none*/, const char* str2 /*none*/);
// gboolean g_ref_string_equal (const char* str1 /*none*/, const char* str2 /*none*/);
bool ref_string_equal (const gi::cstring_v str1, const gi::cstring_v str2) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* str1, const char* str2);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_ref_string_equal;
...
// void g_sort_array (void* array /*none*/, size_t n_elements, size_t element_size, GCompareDataFunc compare_func /*none*/, void* user_data);
// void g_sort_array (void** array /*none*/, gsize n_elements, gsize element_size, GLib::CompareDataFunc::cfunction_type compare_func /*none*/, void* user_data);
// IGNORE; not introspectable, inconsistent array in pointer depth (1 vs 2)
...
// gchar** /*full*/ g_str_tokenize_and_fold (const gchar* string /*none*/, const gchar* translit_locale /*none,nullable*/, gchar*** ascii_alternates /*full,out,opt*/);
// char** /*full*/ g_str_tokenize_and_fold (const char* string /*none*/, const char* translit_locale /*none,nullable*/, char*** ascii_alternates /*full,out,opt*/);
gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> str_tokenize_and_fold (const gi::cstring_v string, const gi::cstring_v translit_locale, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> * ascii_alternates) noexcept
{
  ...
  auto string_to_c = gi::unwrap (string, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((const char*) (string_to_c), (const char*) (translit_locale_to_c), (char***) (ascii_alternates ? &ascii_alternates_o : nullptr));
  if (ascii_alternates) *ascii_alternates = gi::wrap_to<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>>(ascii_alternates_o, gi::transfer_full);
  return gi::wrap_to<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>>(_temp_ret, gi::transfer_full);
}
...
gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> strdupv (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> str_array) noexcept
{
  typedef char** (*call_wrap_t) (char** str_array);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_strdupv;
  auto str_array_w = unwrap (std::move(str_array), gi::transfer_none);
  auto str_array_to_c = str_array_w;
  auto _temp_ret = call_wrap_v ((char**) (str_array_to_c));
  return gi::wrap_to<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>>(_temp_ret, gi::transfer_full);
}
...
void strfreev (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_full_t> str_array) noexcept
{
  typedef void (*call_wrap_t) (char** str_array);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_strfreev;
  auto str_array_w = unwrap (std::move(str_array), gi::transfer_full);
  auto str_array_to_c = str_array_w;
  call_wrap_v ((char**) (str_array_to_c));
}
...
gi::cstring strjoinv (const gi::cstring_v separator, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> str_array) noexcept
{
  typedef char* (*call_wrap_t) (const char* separator, char** str_array);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_strjoinv;
  auto str_array_w = unwrap (std::move(str_array), gi::transfer_none);
  auto str_array_to_c = str_array_w;
  auto separator_to_c = gi::unwrap (separator, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((const char*) (separator_to_c), (char**) (str_array_to_c));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
gi::cstring strjoinv (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> str_array) noexcept
{
  typedef char* (*call_wrap_t) (const char* separator, char** str_array);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_strjoinv;
  auto str_array_w = unwrap (std::move(str_array), gi::transfer_none);
  auto str_array_to_c = str_array_w;
  auto separator_to_c = nullptr;
  auto _temp_ret = call_wrap_v ((const char*) (separator_to_c), (char**) (str_array_to_c));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
...
// gchar* /*full,nullable*/ g_strndup (const gchar* str /*none,nullable*/, gsize n);
// char* /*full,nullable*/ g_strndup (const char* str /*none,nullable*/, gsize n);
...
gi::cstring strndup (gsize n) noexcept
{
  typedef char* (*call_wrap_t) (const char* str, gsize n);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_strndup;
  auto n_to_c = n;
...
// gchar* /*none,nullable*/ g_strrstr (const gchar* haystack /*none*/, const gchar* needle /*none*/);
// char* /*none,nullable*/ g_strrstr (const char* haystack /*none*/, const char* needle /*none*/);
gi::cstring_v strrstr (const gi::cstring_v haystack, const gi::cstring_v needle) noexcept
{
...
// gchar* /*none,nullable*/ g_strrstr_len (const gchar* haystack /*none*/, gssize haystack_len, const gchar* needle /*none*/);
// char* /*none,nullable*/ g_strrstr_len (const char* haystack /*none*/, gssize haystack_len, const char* needle /*none*/);
gi::cstring_v strrstr_len (const gi::cstring_v haystack, gssize haystack_len, const gi::cstring_v needle) noexcept
{
...
// char** /*full*/ g_strsplit_set (const char* string /*none*/, const guint8* delimiters /*none*/, gint max_tokens);
gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> strsplit_set (const gi::cstring_v string, gi::CollectionParameter<gi::ZTSpan, guint8, gi::transfer_none_t> delimiters, gint max_tokens) noexcept
{
  typedef char** (*call_wrap_t) (const char* string, const guint8* delimiters, gint max_tokens);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_strsplit_set;
  auto max_tokens_to_c = max_tokens;
  auto delimiters_w = unwrap (std::move(delimiters), gi::transfer_none);
  auto delimiters_to_c = delimiters_w;
  auto string_to_c = gi::unwrap (string, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((const char*) (string_to_c), (const guint8*) (delimiters_to_c), (gint) (max_tokens_to_c));
  return gi::wrap_to<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>>(_temp_ret, gi::transfer_full);
}

// gchar* /*none,nullable*/ g_strstr_len (const gchar* haystack /*none*/, gssize haystack_len, const gchar* needle /*none*/);
// char* /*none,nullable*/ g_strstr_len (const char* haystack /*none*/, gssize haystack_len, const char* needle /*none*/);
gi::cstring_v strstr_len (const gi::cstring_v haystack, gssize haystack_len, const gi::cstring_v needle) noexcept
{
  typedef char* (*call_wrap_t) (const char* haystack, gssize haystack_len, const char* needle);
...
bool strv_equal (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> strv1, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> strv2) noexcept
{
  typedef gboolean (*call_wrap_t) (const char** strv1, const char** strv2);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_strv_equal;
  auto strv2_w = unwrap (std::move(strv2), gi::transfer_none);
  auto strv2_to_c = strv2_w;
  auto strv1_w = unwrap (std::move(strv1), gi::transfer_none);
  auto strv1_to_c = strv1_w;
  auto _temp_ret = call_wrap_v ((const char**) (strv1_to_c), (const char**) (strv2_to_c));
  return _temp_ret;
}
...
guint strv_length (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> str_array) noexcept
{
  typedef guint (*call_wrap_t) (char** str_array);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_strv_length;
  auto str_array_w = unwrap (std::move(str_array), gi::transfer_none);
  auto str_array_to_c = str_array_w;
  auto _temp_ret = call_wrap_v ((char**) (str_array_to_c));
  return _temp_ret;
...
void test_queue_destroy (GLib::DestroyNotify destroy_func) noexcept
{
  typedef void (*call_wrap_t) (GLib::DestroyNotify::cfunction_type destroy_func, void* destroy_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_test_queue_destroy;
  auto destroy_func_wrap_ = destroy_func ? unwrap (std::move (destroy_func), gi::scope_async) : nullptr;
  call_wrap_v ((GLib::DestroyNotify::cfunction_type) (destroy_func_wrap_ ? &destroy_func_wrap_->wrapper : nullptr), (void*) (destroy_func_wrap_));
}
...
// gboolean g_test_trap_has_skipped ();
// gboolean g_test_trap_has_skipped ();
bool test_trap_has_skipped () noexcept
{
  typedef gboolean (*call_wrap_t) ();
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_test_trap_has_skipped;
  auto _temp_ret = call_wrap_v ();
  return _temp_ret;
}
...
// gboolean g_utf8_validate (const guint8* str /*none*/, gssize max_len, const guint8** end /*none,out,opt*/);
bool utf8_validate (const guint8 * str, gssize max_len, gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t> * end) noexcept
{
  typedef gboolean (*call_wrap_t) (const guint8* str, gssize max_len, const guint8** end);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_utf8_validate;
  const guint8* end_o {};
  auto str_to_c = str;
  auto _temp_ret = call_wrap_v ((const guint8*) (str_to_c), (gssize) (max_len), (const guint8**) (end ? &end_o : nullptr));
  if (end) *end = gi::wrap_to<gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t>>(end_o, gi::transfer_none);
  return _temp_ret;
}
std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t>> utf8_validate (const guint8 * str, gssize max_len) noexcept
{
  typedef gboolean (*call_wrap_t) (const guint8* str, gssize max_len, const guint8** end);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_utf8_validate;
  const guint8* end_o {};
  auto str_to_c = str;
  auto _temp_ret = call_wrap_v ((const guint8*) (str_to_c), (gssize) (max_len), (const guint8**) (&end_o));
  auto &&tmp_return_1 = _temp_ret;
  auto &&tmp_return_2 = gi::wrap_to<gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t>>(end_o, gi::transfer_none);
  return std::make_tuple (std::move(tmp_return_1),std::move(tmp_return_2));
}

// gboolean g_utf8_validate_len (const gchar* str /*none*/, gsize max_len, const gchar** end /*none,out,opt*/);
// gboolean g_utf8_validate_len (const guint8* str /*none*/, gsize max_len, const guint8** end /*none,out,opt*/);
bool utf8_validate_len (const guint8 * str, gsize max_len, gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t> * end) noexcept
{
  typedef gboolean (*call_wrap_t) (const guint8* str, gsize max_len, const guint8** end);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_utf8_validate_len;
  const guint8* end_o {};
  auto str_to_c = str;
  auto _temp_ret = call_wrap_v ((const guint8*) (str_to_c), (gsize) (max_len), (const guint8**) (end ? &end_o : nullptr));
  if (end) *end = gi::wrap_to<gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t>>(end_o, gi::transfer_none);
  return _temp_ret;
}
std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t>> utf8_validate_len (const guint8 * str, gsize max_len) noexcept
{
  typedef gboolean (*call_wrap_t) (const guint8* str, gsize max_len, const guint8** end);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_utf8_validate_len;
  const guint8* end_o {};
  auto str_to_c = str;
  auto _temp_ret = call_wrap_v ((const guint8*) (str_to_c), (gsize) (max_len), (const guint8**) (&end_o));
  auto &&tmp_return_1 = _temp_ret;
  auto &&tmp_return_2 = gi::wrap_to<gi::Collection<gi::ZTSpan, guint8, gi::transfer_none_t>>(end_o, gi::transfer_none);
  return std::make_tuple (std::move(tmp_return_1),std::move(tmp_return_2));
}
...
// gint g_vasprintf (gchar** string /*full,out*/, const gchar* format /*none*/, va_list args /*none*/);
// gint g_vasprintf (char** string /*full,out*/, const char* format /*none*/,  args /*none*/);
// IGNORE; not introspectable, args type  not supported
