...
// gchar* /*none,nullable*/ g_mapped_file_get_contents (GMappedFile* file /*none*/);
// char* /*none,nullable*/ g_mapped_file_get_contents (::GMappedFile* file /*none*/);
gi::cstring_v base::MappedFileBase::get_contents () noexcept
{
