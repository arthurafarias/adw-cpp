...
// guint g_date_get_week_of_year (const ::GDate* date /*none*/, ::GDateWeekday first_day_of_week);
GI_INLINE_DECL guint get_week_of_year (GLib::DateWeekday first_day_of_week) const noexcept;
...
// guint8 g_date_get_weeks_in_year (::GDateYear year, ::GDateWeekday first_day_of_week);
static GI_INLINE_DECL guint8 get_weeks_in_year (::GDateYear year, GLib::DateWeekday first_day_of_week) noexcept;
