...
GI_MODULE_STATIC_OR_INLINE guint _field_julian_days_get (const ::GDate* obj) { return (guint) obj->julian_days; }
...
GI_MODULE_STATIC_OR_INLINE void _field_julian_days_set (::GDate* obj, guint _value) { obj->julian_days = (decltype(obj->julian_days)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_julian_get (const ::GDate* obj) { return (guint) obj->julian; }
...
GI_MODULE_STATIC_OR_INLINE void _field_julian_set (::GDate* obj, guint _value) { obj->julian = (decltype(obj->julian)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_dmy_get (const ::GDate* obj) { return (guint) obj->dmy; }
...
GI_MODULE_STATIC_OR_INLINE void _field_dmy_set (::GDate* obj, guint _value) { obj->dmy = (decltype(obj->dmy)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_day_get (const ::GDate* obj) { return (guint) obj->day; }
...
GI_MODULE_STATIC_OR_INLINE void _field_day_set (::GDate* obj, guint _value) { obj->day = (decltype(obj->day)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_month_get (const ::GDate* obj) { return (guint) obj->month; }
...
GI_MODULE_STATIC_OR_INLINE void _field_month_set (::GDate* obj, guint _value) { obj->month = (decltype(obj->month)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_year_get (const ::GDate* obj) { return (guint) obj->year; }
...
GI_MODULE_STATIC_OR_INLINE void _field_year_set (::GDate* obj, guint _value) { obj->year = (decltype(obj->year)) _value; }
...
// guint g_date_get_week_of_year (const GDate* date /*none*/, GDateWeekday first_day_of_week);
// guint g_date_get_week_of_year (const ::GDate* date /*none*/, ::GDateWeekday first_day_of_week);
guint base::DateBase::get_week_of_year (GLib::DateWeekday first_day_of_week) const noexcept
{
  typedef guint (*call_wrap_t) (const ::GDate* date, ::GDateWeekday first_day_of_week);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_date_get_week_of_year;
  auto first_day_of_week_to_c = gi::unwrap (first_day_of_week);
  auto _temp_ret = call_wrap_v ((const ::GDate*) (gobj_()), (::GDateWeekday) (first_day_of_week_to_c));
  return _temp_ret;
}
...
// void g_date_set_time_t (GDate* date /*none*/, time_t timet /*none*/);
// void g_date_set_time_t (::GDate* date /*none*/,  timet /*none*/);
// SKIP; timet type  not supported
...
// guint8 g_date_get_weeks_in_year (::GDateYear year, ::GDateWeekday first_day_of_week);
guint8 base::DateBase::get_weeks_in_year (::GDateYear year, GLib::DateWeekday first_day_of_week) noexcept
{
  typedef guint8 (*call_wrap_t) (::GDateYear year, ::GDateWeekday first_day_of_week);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_date_get_weeks_in_year;
  auto first_day_of_week_to_c = gi::unwrap (first_day_of_week);
  auto year_to_c = year;
  auto _temp_ret = call_wrap_v ((::GDateYear) (year_to_c), (::GDateWeekday) (first_day_of_week_to_c));
  return _temp_ret;
}
