...
GI_MODULE_STATIC_OR_INLINE char* _field_str_get (const ::GString* obj) { return (char*) obj->str; }
...
GI_MODULE_STATIC_OR_INLINE gsize _field_len_get (const ::GString* obj) { return (gsize) obj->len; }
...
GI_MODULE_STATIC_OR_INLINE void _field_len_set (::GString* obj, gsize _value) { obj->len = (decltype(obj->len)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gsize _field_allocated_len_get (const ::GString* obj) { return (gsize) obj->allocated_len; }
...
GI_MODULE_STATIC_OR_INLINE void _field_allocated_len_set (::GString* obj, gsize _value) { obj->allocated_len = (decltype(obj->allocated_len)) _value; }
...
// GString* /*full*/ g_string_copy (GString* string /*none*/);
// ::GString* /*full*/ g_string_copy (::GString* string /*none*/);
GLib::String base::StringBase::copy () noexcept
{
  typedef ::GString* (*call_wrap_t) (::GString* string);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_string_copy;
  auto _temp_ret = call_wrap_v ((::GString*) (gobj_()));
  return gi::wrap (_temp_ret, gi::transfer_full);
}
