...
GI_MODULE_STATIC_OR_INLINE gboolean _field_exclusive_get (const ::GThreadPool* obj) { return (gboolean) obj->exclusive; }
...
GI_MODULE_STATIC_OR_INLINE void _field_exclusive_set (::GThreadPool* obj, gboolean _value) { obj->exclusive = (decltype(obj->exclusive)) _value; }
