...
// typedef void (*GLogFunc) (const gchar* log_domain /*none,nullable*/, GLogLevelFlags log_level, const gchar* message /*none*/, gpointer user_data);
// typedef void (*GLogFunc) (const char* log_domain /*none,nullable*/, ::GLogLevelFlags log_level, const char* message /*none*/, void* user_data);
namespace internal {
...
// typedef gboolean (*GSourceFuncsCheckFunc) (GSource* source /*none*/);
// typedef gboolean (*GSourceFuncsCheckFunc) (::GSource* source /*none*/);
// SKIP; not a callback since no user_data

// typedef gboolean (*GSourceFuncsDispatchFunc) (GSource* source /*none*/, GSourceFunc callback /*none,nullable*/, gpointer user_data);
// typedef gboolean (*GSourceFuncsDispatchFunc) (::GSource* source /*none*/, GLib::SourceFunc::cfunction_type callback /*none,nullable*/, void* user_data);
// IGNORE; not introspectable, callback misses scope info

// typedef void (*GSourceFuncsFinalizeFunc) (GSource* source /*none*/);
// typedef void (*GSourceFuncsFinalizeFunc) (::GSource* source /*none*/);
// SKIP; not a callback since no user_data

// typedef gboolean (*GSourceFuncsPrepareFunc) (GSource* source /*none*/, gint* timeout_);
// typedef gboolean (*GSourceFuncsPrepareFunc) (::GSource* source /*none*/, gint* timeout_);
// SKIP; not a callback since no user_data
