...
// gsize g_markup_parse_context_get_offset (::GMarkupParseContext* context /*none*/);
GI_INLINE_DECL gsize get_offset () noexcept;
...
// void g_markup_parse_context_get_tag_start (::GMarkupParseContext* context /*none*/, gsize* line_number, gsize* char_number, gsize* offset);
GI_INLINE_DECL void get_tag_start (gsize & line_number, gsize & char_number, gsize & offset) noexcept;
GI_INLINE_DECL std::tuple<gsize, gsize, gsize> get_tag_start () noexcept;
