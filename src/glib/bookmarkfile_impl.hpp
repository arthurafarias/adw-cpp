...
// time_t /*none*/ g_bookmark_file_get_added (GBookmarkFile* bookmark /*none*/, const gchar* uri /*none*/, GError ** error);
//  /*none*/ g_bookmark_file_get_added (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/, GError ** error);
// IGNORE; deprecated
...
// gboolean g_bookmark_file_get_app_info (GBookmarkFile* bookmark /*none*/, const gchar* uri /*none*/, const gchar* name /*none*/, gchar** exec /*full,out,opt*/, guint* count, time_t* stamp /*full,out,opt*/, GError ** error);
// gboolean g_bookmark_file_get_app_info (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/, const char* name /*none*/, char** exec /*full,out,opt*/, guint* count, * stamp /*full,out,opt*/, GError ** error);
// IGNORE; deprecated
...
// time_t /*none*/ g_bookmark_file_get_modified (GBookmarkFile* bookmark /*none*/, const gchar* uri /*none*/, GError ** error);
//  /*none*/ g_bookmark_file_get_modified (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/, GError ** error);
// IGNORE; deprecated
...
// time_t /*none*/ g_bookmark_file_get_visited (GBookmarkFile* bookmark /*none*/, const gchar* uri /*none*/, GError ** error);
//  /*none*/ g_bookmark_file_get_visited (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/, GError ** error);
// IGNORE; deprecated
...
// void g_bookmark_file_set_added (GBookmarkFile* bookmark /*none*/, const gchar* uri /*none*/, time_t added /*none*/);
// void g_bookmark_file_set_added (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/,  added /*none*/);
// IGNORE; deprecated
...
// gboolean g_bookmark_file_set_app_info (GBookmarkFile* bookmark /*none*/, const gchar* uri /*none*/, const gchar* name /*none*/, const gchar* exec /*none*/, gint count, time_t stamp /*none*/, GError ** error);
// gboolean g_bookmark_file_set_app_info (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/, const char* name /*none*/, const char* exec /*none*/, gint count,  stamp /*none*/, GError ** error);
// IGNORE; deprecated
...
// void g_bookmark_file_set_modified (GBookmarkFile* bookmark /*none*/, const gchar* uri /*none*/, time_t modified /*none*/);
// void g_bookmark_file_set_modified (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/,  modified /*none*/);
// IGNORE; deprecated
...
// void g_bookmark_file_set_visited (GBookmarkFile* bookmark /*none*/, const gchar* uri /*none*/, time_t visited /*none*/);
// void g_bookmark_file_set_visited (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/,  visited /*none*/);
// IGNORE; deprecated
