...
GI_MODULE_STATIC_OR_INLINE const char* _field_key_get (const ::GDebugKey* obj) { return (const char*) obj->key; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_value_get (const ::GDebugKey* obj) { return (guint) obj->value; }
...
GI_MODULE_STATIC_OR_INLINE void _field_value_set (::GDebugKey* obj, guint _value) { obj->value = (decltype(obj->value)) _value; }
