...
GI_MODULE_STATIC_OR_INLINE gboolean _field_test_initialized_get (const ::GTestConfig* obj) { return (gboolean) obj->test_initialized; }
...
GI_MODULE_STATIC_OR_INLINE void _field_test_initialized_set (::GTestConfig* obj, gboolean _value) { obj->test_initialized = (decltype(obj->test_initialized)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gboolean _field_test_quick_get (const ::GTestConfig* obj) { return (gboolean) obj->test_quick; }
...
GI_MODULE_STATIC_OR_INLINE void _field_test_quick_set (::GTestConfig* obj, gboolean _value) { obj->test_quick = (decltype(obj->test_quick)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gboolean _field_test_perf_get (const ::GTestConfig* obj) { return (gboolean) obj->test_perf; }
...
GI_MODULE_STATIC_OR_INLINE void _field_test_perf_set (::GTestConfig* obj, gboolean _value) { obj->test_perf = (decltype(obj->test_perf)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gboolean _field_test_verbose_get (const ::GTestConfig* obj) { return (gboolean) obj->test_verbose; }
...
GI_MODULE_STATIC_OR_INLINE void _field_test_verbose_set (::GTestConfig* obj, gboolean _value) { obj->test_verbose = (decltype(obj->test_verbose)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gboolean _field_test_quiet_get (const ::GTestConfig* obj) { return (gboolean) obj->test_quiet; }
...
GI_MODULE_STATIC_OR_INLINE void _field_test_quiet_set (::GTestConfig* obj, gboolean _value) { obj->test_quiet = (decltype(obj->test_quiet)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gboolean _field_test_undefined_get (const ::GTestConfig* obj) { return (gboolean) obj->test_undefined; }
...
GI_MODULE_STATIC_OR_INLINE void _field_test_undefined_set (::GTestConfig* obj, gboolean _value) { obj->test_undefined = (decltype(obj->test_undefined)) _value; }
