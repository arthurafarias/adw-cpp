...
// GMainContext* /*full,nullable*/ g_source_dup_context (GSource* source /*none*/);
// ::GMainContext* /*full,nullable*/ g_source_dup_context (::GSource* source /*none*/);
GLib::MainContext base::SourceBase::dup_context () noexcept
{
  typedef ::GMainContext* (*call_wrap_t) (::GSource* source);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_source_dup_context;
