...
GI_MODULE_STATIC_OR_INLINE guint _field_len_get (const ::GByteArray* obj) { return (guint) obj->len; }
...
GI_MODULE_STATIC_OR_INLINE void _field_len_set (::GByteArray* obj, guint _value) { obj->len = (decltype(obj->len)) _value; }
...
// GByteArray* /*none*/ g_byte_array_append (GByteArray* array /*none*/, const guint8* data /*none*/, guint len);
// ::GByteArray* /*none*/ g_byte_array_append (::GByteArray* array /*none*/, const guint8* data /*none*/, guint len);
GLib::ByteArray_Ref base::ByteArrayBase::append (GLib::ByteArray_Ref array, const guint8 * data, guint len) noexcept
{
  typedef ::GByteArray* (*call_wrap_t) (::GByteArray* array, const guint8* data, guint len);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_byte_array_append;
  auto data_to_c = data;
  auto array_to_c = gi::unwrap (array, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((::GByteArray*) (array_to_c), (const guint8*) (data_to_c), (guint) (len));
  return gi::wrap (_temp_ret, gi::transfer_none);
}

//  /*full,nullable*/ g_byte_array_free (GByteArray* array /*full*/, gboolean free_segment);
// * /*full,nullable*/ g_byte_array_free (::GByteArray* array /*full*/, gboolean free_segment);
// IGNORE; marked ignore, inconsistent array info
...
// GByteArray* /*none*/ g_byte_array_prepend (GByteArray* array /*none*/, const guint8* data /*none*/, guint len);
// ::GByteArray* /*none*/ g_byte_array_prepend (::GByteArray* array /*none*/, const guint8* data /*none*/, guint len);
GLib::ByteArray_Ref base::ByteArrayBase::prepend (GLib::ByteArray_Ref array, const guint8 * data, guint len) noexcept
{
  typedef ::GByteArray* (*call_wrap_t) (::GByteArray* array, const guint8* data, guint len);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_byte_array_prepend;
  auto data_to_c = data;
  auto array_to_c = gi::unwrap (array, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((::GByteArray*) (array_to_c), (const guint8*) (data_to_c), (guint) (len));
  return gi::wrap (_temp_ret, gi::transfer_none);
...
// guint8* /*full*/ g_byte_array_steal (GByteArray* array /*none*/, gsize* len);
// guint8* /*full*/ g_byte_array_steal (::GByteArray* array /*none*/, gsize* len);
gi::Collection<gi::DSpan, guint8, gi::transfer_full_t> base::ByteArrayBase::steal (GLib::ByteArray_Ref array) noexcept
{
  typedef guint8* (*call_wrap_t) (::GByteArray* array, gsize* len);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_byte_array_steal;
  auto array_to_c = gi::unwrap (array, gi::transfer_none);
  gsize len;
  auto _ret_o = call_wrap_v ((::GByteArray*) (array_to_c), (gsize*) (&len));
  gi::Collection<gi::DSpan, guint8, gi::transfer_full_t> _temp_ret;
  _temp_ret = gi::wrap_to<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>>(_ret_o, len, gi::transfer_full);
  return _temp_ret;
}

// void g_byte_array_unref (GByteArray* array /*full*/);
// void g_byte_array_unref (::GByteArray* array /*full*/);
// IGNORE; marked ignore
