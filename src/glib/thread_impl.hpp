...
// const char* /*none*/ g_thread_get_name (GThread* thread /*none*/);
// const char* /*none*/ g_thread_get_name (::GThread* thread /*none*/);
gi::cstring_v base::ThreadBase::get_name () noexcept
{
  typedef const char* (*call_wrap_t) (::GThread* thread);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_thread_get_name;
