...
// gboolean g_dtls_connection_get_channel_binding_data (GDtlsConnection* conn /*none*/, GTlsChannelBindingType type, GByteArray* data /*none,out,opt,ca*/, GError ** error);
// gboolean g_dtls_connection_get_channel_binding_data (::GDtlsConnection* conn /*none*/, ::GTlsChannelBindingType type, ::GByteArray* data /*none,out,opt,ca*/, GError ** error);
bool base::DtlsConnectionBase::get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::ByteArray * data)
{
  typedef gboolean (*call_wrap_t) (::GDtlsConnection* conn, ::GTlsChannelBindingType type, ::GByteArray* data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dtls_connection_get_channel_binding_data;
  static_assert(sizeof(::GByteArray) == sizeof(*(*data).gobj_()), "");
  auto type_to_c = gi::unwrap (type);
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::GDtlsConnection*) (gobj_()), (::GTlsChannelBindingType) (type_to_c), (::GByteArray*) (data ? (::GByteArray*) (*data).gobj_() : nullptr), &error);
  gi::check_error (error);
  return _temp_ret;
}
bool base::DtlsConnectionBase::get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::ByteArray * data, GLib::Error * _error) noexcept
{
  typedef gboolean (*call_wrap_t) (::GDtlsConnection* conn, ::GTlsChannelBindingType type, ::GByteArray* data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dtls_connection_get_channel_binding_data;
  static_assert(sizeof(::GByteArray) == sizeof(*(*data).gobj_()), "");
  auto type_to_c = gi::unwrap (type);
  GError* _error_o {};
  auto _temp_ret = call_wrap_v ((::GDtlsConnection*) (gobj_()), (::GTlsChannelBindingType) (type_to_c), (::GByteArray*) (data ? (::GByteArray*) (*data).gobj_() : nullptr), _error ? &_error_o : nullptr);
  if (_error) *_error = gi::wrap (_error_o, gi::transfer_full);
  return _temp_ret;
}
std::tuple<bool, GLib::ByteArray> base::DtlsConnectionBase::get_channel_binding_data (Gio::TlsChannelBindingType type)
{
  typedef gboolean (*call_wrap_t) (::GDtlsConnection* conn, ::GTlsChannelBindingType type, ::GByteArray* data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dtls_connection_get_channel_binding_data;
  GLib::ByteArray data_c;
  auto data = &data_c;
  static_assert(sizeof(::GByteArray) == sizeof(*(*data).gobj_()), "");
  auto type_to_c = gi::unwrap (type);
  GError *error = NULL;
  ...
  auto &&tmp_return_2 = data_c;
  return std::make_tuple (std::move(tmp_return_1),std::move(tmp_return_2));
}
std::tuple<bool, GLib::ByteArray> base::DtlsConnectionBase::get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::Error * _error) noexcept
{
  typedef gboolean (*call_wrap_t) (::GDtlsConnection* conn, ::GTlsChannelBindingType type, ::GByteArray* data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dtls_connection_get_channel_binding_data;
  GLib::ByteArray data_c;
...
void DtlsConnectionInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.accept_certificate) methods->accept_certificate = (decltype (methods->accept_certificate)) gi::detail::method_wrapper<self, bool (*) (Gio::TlsCertificate peer_cert, Gio::TlsCertificateFlags errors), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::accept_certificate_>;
  if (init_data.get_binding_data) methods->get_binding_data = (decltype (methods->get_binding_data)) gi::detail::method_wrapper<self, bool (*) (Gio::TlsChannelBindingType type, GLib::ByteArray_Ref data, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::get_binding_data_>;
  if (init_data.get_negotiated_protocol) methods->get_negotiated_protocol = (decltype (methods->get_negotiated_protocol)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_negotiated_protocol_>;
  if (init_data.handshake) methods->handshake = (decltype (methods->handshake)) gi::detail::method_wrapper<self, bool (*) (Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::handshake_>;
  ...
  if (init_data.handshake_finish) methods->handshake_finish = (decltype (methods->handshake_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::handshake_finish_>;
  if (init_data.set_advertised_protocols) methods->set_advertised_protocols = (decltype (methods->set_advertised_protocols)) gi::detail::method_wrapper<self, void (*) (gi::Collection<gi::ZTSpan, char*, gi::transfer_none_t> protocols), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_advertised_protocols_>;
  if (init_data.shutdown) methods->shutdown = (decltype (methods->shutdown)) gi::detail::method_wrapper<self, bool (*) (gboolean shutdown_read, gboolean shutdown_write, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::shutdown_>;
  if (init_data.shutdown_async) methods->shutdown_async = (decltype (methods->shutdown_async)) gi::detail::method_wrapper<self, void (*) (gboolean shutdown_read, gboolean shutdown_write, gint io_priority, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<3>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<4, 5>>>, void  (gboolean shutdown_read, gboolean shutdown_write, gint io_priority, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::shutdown_async_>;
  if (init_data.shutdown_finish) methods->shutdown_finish = (decltype (methods->shutdown_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::shutdown_finish_>;
}
