...
GI_MODULE_STATIC_OR_INLINE guint _field_num_vectors_get (const ::GInputMessage* obj) { return (guint) obj->num_vectors; }
...
GI_MODULE_STATIC_OR_INLINE void _field_num_vectors_set (::GInputMessage* obj, guint _value) { obj->num_vectors = (decltype(obj->num_vectors)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gsize _field_bytes_received_get (const ::GInputMessage* obj) { return (gsize) obj->bytes_received; }
...
GI_MODULE_STATIC_OR_INLINE void _field_bytes_received_set (::GInputMessage* obj, gsize _value) { obj->bytes_received = (decltype(obj->bytes_received)) _value; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_flags_get (const ::GInputMessage* obj) { return (gint) obj->flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_flags_set (::GInputMessage* obj, gint _value) { obj->flags = (decltype(obj->flags)) _value; }
