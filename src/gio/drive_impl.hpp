...
void DriveIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.can_poll_for_media) methods->can_poll_for_media = (decltype (methods->can_poll_for_media)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_poll_for_media_>;
  if (init_data.can_start) methods->can_start = (decltype (methods->can_start)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_start_>;
  if (init_data.can_start_degraded) methods->can_start_degraded = (decltype (methods->can_start_degraded)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_start_degraded_>;
  if (init_data.can_stop) methods->can_stop = (decltype (methods->can_stop)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_stop_>;
  ...
  if (init_data.disconnected) methods->disconnected = (decltype (methods->disconnected)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::disconnected_>;
  if (init_data.eject_button) methods->eject_button = (decltype (methods->eject_button)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::eject_button_>;
  ...
  if (init_data.enumerate_identifiers) methods->enumerate_identifiers = (decltype (methods->enumerate_identifiers)) gi::detail::method_wrapper<self, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::enumerate_identifiers_>;
  ...
  if (init_data.get_identifier) methods->get_identifier = (decltype (methods->get_identifier)) gi::detail::method_wrapper<self, gi::cstring (*) (const gi::cstring_v kind), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_identifier_>;
  ...
  if (init_data.get_start_stop_type) methods->get_start_stop_type = (decltype (methods->get_start_stop_type)) gi::detail::method_wrapper<self, Gio::DriveStartStopType (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_start_stop_type_>;
  ...
  if (init_data.get_volumes) methods->get_volumes = (decltype (methods->get_volumes)) gi::detail::method_wrapper<self, gi::Collection<GList, ::GVolume*, gi::transfer_full_t> (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_volumes_>;
  if (init_data.has_media) methods->has_media = (decltype (methods->has_media)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::has_media_>;
  if (init_data.has_volumes) methods->has_volumes = (decltype (methods->has_volumes)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::has_volumes_>;
  if (init_data.is_media_check_automatic) methods->is_media_check_automatic = (decltype (methods->is_media_check_automatic)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::is_media_check_automatic_>;
  if (init_data.is_media_removable) methods->is_media_removable = (decltype (methods->is_media_removable)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::is_media_removable_>;
  if (init_data.is_removable) methods->is_removable = (decltype (methods->is_removable)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::is_removable_>;
  if (init_data.poll_for_media) methods->poll_for_media = (decltype (methods->poll_for_media)) gi::detail::method_wrapper<self, void (*) (Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<1, 2>>>, void  (::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::poll_for_media_>;
  if (init_data.poll_for_media_finish) methods->poll_for_media_finish = (decltype (methods->poll_for_media_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::poll_for_media_finish_>;
  if (init_data.start) methods->start = (decltype (methods->start)) gi::detail::method_wrapper<self, void (*) (Gio::DriveStartFlags flags, Gio::MountOperation mount_operation, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<3, 4>>>, void  (::GDriveStartFlags flags, ::GMountOperation* mount_operation, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::start_>;
  if (init_data.start_finish) methods->start_finish = (decltype (methods->start_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::start_finish_>;
  if (init_data.stop) methods->stop = (decltype (methods->stop)) gi::detail::method_wrapper<self, void (*) (Gio::MountUnmountFlags flags, Gio::MountOperation mount_operation, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<3, 4>>>, void  (::GMountUnmountFlags flags, ::GMountOperation* mount_operation, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::stop_>;
  if (init_data.stop_button) methods->stop_button = (decltype (methods->stop_button)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::stop_button_>;
  if (init_data.stop_finish) methods->stop_finish = (decltype (methods->stop_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::stop_finish_>;
}
