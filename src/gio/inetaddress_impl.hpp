...
// GInetAddress* /*full*/ g_inet_address_new_from_bytes_with_ipv6_info ( bytes /*none*/, GSocketFamily family, guint32 flowinfo, guint32 scope_id);
// ::GInetAddress* /*full*/ g_inet_address_new_from_bytes_with_ipv6_info (* bytes /*none*/, ::GSocketFamily family, guint32 flowinfo, guint32 scope_id);
// SKIP; inconsistent array info
...
// guint32 g_inet_address_get_flowinfo (GInetAddress* address /*none*/);
// guint32 g_inet_address_get_flowinfo (::GInetAddress* address /*none*/);
guint32 base::InetAddressBase::get_flowinfo () noexcept
{
  typedef guint32 (*call_wrap_t) (::GInetAddress* address);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_inet_address_get_flowinfo;
  auto _temp_ret = call_wrap_v ((::GInetAddress*) (gobj_()));
  return _temp_ret;
}
...
// guint32 g_inet_address_get_scope_id (GInetAddress* address /*none*/);
// guint32 g_inet_address_get_scope_id (::GInetAddress* address /*none*/);
guint32 base::InetAddressBase::get_scope_id () noexcept
{
  typedef guint32 (*call_wrap_t) (::GInetAddress* address);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_inet_address_get_scope_id;
  auto _temp_ret = call_wrap_v ((::GInetAddress*) (gobj_()));
  return _temp_ret;
}
...
void InetAddressClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.to_string) methods->to_string = (decltype (methods->to_string)) gi::detail::method_wrapper<self, gi::cstring (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::to_string_>;
}
