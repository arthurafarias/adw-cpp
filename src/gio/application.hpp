...
gi::property_proxy<gi::cstring, base::ApplicationBase> property_version()
{ return gi::property_proxy<gi::cstring, base::ApplicationBase> (*this, "version"); }
const gi::property_proxy<gi::cstring, base::ApplicationBase> property_version() const
{ return gi::property_proxy<gi::cstring, base::ApplicationBase> (*this, "version"); }
