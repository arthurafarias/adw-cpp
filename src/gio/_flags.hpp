...
GI_FLAG_OPERATORS(IOModuleScopeFlags)
...
template<> struct is_bitfield<Gio::IOModuleScopeFlags> : public std::true_type
{};
...
GI_FLAG_OPERATORS(TlsCertificateRequestFlags)
...
template<> struct is_bitfield<Gio::TlsCertificateRequestFlags> : public std::true_type
{};
...
GI_FLAG_OPERATORS(TlsDatabaseLookupFlags)
...
template<> struct is_bitfield<Gio::TlsDatabaseLookupFlags> : public std::true_type
{};
