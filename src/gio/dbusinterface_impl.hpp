...
// GDBusInterfaceInfo* /*none,nullable*/ g_dbus_interface_get_info (GDBusInterface* interface_ /*none*/);
// ::GDBusInterfaceInfo* /*none,nullable*/ g_dbus_interface_get_info (::GDBusInterface* interface_ /*none*/);
...
void DBusInterfaceIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.dup_object) methods->dup_object = (decltype (methods->dup_object)) gi::detail::method_wrapper<self, Gio::DBusObject (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::dup_object_>;
  ...
  if (init_data.set_object) methods->set_object = (decltype (methods->set_object)) gi::detail::method_wrapper<self, void (*) (Gio::DBusObject object), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::set_object_>;
}
...
// GDBusInterfaceInfo* /*none,nullable*/ DBusInterface::get_info (GDBusInterface* interface_ /*none*/);
// ::GDBusInterfaceInfo* /*none,nullable*/ DBusInterface::get_info (::GDBusInterface* interface_ /*none*/);
