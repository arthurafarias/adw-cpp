...
// pid_t g_credentials_get_unix_pid (::GCredentials* credentials /*none*/, GError ** error);
GI_INLINE_DECL pid_t get_unix_pid ();
GI_INLINE_DECL pid_t get_unix_pid (GLib::Error * _error) noexcept;

// uid_t g_credentials_get_unix_user (GCredentials* credentials /*none*/, GError ** error);
// uid_t g_credentials_get_unix_user (::GCredentials* credentials /*none*/, GError ** error);
GI_INLINE_DECL uid_t get_unix_user ();
GI_INLINE_DECL uid_t get_unix_user (GLib::Error * _error) noexcept;
...
// gboolean g_credentials_set_unix_user (::GCredentials* credentials /*none*/, uid_t uid, GError ** error);
GI_INLINE_DECL bool set_unix_user (uid_t uid);
GI_INLINE_DECL bool set_unix_user (uid_t uid, GLib::Error * _error) noexcept;
