...
// GVariant* /*full*/ g_dbus_proxy_call_with_unix_fd_list_finish (GDBusProxy* proxy /*none*/, GUnixFDList** out_fd_list /*full,out,opt,nullable*/, GAsyncResult* res /*none*/, GError ** error);
// ::GVariant* /*full*/ g_dbus_proxy_call_with_unix_fd_list_finish (::GDBusProxy* proxy /*none*/, ::GUnixFDList** out_fd_list /*full,out,opt,nullable*/, ::GAsyncResult* res /*none*/, GError ** error);
...
// ::GVariant* /*full*/ g_dbus_proxy_call_with_unix_fd_list_sync (::GDBusProxy* proxy /*none*/, const char* method_name /*none*/, ::GVariant* parameters /*none,nullable*/, ::GDBusCallFlags flags, gint timeout_msec, ::GUnixFDList* fd_list /*none,nullable*/, ::GUnixFDList** out_fd_list /*full,out,opt,nullable*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
...
void DBusProxyClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.g_signal) methods->g_signal = (decltype (methods->g_signal)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v sender_name, const gi::cstring_v signal_name, GLib::Variant parameters), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::g_signal_>;
}
