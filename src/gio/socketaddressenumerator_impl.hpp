...
void SocketAddressEnumeratorClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.next) methods->next = (decltype (methods->next)) gi::detail::method_wrapper<self, Gio::SocketAddress (*) (Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::next_>;
  if (init_data.next_async) methods->next_async = (decltype (methods->next_async)) gi::detail::method_wrapper<self, void (*) (Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<1, 2>>>, void  (::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::next_async_>;
  if (init_data.next_finish) methods->next_finish = (decltype (methods->next_finish)) gi::detail::method_wrapper<self, Gio::SocketAddress (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::next_finish_>;
}
