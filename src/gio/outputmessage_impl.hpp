...
GI_MODULE_STATIC_OR_INLINE ::GSocketAddress* _field_address_get (const ::GOutputMessage* obj) { return (::GSocketAddress*) obj->address; }
...
GI_MODULE_STATIC_OR_INLINE ::GOutputVector* _field_vectors_get (const ::GOutputMessage* obj) { return (::GOutputVector*) obj->vectors; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_num_vectors_get (const ::GOutputMessage* obj) { return (guint) obj->num_vectors; }
...
GI_MODULE_STATIC_OR_INLINE void _field_num_vectors_set (::GOutputMessage* obj, guint _value) { obj->num_vectors = (decltype(obj->num_vectors)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_bytes_sent_get (const ::GOutputMessage* obj) { return (guint) obj->bytes_sent; }
...
GI_MODULE_STATIC_OR_INLINE void _field_bytes_sent_set (::GOutputMessage* obj, guint _value) { obj->bytes_sent = (decltype(obj->bytes_sent)) _value; }
...
GI_MODULE_STATIC_OR_INLINE guint _field_num_control_messages_get (const ::GOutputMessage* obj) { return (guint) obj->num_control_messages; }
...
GI_MODULE_STATIC_OR_INLINE void _field_num_control_messages_set (::GOutputMessage* obj, guint _value) { obj->num_control_messages = (decltype(obj->num_control_messages)) _value; }
