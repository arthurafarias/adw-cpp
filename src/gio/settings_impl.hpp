...
// void g_settings_bind_with_mapping (GSettings* settings /*none*/, const gchar* key /*none*/, gpointer object /*none*/, const gchar* property /*none*/, GSettingsBindFlags flags, GSettingsBindGetMapping get_mapping /*none,nullable*/, GSettingsBindSetMapping set_mapping /*none,nullable*/, gpointer user_data, GDestroyNotify destroy /*none*/);
// void g_settings_bind_with_mapping (::GSettings* settings /*none*/, const char* key /*none*/, ::GObject* object /*none*/, const char* property /*none*/, ::GSettingsBindFlags flags, Gio::SettingsBindGetMapping::cfunction_type get_mapping /*none,nullable*/, Gio::SettingsBindSetMapping::cfunction_type set_mapping /*none,nullable*/, void* user_data, GLib::DestroyNotify::cfunction_type destroy /*none*/);
// IGNORE; not introspectable; shadowed-by bind_with_mapping_closures

// void g_settings_bind_with_mapping_closures (GSettings* settings /*none*/, const char* key /*none*/, GObject* object /*none*/, const char* property /*none*/, GSettingsBindFlags flags, GClosure* get_mapping /*none,nullable*/, GClosure* set_mapping /*none,nullable*/);
// void g_settings_bind_with_mapping_closures (::GSettings* settings /*none*/, const char* key /*none*/, ::GObject* object /*none*/, const char* property /*none*/, ::GSettingsBindFlags flags, ::GClosure* get_mapping /*none,nullable*/, ::GClosure* set_mapping /*none,nullable*/);
void base::SettingsBase::bind_with_mapping (const gi::cstring_v key, GObject::Object object, const gi::cstring_v property, Gio::SettingsBindFlags flags, GObject::Closure_Ref get_mapping, GObject::Closure_Ref set_mapping) noexcept
{
  typedef void (*call_wrap_t) (::GSettings* settings, const char* key, ::GObject* object, const char* property, ::GSettingsBindFlags flags, ::GClosure* get_mapping, ::GClosure* set_mapping);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_settings_bind_with_mapping_closures;
  auto set_mapping_to_c = gi::unwrap (set_mapping, gi::transfer_none);
  auto get_mapping_to_c = gi::unwrap (get_mapping, gi::transfer_none);
  auto flags_to_c = gi::unwrap (flags);
  auto property_to_c = gi::unwrap (property, gi::transfer_none);
  auto object_to_c = gi::unwrap (object, gi::transfer_none);
  auto key_to_c = gi::unwrap (key, gi::transfer_none);
  call_wrap_v ((::GSettings*) (gobj_()), (const char*) (key_to_c), (::GObject*) (object_to_c), (const char*) (property_to_c), (::GSettingsBindFlags) (flags_to_c), (::GClosure*) (get_mapping_to_c), (::GClosure*) (set_mapping_to_c));
}
void base::SettingsBase::bind_with_mapping (const gi::cstring_v key, GObject::Object object, const gi::cstring_v property, Gio::SettingsBindFlags flags) noexcept
{
  typedef void (*call_wrap_t) (::GSettings* settings, const char* key, ::GObject* object, const char* property, ::GSettingsBindFlags flags, ::GClosure* get_mapping, ::GClosure* set_mapping);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_settings_bind_with_mapping_closures;
  auto set_mapping_to_c = nullptr;
  auto get_mapping_to_c = nullptr;
  auto flags_to_c = gi::unwrap (flags);
  auto property_to_c = gi::unwrap (property, gi::transfer_none);
  auto object_to_c = gi::unwrap (object, gi::transfer_none);
  auto key_to_c = gi::unwrap (key, gi::transfer_none);
...
void SettingsClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.changed) methods->changed = (decltype (methods->changed)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v key), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::changed_>;
  if (init_data.writable_change_event) methods->writable_change_event = (decltype (methods->writable_change_event)) gi::detail::method_wrapper<self, bool (*) (::GQuark key), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::writable_change_event_>;
  if (init_data.writable_changed) methods->writable_changed = (decltype (methods->writable_changed)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v key), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::writable_changed_>;
}
