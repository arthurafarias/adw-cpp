...
GI_MODULE_STATIC_OR_INLINE gint _field_error_code_get (const ::GDBusErrorEntry* obj) { return (gint) obj->error_code; }
...
GI_MODULE_STATIC_OR_INLINE void _field_error_code_set (::GDBusErrorEntry* obj, gint _value) { obj->error_code = (decltype(obj->error_code)) _value; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_dbus_error_name_get (const ::GDBusErrorEntry* obj) { return (const char*) obj->dbus_error_name; }
