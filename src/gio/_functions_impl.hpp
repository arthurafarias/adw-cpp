...
// void g_dbus_error_set_dbus_error (GError** error /*full,out,opt,nullable*/, const gchar* dbus_error_name /*none*/, const gchar* dbus_error_message /*none*/, const gchar* format /*none,nullable*/,  ..._ /*none*/);
// void g_dbus_error_set_dbus_error (::GError** error /*full,out,opt,nullable*/, const char* dbus_error_name /*none*/, const char* dbus_error_message /*none*/, const char* format /*none,nullable*/,  ..._ /*none*/);
// IGNORE; not introspectable, varargs not supported

// void g_dbus_error_set_dbus_error_valist (GError** error /*full,out,opt,nullable*/, const gchar* dbus_error_name /*none*/, const gchar* dbus_error_message /*none*/, const gchar* format /*none,nullable*/, va_list var_args /*none*/);
// void g_dbus_error_set_dbus_error_valist (::GError** error /*full,out,opt,nullable*/, const char* dbus_error_name /*none*/, const char* dbus_error_message /*none*/, const char* format /*none,nullable*/,  var_args /*none*/);
...
// gboolean g_resources_has_children (const char* path /*none*/);
// gboolean g_resources_has_children (const char* path /*none*/);
bool resources_has_children (const gi::cstring_v path) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* path);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_resources_has_children;
  auto path_to_c = gi::unwrap (path, gi::transfer_none);
