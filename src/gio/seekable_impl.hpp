...
void SeekableIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.truncate_fn) methods->truncate_fn = (decltype (methods->truncate_fn)) gi::detail::method_wrapper<self, bool (*) (gint64 offset, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::truncate_fn_>;
}
