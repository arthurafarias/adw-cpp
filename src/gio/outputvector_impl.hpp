...
GI_MODULE_STATIC_OR_INLINE gsize _field_size_get (const ::GOutputVector* obj) { return (gsize) obj->size; }
...
GI_MODULE_STATIC_OR_INLINE void _field_size_set (::GOutputVector* obj, gsize _value) { obj->size = (decltype(obj->size)) _value; }
