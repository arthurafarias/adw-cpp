...
// gboolean g_dtls_connection_get_channel_binding_data (::GDtlsConnection* conn /*none*/, ::GTlsChannelBindingType type, ::GByteArray* data /*none,out,opt,ca*/, GError ** error);
GI_INLINE_DECL bool get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::ByteArray * data);
GI_INLINE_DECL bool get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::ByteArray * data, GLib::Error * _error) noexcept;
GI_INLINE_DECL std::tuple<bool, GLib::ByteArray> get_channel_binding_data (Gio::TlsChannelBindingType type);
GI_INLINE_DECL std::tuple<bool, GLib::ByteArray> get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::Error * _error) noexcept;
