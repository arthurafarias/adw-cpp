...
void TlsClientConnectionInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.copy_session_state) methods->copy_session_state = (decltype (methods->copy_session_state)) gi::detail::method_wrapper<self, void (*) (Gio::TlsClientConnection source), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::copy_session_state_>;
}
