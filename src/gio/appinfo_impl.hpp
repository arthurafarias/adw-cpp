...
// const char** /*none,nullable*/ g_app_info_get_supported_types (GAppInfo* appinfo /*none*/);
// const char** /*none,nullable*/ g_app_info_get_supported_types (::GAppInfo* appinfo /*none*/);
...
void AppInfoIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.add_supports_type) methods->add_supports_type = (decltype (methods->add_supports_type)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v content_type, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::add_supports_type_>;
  if (init_data.can_delete) methods->can_delete = (decltype (methods->can_delete)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_delete_>;
  if (init_data.can_remove_supports_type) methods->can_remove_supports_type = (decltype (methods->can_remove_supports_type)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_remove_supports_type_>;
  if (init_data.do_delete) methods->do_delete = (decltype (methods->do_delete)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::do_delete_>;
  if (init_data.dup) methods->dup = (decltype (methods->dup)) gi::detail::method_wrapper<self, Gio::AppInfo (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::dup_>;
  if (init_data.equal) methods->equal = (decltype (methods->equal)) gi::detail::method_wrapper<self, bool (*) (Gio::AppInfo appinfo2), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::equal_>;
  if (init_data.get_commandline) methods->get_commandline = (decltype (methods->get_commandline)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_commandline_>;
  if (init_data.get_description) methods->get_description = (decltype (methods->get_description)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_description_>;
  if (init_data.get_display_name) methods->get_display_name = (decltype (methods->get_display_name)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_display_name_>;
  if (init_data.get_executable) methods->get_executable = (decltype (methods->get_executable)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_executable_>;
  if (init_data.get_icon) methods->get_icon = (decltype (methods->get_icon)) gi::detail::method_wrapper<self, Gio::Icon (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_icon_>;
  if (init_data.get_id) methods->get_id = (decltype (methods->get_id)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_id_>;
  if (init_data.get_name) methods->get_name = (decltype (methods->get_name)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_name_>;
  if (init_data.get_supported_types) methods->get_supported_types = (decltype (methods->get_supported_types)) gi::detail::method_wrapper<self, gi::Collection<gi::ZTSpan, char*, gi::transfer_none_t> (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_supported_types_>;
  if (init_data.launch) methods->launch = (decltype (methods->launch)) gi::detail::method_wrapper<self, bool (*) (gi::Collection<GList, ::GFile*, gi::transfer_none_t> files, Gio::AppLaunchContext context, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::launch_>;
  if (init_data.launch_uris) methods->launch_uris = (decltype (methods->launch_uris)) gi::detail::method_wrapper<self, bool (*) (gi::Collection<GList, char*, gi::transfer_none_t> uris, Gio::AppLaunchContext context, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::launch_uris_>;
  if (init_data.launch_uris_async) methods->launch_uris_async = (decltype (methods->launch_uris_async)) gi::detail::method_wrapper<self, void (*) (gi::Collection<GList, char*, gi::transfer_none_t> uris, Gio::AppLaunchContext context, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<3, 4>>>, void  (::GList* uris, ::GAppLaunchContext* context, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::launch_uris_async_>;
  if (init_data.launch_uris_finish) methods->launch_uris_finish = (decltype (methods->launch_uris_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::launch_uris_finish_>;
  if (init_data.remove_supports_type) methods->remove_supports_type = (decltype (methods->remove_supports_type)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v content_type, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::remove_supports_type_>;
  if (init_data.set_as_default_for_extension) methods->set_as_default_for_extension = (decltype (methods->set_as_default_for_extension)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v extension, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::set_as_default_for_extension_>;
  if (init_data.set_as_default_for_type) methods->set_as_default_for_type = (decltype (methods->set_as_default_for_type)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v content_type, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::set_as_default_for_type_>;
  if (init_data.set_as_last_used_for_type) methods->set_as_last_used_for_type = (decltype (methods->set_as_last_used_for_type)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v content_type, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::set_as_last_used_for_type_>;
  if (init_data.should_show) methods->should_show = (decltype (methods->should_show)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::should_show_>;
  if (init_data.supports_files) methods->supports_files = (decltype (methods->supports_files)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::supports_files_>;
  if (init_data.supports_uris) methods->supports_uris = (decltype (methods->supports_uris)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::supports_uris_>;
}
...
// const char** /*none,nullable*/ AppInfo::get_supported_types (GAppInfo* appinfo /*none*/);
// const char** /*none,nullable*/ AppInfo::get_supported_types (::GAppInfo* appinfo /*none*/);
