...
void ProxyInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.connect) methods->connect = (decltype (methods->connect)) gi::detail::method_wrapper<self, Gio::IOStream (*) (Gio::IOStream connection, Gio::ProxyAddress proxy_address, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::connect_>;
  if (init_data.connect_async) methods->connect_async = (decltype (methods->connect_async)) gi::detail::method_wrapper<self, void (*) (Gio::IOStream connection, Gio::ProxyAddress proxy_address, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<3, 4>>>, void  (::GIOStream* connection, ::GProxyAddress* proxy_address, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::connect_async_>;
  if (init_data.connect_finish) methods->connect_finish = (decltype (methods->connect_finish)) gi::detail::method_wrapper<self, Gio::IOStream (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::connect_finish_>;
  if (init_data.supports_hostname) methods->supports_hostname = (decltype (methods->supports_hostname)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::supports_hostname_>;
}
