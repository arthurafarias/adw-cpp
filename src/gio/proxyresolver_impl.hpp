...
void ProxyResolverInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.is_supported) methods->is_supported = (decltype (methods->is_supported)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::is_supported_>;
  if (init_data.lookup) methods->lookup = (decltype (methods->lookup)) gi::detail::method_wrapper<self, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> (*) (const gi::cstring_v uri, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::lookup_>;
  if (init_data.lookup_async) methods->lookup_async = (decltype (methods->lookup_async)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v uri, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<2, 3>>>, void  (const char* uri, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::lookup_async_>;
  if (init_data.lookup_finish) methods->lookup_finish = (decltype (methods->lookup_finish)) gi::detail::method_wrapper<self, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::lookup_finish_>;
}
