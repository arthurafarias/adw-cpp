...
void NetworkMonitorInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.can_reach) methods->can_reach = (decltype (methods->can_reach)) gi::detail::method_wrapper<self, bool (*) (Gio::SocketConnectable connectable, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::can_reach_>;
  if (init_data.can_reach_async) methods->can_reach_async = (decltype (methods->can_reach_async)) gi::detail::method_wrapper<self, void (*) (Gio::SocketConnectable connectable, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<2, 3>>>, void  (::GSocketConnectable* connectable, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::can_reach_async_>;
  if (init_data.can_reach_finish) methods->can_reach_finish = (decltype (methods->can_reach_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::can_reach_finish_>;
  if (init_data.network_changed) methods->network_changed = (decltype (methods->network_changed)) gi::detail::method_wrapper<self, void (*) (gboolean network_available), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::network_changed_>;
}
