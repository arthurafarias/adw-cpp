...
// pid_t g_credentials_get_unix_pid (::GCredentials* credentials /*none*/, GError ** error);
pid_t base::CredentialsBase::get_unix_pid ()
{
  typedef pid_t (*call_wrap_t) (::GCredentials* credentials, GError ** error);
...
pid_t base::CredentialsBase::get_unix_pid (GLib::Error * _error) noexcept
{
  typedef pid_t (*call_wrap_t) (::GCredentials* credentials, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_credentials_get_unix_pid;
  GError* _error_o {};
...
// uid_t g_credentials_get_unix_user (::GCredentials* credentials /*none*/, GError ** error);
uid_t base::CredentialsBase::get_unix_user ()
{
  typedef uid_t (*call_wrap_t) (::GCredentials* credentials, GError ** error);
...
uid_t base::CredentialsBase::get_unix_user (GLib::Error * _error) noexcept
{
  typedef uid_t (*call_wrap_t) (::GCredentials* credentials, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_credentials_get_unix_user;
  GError* _error_o {};
...
// gboolean g_credentials_set_unix_user (::GCredentials* credentials /*none*/, uid_t uid, GError ** error);
bool base::CredentialsBase::set_unix_user (uid_t uid)
{
  typedef gboolean (*call_wrap_t) (::GCredentials* credentials, uid_t uid, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_credentials_set_unix_user;
  auto uid_to_c = uid;
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::GCredentials*) (gobj_()), (uid_t) (uid_to_c), &error);
  gi::check_error (error);
  return _temp_ret;
}
bool base::CredentialsBase::set_unix_user (uid_t uid, GLib::Error * _error) noexcept
{
  typedef gboolean (*call_wrap_t) (::GCredentials* credentials, uid_t uid, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_credentials_set_unix_user;
  auto uid_to_c = uid;
  GError* _error_o {};
  auto _temp_ret = call_wrap_v ((::GCredentials*) (gobj_()), (uid_t) (uid_to_c), _error ? &_error_o : nullptr);
  if (_error) *_error = gi::wrap (_error_o, gi::transfer_full);
  return _temp_ret;
}
