...
GI_INLINE_DECL gint get_os () noexcept;
...
GI_INLINE_DECL void set_os (gint os) noexcept;
...
gi::property_proxy<gint, base::ZlibCompressorBase> property_os()
{ return gi::property_proxy<gint, base::ZlibCompressorBase> (*this, "os"); }
const gi::property_proxy<gint, base::ZlibCompressorBase> property_os() const
{ return gi::property_proxy<gint, base::ZlibCompressorBase> (*this, "os"); }
