...
GI_MODULE_STATIC_OR_INLINE gint _field_ref_count_get (const ::GDBusPropertyInfo* obj) { return (gint) obj->ref_count; }
...
GI_MODULE_STATIC_OR_INLINE void _field_ref_count_set (::GDBusPropertyInfo* obj, gint _value) { obj->ref_count = (decltype(obj->ref_count)) _value; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_name_get (const ::GDBusPropertyInfo* obj) { return (char*) obj->name; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_signature_get (const ::GDBusPropertyInfo* obj) { return (char*) obj->signature; }
...
GI_MODULE_STATIC_OR_INLINE ::GDBusPropertyInfoFlags _field_flags_get (const ::GDBusPropertyInfo* obj) { return (::GDBusPropertyInfoFlags) obj->flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_flags_set (::GDBusPropertyInfo* obj, ::GDBusPropertyInfoFlags _value) { obj->flags = (decltype(obj->flags)) _value; }
