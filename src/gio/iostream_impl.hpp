...
void IOStreamClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.get_input_stream) methods->get_input_stream = (decltype (methods->get_input_stream)) gi::detail::method_wrapper<self, Gio::InputStream (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_input_stream_>;
  if (init_data.get_output_stream) methods->get_output_stream = (decltype (methods->get_output_stream)) gi::detail::method_wrapper<self, Gio::OutputStream (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_output_stream_>;
}
