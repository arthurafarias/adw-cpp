...
// gboolean g_tls_connection_get_channel_binding_data (GTlsConnection* conn /*none*/, GTlsChannelBindingType type, GByteArray* data /*none,out,opt,ca*/, GError ** error);
// gboolean g_tls_connection_get_channel_binding_data (::GTlsConnection* conn /*none*/, ::GTlsChannelBindingType type, ::GByteArray* data /*none,out,opt,ca*/, GError ** error);
bool base::TlsConnectionBase::get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::ByteArray * data)
{
  typedef gboolean (*call_wrap_t) (::GTlsConnection* conn, ::GTlsChannelBindingType type, ::GByteArray* data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_tls_connection_get_channel_binding_data;
  static_assert(sizeof(::GByteArray) == sizeof(*(*data).gobj_()), "");
  auto type_to_c = gi::unwrap (type);
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::GTlsConnection*) (gobj_()), (::GTlsChannelBindingType) (type_to_c), (::GByteArray*) (data ? (::GByteArray*) (*data).gobj_() : nullptr), &error);
  gi::check_error (error);
  return _temp_ret;
}
bool base::TlsConnectionBase::get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::ByteArray * data, GLib::Error * _error) noexcept
{
  typedef gboolean (*call_wrap_t) (::GTlsConnection* conn, ::GTlsChannelBindingType type, ::GByteArray* data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_tls_connection_get_channel_binding_data;
  static_assert(sizeof(::GByteArray) == sizeof(*(*data).gobj_()), "");
  auto type_to_c = gi::unwrap (type);
  GError* _error_o {};
  auto _temp_ret = call_wrap_v ((::GTlsConnection*) (gobj_()), (::GTlsChannelBindingType) (type_to_c), (::GByteArray*) (data ? (::GByteArray*) (*data).gobj_() : nullptr), _error ? &_error_o : nullptr);
  if (_error) *_error = gi::wrap (_error_o, gi::transfer_full);
  return _temp_ret;
}
std::tuple<bool, GLib::ByteArray> base::TlsConnectionBase::get_channel_binding_data (Gio::TlsChannelBindingType type)
{
  typedef gboolean (*call_wrap_t) (::GTlsConnection* conn, ::GTlsChannelBindingType type, ::GByteArray* data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_tls_connection_get_channel_binding_data;
...
std::tuple<bool, GLib::ByteArray> base::TlsConnectionBase::get_channel_binding_data (Gio::TlsChannelBindingType type, GLib::Error * _error) noexcept
{
  typedef gboolean (*call_wrap_t) (::GTlsConnection* conn, ::GTlsChannelBindingType type, ::GByteArray* data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_tls_connection_get_channel_binding_data;
  GLib::ByteArray data_c;
