...
GI_INLINE_DECL guint register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info, GObject::Closure_Ref method_call_closure, GObject::Closure_Ref get_property_closure, GObject::Closure_Ref set_property_closure);
GI_INLINE_DECL guint register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info);
GI_INLINE_DECL guint register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info, GObject::Closure_Ref method_call_closure, GObject::Closure_Ref get_property_closure, GObject::Closure_Ref set_property_closure, GLib::Error * _error) noexcept;
GI_INLINE_DECL guint register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info, GLib::Error * _error) noexcept;
