...
enum class EcnCodePoint : std::underlying_type<GEcnCodePoint>::type {
  NO_ECN_ = G_ECN_NO_ECN,
  ECT_1_ = G_ECN_ECT_1,
  ECT_0_ = G_ECN_ECT_0,
  ECT_CE_ = G_ECN_ECT_CE,
};
...
template<> struct declare_ctype_of<Gio::EcnCodePoint>
{ typedef GEcnCodePoint type; }; 
template<> struct declare_cpptype_of<GEcnCodePoint>
{ typedef Gio::EcnCodePoint type; }; 

template<> struct declare_gtype_of<Gio::EcnCodePoint>
{ static GType get_type() { return g_ecn_code_point_get_type(); } };
