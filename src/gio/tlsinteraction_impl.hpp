...
void TlsInteractionClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.ask_password) methods->ask_password = (decltype (methods->ask_password)) gi::detail::method_wrapper<self, Gio::TlsInteractionResult (*) (Gio::TlsPassword password, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::ask_password_>;
  if (init_data.ask_password_async) methods->ask_password_async = (decltype (methods->ask_password_async)) gi::detail::method_wrapper<self, void (*) (Gio::TlsPassword password, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<2, 3>>>, void  (::GTlsPassword* password, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::ask_password_async_>;
  if (init_data.ask_password_finish) methods->ask_password_finish = (decltype (methods->ask_password_finish)) gi::detail::method_wrapper<self, Gio::TlsInteractionResult (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::ask_password_finish_>;
  if (init_data.request_certificate) methods->request_certificate = (decltype (methods->request_certificate)) gi::detail::method_wrapper<self, Gio::TlsInteractionResult (*) (Gio::TlsConnection connection, Gio::TlsCertificateRequestFlags flags, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::request_certificate_>;
  if (init_data.request_certificate_async) methods->request_certificate_async = (decltype (methods->request_certificate_async)) gi::detail::method_wrapper<self, void (*) (Gio::TlsConnection connection, Gio::TlsCertificateRequestFlags flags, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<3, 4>>>, void  (::GTlsConnection* connection, ::GTlsCertificateRequestFlags flags, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::request_certificate_async_>;
  if (init_data.request_certificate_finish) methods->request_certificate_finish = (decltype (methods->request_certificate_finish)) gi::detail::method_wrapper<self, Gio::TlsInteractionResult (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::request_certificate_finish_>;
}
