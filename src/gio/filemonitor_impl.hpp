...
// void g_file_monitor_emit_event (GFileMonitor* monitor /*none*/, GFile* child /*none*/, GFile* other_file /*none,nullable*/, GFileMonitorEvent event_type);
// void g_file_monitor_emit_event (::GFileMonitor* monitor /*none*/, ::GFile* child /*none*/, ::GFile* other_file /*none,nullable*/, ::GFileMonitorEvent event_type);
...
void base::FileMonitorBase::emit_event (Gio::File child, Gio::FileMonitorEvent event_type) noexcept
{
  typedef void (*call_wrap_t) (::GFileMonitor* monitor, ::GFile* child, ::GFile* other_file, ::GFileMonitorEvent event_type);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_file_monitor_emit_event;
  auto event_type_to_c = gi::unwrap (event_type);
  auto other_file_to_c = nullptr;
  auto child_to_c = gi::unwrap (child, gi::transfer_none);
  call_wrap_v ((::GFileMonitor*) (gobj_()), (::GFile*) (child_to_c), (::GFile*) (other_file_to_c), (::GFileMonitorEvent) (event_type_to_c));
}
...
void FileMonitorClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.cancel) methods->cancel = (decltype (methods->cancel)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::cancel_>;
  if (init_data.changed) methods->changed = (decltype (methods->changed)) gi::detail::method_wrapper<self, void (*) (Gio::File file, Gio::File other_file, Gio::FileMonitorEvent event_type), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::changed_>;
}
