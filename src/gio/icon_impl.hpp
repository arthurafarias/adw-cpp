...
void IconIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.equal) methods->equal = (decltype (methods->equal)) gi::detail::method_wrapper<self, bool (*) (Gio::Icon icon2), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::equal_>;
  ...
  if (init_data.serialize) methods->serialize = (decltype (methods->serialize)) gi::detail::method_wrapper<self, GLib::Variant (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::serialize_>;
}
