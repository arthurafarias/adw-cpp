...
GI_MODULE_STATIC_OR_INLINE ::GFileAttributeInfo* _field_infos_get (const ::GFileAttributeInfoList* obj) { return (::GFileAttributeInfo*) obj->infos; }
...
GI_MODULE_STATIC_OR_INLINE gint _field_n_infos_get (const ::GFileAttributeInfoList* obj) { return (gint) obj->n_infos; }
...
GI_MODULE_STATIC_OR_INLINE void _field_n_infos_set (::GFileAttributeInfoList* obj, gint _value) { obj->n_infos = (decltype(obj->n_infos)) _value; }
