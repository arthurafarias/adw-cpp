...
void FileOutputStreamClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.can_seek) methods->can_seek = (decltype (methods->can_seek)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_seek_>;
  if (init_data.can_truncate) methods->can_truncate = (decltype (methods->can_truncate)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_truncate_>;
  if (init_data.get_etag) methods->get_etag = (decltype (methods->get_etag)) gi::detail::method_wrapper<self, gi::cstring (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_etag_>;
  if (init_data.query_info) methods->query_info = (decltype (methods->query_info)) gi::detail::method_wrapper<self, Gio::FileInfo (*) (const gi::cstring_v attributes, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::query_info_>;
  ...
  if (init_data.query_info_finish) methods->query_info_finish = (decltype (methods->query_info_finish)) gi::detail::method_wrapper<self, Gio::FileInfo (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::query_info_finish_>;
  if (init_data.seek) methods->seek = (decltype (methods->seek)) gi::detail::method_wrapper<self, bool (*) (gint64 offset, GLib::SeekType type, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::seek_>;
  if (init_data.tell) methods->tell = (decltype (methods->tell)) gi::detail::method_wrapper<self, gint64 (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::tell_>;
  if (init_data.truncate_fn) methods->truncate_fn = (decltype (methods->truncate_fn)) gi::detail::method_wrapper<self, bool (*) (gint64 size, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::truncate_fn_>;
}
