...
// typedef GVariant* /*full*/ (*GDBusInterfaceGetPropertyFunc) (GDBusConnection* connection /*none*/, const gchar* sender /*none,nullable*/, const gchar* object_path /*none*/, const gchar* interface_name /*none*/, const gchar* property_name /*none*/, GError** error /*none*/, gpointer user_data);
// typedef ::GVariant* /*full*/ (*GDBusInterfaceGetPropertyFunc) (::GDBusConnection* connection /*none*/, const char* sender /*none,nullable*/, const char* object_path /*none*/, const char* interface_name /*none*/, const char* property_name /*none*/, ::GError* error /*none*/, void* user_data);
// SKIP; inconsistent error in pointer depth (2 vs 1)

// typedef void (*GDBusInterfaceMethodCallFunc) (GDBusConnection* connection /*none*/, const gchar* sender /*none,nullable*/, const gchar* object_path /*none*/, const gchar* interface_name /*none,nullable*/, const gchar* method_name /*none*/, GVariant* parameters /*none*/, GDBusMethodInvocation* invocation /*full*/, gpointer user_data);
// typedef void (*GDBusInterfaceMethodCallFunc) (::GDBusConnection* connection /*none*/, const char* sender /*none,nullable*/, const char* object_path /*none*/, const char* interface_name /*none,nullable*/, const char* method_name /*none*/, ::GVariant* parameters /*none*/, ::GDBusMethodInvocation* invocation /*full*/, void* user_data);
namespace internal {
...
// typedef gboolean (*GDBusInterfaceSetPropertyFunc) (GDBusConnection* connection /*none*/, const gchar* sender /*none,nullable*/, const gchar* object_path /*none*/, const gchar* interface_name /*none*/, const gchar* property_name /*none*/, GVariant* value /*none*/, GError** error /*none*/, gpointer user_data);
// typedef gboolean (*GDBusInterfaceSetPropertyFunc) (::GDBusConnection* connection /*none*/, const char* sender /*none,nullable*/, const char* object_path /*none*/, const char* interface_name /*none*/, const char* property_name /*none*/, ::GVariant* value /*none*/, ::GError* error /*none*/, void* user_data);
// SKIP; inconsistent error in pointer depth (2 vs 1)
...
// typedef GVariant* /*full,nullable*/ (*GSettingsBindSetMapping) (const GValue* value /*none*/, const GVariantType* expected_type /*none*/, gpointer user_data);
// typedef ::GVariant* /*full,nullable*/ (*GSettingsBindSetMapping) (const ::GValue* value /*none*/, const ::GVariantType* expected_type /*none*/, void* user_data);
namespace internal {
...
// typedef gboolean (*GSettingsGetMapping) (GVariant* value /*none,nullable*/, gpointer* result, gpointer user_data);
// typedef gboolean (*GSettingsGetMapping) (::GVariant* value /*none,nullable*/, void** result, void* user_data);
namespace internal {
...
// typedef GFile* /*full,nullable*/ (*GVfsFileLookupFunc) (GVfs* vfs /*none*/, const char* identifier /*none*/, gpointer user_data);
// typedef ::GFile* /*full,nullable*/ (*GVfsFileLookupFunc) (::GVfs* vfs /*none*/, const char* identifier /*none*/, void* user_data);
namespace internal {
