...
void VolumeIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.can_mount) methods->can_mount = (decltype (methods->can_mount)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::can_mount_>;
  ...
  if (init_data.get_activation_root) methods->get_activation_root = (decltype (methods->get_activation_root)) gi::detail::method_wrapper<self, Gio::File (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_activation_root_>;
  ...
  if (init_data.get_mount) methods->get_mount = (decltype (methods->get_mount)) gi::detail::method_wrapper<self, Gio::Mount (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_mount_>;
  ...
  if (init_data.mount_finish) methods->mount_finish = (decltype (methods->mount_finish)) gi::detail::method_wrapper<self, bool (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::mount_finish_>;
  if (init_data.mount_fn) methods->mount_fn = (decltype (methods->mount_fn)) gi::detail::method_wrapper<self, void (*) (Gio::MountMountFlags flags, Gio::MountOperation mount_operation, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<3, 4>>>, void  (::GMountMountFlags flags, ::GMountOperation* mount_operation, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::mount_fn_>;
  if (init_data.removed) methods->removed = (decltype (methods->removed)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::removed_>;
  if (init_data.should_automount) methods->should_automount = (decltype (methods->should_automount)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::should_automount_>;
}
