...
// const gchar* const* /*none,nullable*/ g_application_command_line_get_environ (GApplicationCommandLine* cmdline /*none*/);
// const char** /*none,nullable*/ g_application_command_line_get_environ (::GApplicationCommandLine* cmdline /*none*/);
...
void ApplicationCommandLineClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.done) methods->done = (decltype (methods->done)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::done_>;
  if (init_data.get_stdin) methods->get_stdin = (decltype (methods->get_stdin)) gi::detail::method_wrapper<self, Gio::InputStream (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_stdin_>;
  if (init_data.print_literal) methods->print_literal = (decltype (methods->print_literal)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v message), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::print_literal_>;
  if (init_data.printerr_literal) methods->printerr_literal = (decltype (methods->printerr_literal)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v message), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::printerr_literal_>;
}
