...
GI_MODULE_STATIC_OR_INLINE gint _field_ref_count_get (const ::GDBusNodeInfo* obj) { return (gint) obj->ref_count; }
...
GI_MODULE_STATIC_OR_INLINE void _field_ref_count_set (::GDBusNodeInfo* obj, gint _value) { obj->ref_count = (decltype(obj->ref_count)) _value; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_path_get (const ::GDBusNodeInfo* obj) { return (char*) obj->path; }
