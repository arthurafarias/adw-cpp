...
GI_MODULE_STATIC_OR_INLINE char* _field_name_get (const ::GFileAttributeInfo* obj) { return (char*) obj->name; }
...
GI_MODULE_STATIC_OR_INLINE ::GFileAttributeType _field_type_get (const ::GFileAttributeInfo* obj) { return (::GFileAttributeType) obj->type; }
...
GI_MODULE_STATIC_OR_INLINE void _field_type_set (::GFileAttributeInfo* obj, ::GFileAttributeType _value) { obj->type = (decltype(obj->type)) _value; }
...
GI_MODULE_STATIC_OR_INLINE ::GFileAttributeInfoFlags _field_flags_get (const ::GFileAttributeInfo* obj) { return (::GFileAttributeInfoFlags) obj->flags; }
...
GI_MODULE_STATIC_OR_INLINE void _field_flags_set (::GFileAttributeInfo* obj, ::GFileAttributeInfoFlags _value) { obj->flags = (decltype(obj->flags)) _value; }
