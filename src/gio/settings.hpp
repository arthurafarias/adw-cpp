...
// void g_settings_bind_with_mapping_closures (::GSettings* settings /*none*/, const char* key /*none*/, ::GObject* object /*none*/, const char* property /*none*/, ::GSettingsBindFlags flags, ::GClosure* get_mapping /*none,nullable*/, ::GClosure* set_mapping /*none,nullable*/);
GI_INLINE_DECL void bind_with_mapping (const gi::cstring_v key, GObject::Object object, const gi::cstring_v property, Gio::SettingsBindFlags flags, GObject::Closure_Ref get_mapping, GObject::Closure_Ref set_mapping) noexcept;
GI_INLINE_DECL void bind_with_mapping (const gi::cstring_v key, GObject::Object object, const gi::cstring_v property, Gio::SettingsBindFlags flags) noexcept;
