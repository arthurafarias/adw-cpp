...
void LoadableIconIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.load) methods->load = (decltype (methods->load)) gi::detail::method_wrapper<self, Gio::InputStream (*) (gint size, gi::cstring & type, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::load_>;
  if (init_data.load_async) methods->load_async = (decltype (methods->load_async)) gi::detail::method_wrapper<self, void (*) (gint size, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<2, 3>>>, void  (gint size, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::load_async_>;
  if (init_data.load_finish) methods->load_finish = (decltype (methods->load_finish)) gi::detail::method_wrapper<self, Gio::InputStream (*) (Gio::AsyncResult res, gi::cstring & type, GLib::Error * _error), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::load_finish_>;
}
