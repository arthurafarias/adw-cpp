...
// gboolean g_resource_has_children (GResource* resource /*none*/, const char* path /*none*/);
// gboolean g_resource_has_children (::GResource* resource /*none*/, const char* path /*none*/);
bool base::ResourceBase::has_children (const gi::cstring_v path) noexcept
{
  typedef gboolean (*call_wrap_t) (::GResource* resource, const char* path);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_resource_has_children;
  auto path_to_c = gi::unwrap (path, gi::transfer_none);
  auto _temp_ret = call_wrap_v ((::GResource*) (gobj_()), (const char*) (path_to_c));
  return _temp_ret;
}
