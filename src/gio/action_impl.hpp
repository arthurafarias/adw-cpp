...
void ActionInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.activate) methods->activate = (decltype (methods->activate)) gi::detail::method_wrapper<self, void (*) (GLib::Variant parameter), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::activate_>;
  if (init_data.change_state) methods->change_state = (decltype (methods->change_state)) gi::detail::method_wrapper<self, void (*) (GLib::Variant value), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::change_state_>;
  if (init_data.get_enabled) methods->get_enabled = (decltype (methods->get_enabled)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_enabled_>;
  ...
  if (init_data.get_parameter_type) methods->get_parameter_type = (decltype (methods->get_parameter_type)) gi::detail::method_wrapper<self, GLib::VariantType_Ref (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_parameter_type_>;
  if (init_data.get_state) methods->get_state = (decltype (methods->get_state)) gi::detail::method_wrapper<self, GLib::Variant (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_state_>;
  if (init_data.get_state_hint) methods->get_state_hint = (decltype (methods->get_state_hint)) gi::detail::method_wrapper<self, GLib::Variant (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_state_hint_>;
  if (init_data.get_state_type) methods->get_state_type = (decltype (methods->get_state_type)) gi::detail::method_wrapper<self, GLib::VariantType_Ref (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_state_type_>;
}
