...
// GVariant* /*full*/ g_dbus_connection_call_with_unix_fd_list_finish (GDBusConnection* connection /*none*/, GUnixFDList** out_fd_list /*full,out,opt,nullable*/, GAsyncResult* res /*none*/, GError ** error);
// ::GVariant* /*full*/ g_dbus_connection_call_with_unix_fd_list_finish (::GDBusConnection* connection /*none*/, ::GUnixFDList** out_fd_list /*full,out,opt,nullable*/, ::GAsyncResult* res /*none*/, GError ** error);
...
// guint g_dbus_connection_register_object_with_closures2 (GDBusConnection* connection /*none*/, const gchar* object_path /*none*/, GDBusInterfaceInfo* interface_info /*none*/, GClosure* method_call_closure /*none,nullable*/, GClosure* get_property_closure /*none,nullable*/, GClosure* set_property_closure /*none,nullable*/, GError ** error);
// guint g_dbus_connection_register_object_with_closures2 (::GDBusConnection* connection /*none*/, const char* object_path /*none*/, ::GDBusInterfaceInfo* interface_info /*none*/, ::GClosure* method_call_closure /*none,nullable*/, ::GClosure* get_property_closure /*none,nullable*/, ::GClosure* set_property_closure /*none,nullable*/, GError ** error);
guint base::DBusConnectionBase::register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info, GObject::Closure_Ref method_call_closure, GObject::Closure_Ref get_property_closure, GObject::Closure_Ref set_property_closure)
{
  ...
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_connection_register_object_with_closures2;
...
guint base::DBusConnectionBase::register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info)
{
  typedef guint (*call_wrap_t) (::GDBusConnection* connection, const char* object_path, ::GDBusInterfaceInfo* interface_info, ::GClosure* method_call_closure, ::GClosure* get_property_closure, ::GClosure* set_property_closure, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_connection_register_object_with_closures2;
...
guint base::DBusConnectionBase::register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info, GObject::Closure_Ref method_call_closure, GObject::Closure_Ref get_property_closure, GObject::Closure_Ref set_property_closure, GLib::Error * _error) noexcept
{
  typedef guint (*call_wrap_t) (::GDBusConnection* connection, const char* object_path, ::GDBusInterfaceInfo* interface_info, ::GClosure* method_call_closure, ::GClosure* get_property_closure, ::GClosure* set_property_closure, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_connection_register_object_with_closures2;
  auto set_property_closure_to_c = gi::unwrap (set_property_closure, gi::transfer_none);
...
guint base::DBusConnectionBase::register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info, GLib::Error * _error) noexcept
{
  typedef guint (*call_wrap_t) (::GDBusConnection* connection, const char* object_path, ::GDBusInterfaceInfo* interface_info, ::GClosure* method_call_closure, ::GClosure* get_property_closure, ::GClosure* set_property_closure, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_connection_register_object_with_closures2;
  auto set_property_closure_to_c = nullptr;
