...
void VfsClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.add_writable_namespaces) methods->add_writable_namespaces = (decltype (methods->add_writable_namespaces)) gi::detail::method_wrapper<self, void (*) (Gio::FileAttributeInfoList_Ref list), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::add_writable_namespaces_>;
  if (init_data.get_file_for_path) methods->get_file_for_path = (decltype (methods->get_file_for_path)) gi::detail::method_wrapper<self, Gio::File (*) (const gi::cstring_v path), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_file_for_path_>;
  if (init_data.get_file_for_uri) methods->get_file_for_uri = (decltype (methods->get_file_for_uri)) gi::detail::method_wrapper<self, Gio::File (*) (const gi::cstring_v uri), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_file_for_uri_>;
  if (init_data.get_supported_uri_schemes) methods->get_supported_uri_schemes = (decltype (methods->get_supported_uri_schemes)) gi::detail::method_wrapper<self, gi::Collection<gi::ZTSpan, char*, gi::transfer_none_t> (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_supported_uri_schemes_>;
  if (init_data.is_active) methods->is_active = (decltype (methods->is_active)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::is_active_>;
  if (init_data.local_file_moved) methods->local_file_moved = (decltype (methods->local_file_moved)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v source, const gi::cstring_v dest), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::local_file_moved_>;
  if (init_data.local_file_removed) methods->local_file_removed = (decltype (methods->local_file_removed)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v filename), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::local_file_removed_>;
  if (init_data.local_file_set_attributes) methods->local_file_set_attributes = (decltype (methods->local_file_set_attributes)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v filename, Gio::FileInfo info, Gio::FileQueryInfoFlags flags, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::local_file_set_attributes_>;
  if (init_data.parse_name) methods->parse_name = (decltype (methods->parse_name)) gi::detail::method_wrapper<self, Gio::File (*) (const gi::cstring_v parse_name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::parse_name_>;
}
