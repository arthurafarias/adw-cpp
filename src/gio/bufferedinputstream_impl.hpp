...
void BufferedInputStreamClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.fill) methods->fill = (decltype (methods->fill)) gi::detail::method_wrapper<self, gssize (*) (gssize count, Gio::Cancellable cancellable, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::fill_>;
  if (init_data.fill_async) methods->fill_async = (decltype (methods->fill_async)) gi::detail::method_wrapper<self, void (*) (gssize count, gint io_priority, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>, detail::arg_info<gi::transfer_none_t, false, Gio::internal::AsyncReadyCallback_CB_Trait, detail::args_index<3, 4>>>, void  (gssize count, gint io_priority, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data)>::wrapper<&self::fill_async_>;
  if (init_data.fill_finish) methods->fill_finish = (decltype (methods->fill_finish)) gi::detail::method_wrapper<self, gssize (*) (Gio::AsyncResult result, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::fill_finish_>;
}
