...
void DebugControllerDBusClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.authorize) methods->authorize = (decltype (methods->authorize)) gi::detail::method_wrapper<self, bool (*) (Gio::DBusMethodInvocation invocation), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::authorize_>;
}
