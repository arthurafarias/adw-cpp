...
void SocketListenerClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.event) methods->event = (decltype (methods->event)) gi::detail::method_wrapper<self, void (*) (Gio::SocketListenerEvent event, Gio::Socket socket), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::event_>;
}
