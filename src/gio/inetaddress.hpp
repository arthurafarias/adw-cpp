...
gi::property_proxy<guint, base::InetAddressBase> property_flowinfo()
{ return gi::property_proxy<guint, base::InetAddressBase> (*this, "flowinfo"); }
const gi::property_proxy<guint, base::InetAddressBase> property_flowinfo() const
{ return gi::property_proxy<guint, base::InetAddressBase> (*this, "flowinfo"); }
...
gi::property_proxy<guint, base::InetAddressBase> property_scope_id()
{ return gi::property_proxy<guint, base::InetAddressBase> (*this, "scope-id"); }
const gi::property_proxy<guint, base::InetAddressBase> property_scope_id() const
{ return gi::property_proxy<guint, base::InetAddressBase> (*this, "scope-id"); }
