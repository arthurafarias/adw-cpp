...
// GBytes* /*full*/ g_converter_convert_bytes (GConverter* converter /*none*/, GBytes* bytes /*none*/, GError ** error);
// ::GBytes* /*full*/ g_converter_convert_bytes (::GConverter* converter /*none*/, ::GBytes* bytes /*none*/, GError ** error);
GLib::Bytes base::ConverterBase::convert_bytes (GLib::Bytes_Ref bytes)
{
  typedef ::GBytes* (*call_wrap_t) (::GConverter* converter, ::GBytes* bytes, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_converter_convert_bytes;
  auto bytes_to_c = gi::unwrap (bytes, gi::transfer_none);
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::GConverter*) (gobj_()), (::GBytes*) (bytes_to_c), &error);
  gi::check_error (error);
  return gi::wrap (_temp_ret, gi::transfer_full);
}
GLib::Bytes base::ConverterBase::convert_bytes (GLib::Bytes_Ref bytes, GLib::Error * _error) noexcept
{
  typedef ::GBytes* (*call_wrap_t) (::GConverter* converter, ::GBytes* bytes, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_converter_convert_bytes;
  auto bytes_to_c = gi::unwrap (bytes, gi::transfer_none);
  GError* _error_o {};
  auto _temp_ret = call_wrap_v ((::GConverter*) (gobj_()), (::GBytes*) (bytes_to_c), _error ? &_error_o : nullptr);
  if (_error) *_error = gi::wrap (_error_o, gi::transfer_full);
  return gi::wrap (_temp_ret, gi::transfer_full);
}
...
void ConverterIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.convert) methods->convert = (decltype (methods->convert)) gi::detail::method_wrapper<self, Gio::ConverterResult (*) (const guint8 * inbuf, gsize inbuf_size, const guint8 * outbuf, gsize outbuf_size, Gio::ConverterFlags flags, gsize & bytes_read, gsize & bytes_written, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::convert_>;
