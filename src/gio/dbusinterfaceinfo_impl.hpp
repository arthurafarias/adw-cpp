...
GI_MODULE_STATIC_OR_INLINE gint _field_ref_count_get (const ::GDBusInterfaceInfo* obj) { return (gint) obj->ref_count; }
...
GI_MODULE_STATIC_OR_INLINE void _field_ref_count_set (::GDBusInterfaceInfo* obj, gint _value) { obj->ref_count = (decltype(obj->ref_count)) _value; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_name_get (const ::GDBusInterfaceInfo* obj) { return (char*) obj->name; }
