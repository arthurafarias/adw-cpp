...
void TlsCertificateClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.verify) methods->verify = (decltype (methods->verify)) gi::detail::method_wrapper<self, Gio::TlsCertificateFlags (*) (Gio::SocketConnectable identity, Gio::TlsCertificate trusted_ca), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::verify_>;
}
