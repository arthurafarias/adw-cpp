...
GI_MODULE_STATIC_OR_INLINE gint _field_ref_count_get (const ::GDBusAnnotationInfo* obj) { return (gint) obj->ref_count; }
...
GI_MODULE_STATIC_OR_INLINE void _field_ref_count_set (::GDBusAnnotationInfo* obj, gint _value) { obj->ref_count = (decltype(obj->ref_count)) _value; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_key_get (const ::GDBusAnnotationInfo* obj) { return (char*) obj->key; }
...
GI_MODULE_STATIC_OR_INLINE char* _field_value_get (const ::GDBusAnnotationInfo* obj) { return (char*) obj->value; }
