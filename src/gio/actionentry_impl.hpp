...
GI_MODULE_STATIC_OR_INLINE const char* _field_name_get (const ::GActionEntry* obj) { return (const char*) obj->name; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_parameter_type_get (const ::GActionEntry* obj) { return (const char*) obj->parameter_type; }
...
GI_MODULE_STATIC_OR_INLINE const char* _field_state_get (const ::GActionEntry* obj) { return (const char*) obj->state; }
