...
void DBusObjectManagerClientClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.interface_proxy_signal) methods->interface_proxy_signal = (decltype (methods->interface_proxy_signal)) gi::detail::method_wrapper<self, void (*) (Gio::DBusObjectProxy object_proxy, Gio::DBusProxy interface_proxy, const gi::cstring_v sender_name, const gi::cstring_v signal_name, GLib::Variant parameters), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::interface_proxy_signal_>;
}
