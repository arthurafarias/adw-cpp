...
// const gchar* /*none,nullable*/ g_application_get_version (GApplication* application /*none*/);
// const char* /*none,nullable*/ g_application_get_version (::GApplication* application /*none*/);
gi::cstring_v base::ApplicationBase::get_version () noexcept
{
  typedef const char* (*call_wrap_t) (::GApplication* application);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_application_get_version;
  auto _temp_ret = call_wrap_v ((::GApplication*) (gobj_()));
  return gi::wrap (_temp_ret, gi::transfer_none);
}
...
// void g_application_set_version (GApplication* application /*none*/, const gchar* version /*none*/);
// void g_application_set_version (::GApplication* application /*none*/, const char* version /*none*/);
void base::ApplicationBase::set_version (const gi::cstring_v version) noexcept
{
  typedef void (*call_wrap_t) (::GApplication* application, const char* version);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_application_set_version;
  auto version_to_c = gi::unwrap (version, gi::transfer_none);
  call_wrap_v ((::GApplication*) (gobj_()), (const char*) (version_to_c));
}
...
void ApplicationClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.add_platform_data) methods->add_platform_data = (decltype (methods->add_platform_data)) gi::detail::method_wrapper<self, void (*) (GLib::VariantBuilder_Ref builder), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::add_platform_data_>;
  if (init_data.after_emit) methods->after_emit = (decltype (methods->after_emit)) gi::detail::method_wrapper<self, void (*) (GLib::Variant platform_data), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::after_emit_>;
  if (init_data.before_emit) methods->before_emit = (decltype (methods->before_emit)) gi::detail::method_wrapper<self, void (*) (GLib::Variant platform_data), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::before_emit_>;
  if (init_data.command_line) methods->command_line = (decltype (methods->command_line)) gi::detail::method_wrapper<self, gint (*) (Gio::ApplicationCommandLine command_line), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::command_line_>;
  if (init_data.dbus_register) methods->dbus_register = (decltype (methods->dbus_register)) gi::detail::method_wrapper<self, bool (*) (Gio::DBusConnection connection, const gi::cstring_v object_path, GLib::Error * _error), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::dbus_register_>;
  if (init_data.dbus_unregister) methods->dbus_unregister = (decltype (methods->dbus_unregister)) gi::detail::method_wrapper<self, void (*) (Gio::DBusConnection connection, const gi::cstring_v object_path), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::dbus_unregister_>;
  if (init_data.handle_local_options) methods->handle_local_options = (decltype (methods->handle_local_options)) gi::detail::method_wrapper<self, gint (*) (GLib::VariantDict_Ref options), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::handle_local_options_>;
  if (init_data.local_command_line) methods->local_command_line = (decltype (methods->local_command_line)) gi::detail::method_wrapper<self, bool (*) (gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> & arguments, gint & exit_status), gi::transfer_none_t, std::tuple<detail::arg_info<gi::transfer_full_t, true>, gi::transfer_full_t>>::wrapper<&self::local_command_line_>;
  if (init_data.name_lost) methods->name_lost = (decltype (methods->name_lost)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::name_lost_>;
  if (init_data.open) methods->open = (decltype (methods->open)) gi::detail::method_wrapper<self, void (*) (gi::Collection<gi::DSpan, ::GFile*, gi::transfer_none_t> files, const gi::cstring_v hint), gi::transfer_full_t, std::tuple<detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<0, 1>>, detail::arg_info<gi::transfer_none_t, false, void, detail::args_index<2>>>, void  (::GFile** files, gint n_files, const char* hint)>::wrapper<&self::open_>;
  if (init_data.quit_mainloop) methods->quit_mainloop = (decltype (methods->quit_mainloop)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::quit_mainloop_>;
  if (init_data.run_mainloop) methods->run_mainloop = (decltype (methods->run_mainloop)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::run_mainloop_>;
  if (init_data.shutdown) methods->shutdown = (decltype (methods->shutdown)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::shutdown_>;
  if (init_data.startup) methods->startup = (decltype (methods->startup)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::startup_>;
}
