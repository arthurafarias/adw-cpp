...
// int g_zlib_compressor_get_os (GZlibCompressor* compressor /*none*/);
// gint g_zlib_compressor_get_os (::GZlibCompressor* compressor /*none*/);
gint base::ZlibCompressorBase::get_os () noexcept
{
  typedef gint (*call_wrap_t) (::GZlibCompressor* compressor);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_zlib_compressor_get_os;
  auto _temp_ret = call_wrap_v ((::GZlibCompressor*) (gobj_()));
  return _temp_ret;
}
...
// void g_zlib_compressor_set_os (GZlibCompressor* compressor /*none*/, int os);
// void g_zlib_compressor_set_os (::GZlibCompressor* compressor /*none*/, gint os);
void base::ZlibCompressorBase::set_os (gint os) noexcept
{
  typedef void (*call_wrap_t) (::GZlibCompressor* compressor, gint os);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_zlib_compressor_set_os;
  auto os_to_c = os;
  call_wrap_v ((::GZlibCompressor*) (gobj_()), (gint) (os_to_c));
}
