...
void TlsPasswordClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.get_default_warning) methods->get_default_warning = (decltype (methods->get_default_warning)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_default_warning_>;
}
